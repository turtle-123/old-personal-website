...
export type EditorThemeClasses = {
  ...
  list?: {
    bullet?: EditorThemeClassName;
    numberDepth?: Array<EditorThemeClassName>;
    number?: EditorThemeClassName;
    check?: EditorThemeClassName;
    bulletDepth?: Array<EditorThemeClassName>;
    checkDepth?: Array<EditorThemeClassName>;
...
export class LexicalEditor {
  ...
  toJSON(): SerializedEditor {
    ...
    if (obj.editorState.root.children[0].hasOwnProperty('first_element')) {
      (obj.editorState.root.children[0] as any)['first_element'] = true;
    }
    return obj;
  }
}
