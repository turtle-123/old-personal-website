...
export {$createTextNode, $isTextNode, TextNode, getElementOuterTag} from './nodes/LexicalTextNode';
export {
  ExtendedTextNode,
  $createExtendedTextNode,
  $isExtendedTextNode,
  
} from './nodes/LexicalExtendedTextNode'
export { errorOnReadOnly } from './LexicalUpdates';
export {
