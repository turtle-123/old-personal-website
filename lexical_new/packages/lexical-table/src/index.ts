...
import type {LexicalCommand, Spread} from 'lexical';
...
export const INSERT_TABLE_COMMAND_WITH_DATA: LexicalCommand<Spread<InsertTableCommandPayload,{ json: string[][] }>> = createCommand('INSERT_TABLE_COMMAND_WITH_DATA');
...
export { 
  ...
  $canUnmerge
} from './LexicalTableCustom';

export type { SerializedCellParagraphNode } from './CellParagraphNode';
export {
  CellParagraphNode,
  $createCellParagraphNode,
  $isCellParagraphNode
} from './CellParagraphNode';
export {
