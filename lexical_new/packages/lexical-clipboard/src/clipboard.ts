...
import { LAUNCH_TEXT_INSERTION_COMMAND, getDOMRangeRectAbsolute } from '@lexical/shared';
...
export function $insertDataTransferForRichText(
  ...
  if (htmlString) {
    ...
    if (root&&domSelection&&domSelection.getRangeAt(0)&&domSelection.getRangeAt(0).commonAncestorContainer&&PORTAL_EL_TEMP) {
      ...
      editor.dispatchCommand(LAUNCH_TEXT_INSERTION_COMMAND, { html: htmlString, rect })
      return;
    }
    try {
