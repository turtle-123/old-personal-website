...
exports.CLEAR_EDITOR_COMMAND = exports.CAN_UNDO_COMMAND = exports.CAN_REDO_COMMAND = exports.BLUR_COMMAND = exports.BLOCK_STYLE_DEFAULT = exports.ALLOWED_BORDER_STYLES = exports.$splitNode = exports.$setSelection = exports.$setCompositionKey = exports.$selectAll = exports.$parseSerializedNode = exports.$normalizeSelection__EXPERIMENTAL = exports.$nodesOfType = exports.$isTextNode = exports.$isTableWrapperNode = exports.$isTabNode = exports.$isRootOrShadowRoot = exports.$isRootNode = exports.$isRangeSelection = exports.$isParagraphNode = exports.$isNodeSelection = exports.$isLineBreakNode = exports.$isLeafNode = exports.$isInlineElementOrDecoratorNode = exports.$isExtendedTextNode = exports.$isElementNode = exports.$isDecoratorNode = exports.$isBlockElementNode = exports.$insertNodes = exports.$hasUpdateTag = exports.$hasAncestor = exports.$getTextContent = exports.$getSelection = exports.$getRoot = exports.$getPreviousSelection = exports.$getNodeByKey = exports.$getNearestRootOrShadowRoot = exports.$getNearestNodeFromDOMNode = exports.$getAdjacentNode = exports.$createTextNode = exports.$createTableWrapperNode = exports.$createTabNode = exports.$createRangeSelection = exports.$createParagraphNode = exports.$createNodeSelection = exports.$createLineBreakNode = exports.$createExtendedTextNode = exports.$copyNode = exports.$applyNodeReplacement = exports.$addUpdateTag = void 0;
exports.KEY_SPACE_COMMAND = exports.KEY_MODIFIER_COMMAND = exports.KEY_ESCAPE_COMMAND = exports.KEY_ENTER_COMMAND = exports.KEY_DOWN_COMMAND = exports.KEY_DELETE_COMMAND = exports.KEY_BACKSPACE_COMMAND = exports.KEY_ARROW_UP_COMMAND = exports.KEY_ARROW_RIGHT_COMMAND = exports.KEY_ARROW_LEFT_COMMAND = exports.KEY_ARROW_DOWN_COMMAND = exports.INSERT_TAB_COMMAND = exports.INSERT_PARAGRAPH_COMMAND = exports.INSERT_LINE_BREAK_COMMAND = exports.INDENT_CONTENT_COMMAND = exports.FORMAT_TEXT_COMMAND = exports.FORMAT_ELEMENT_COMMAND = exports.FOCUS_COMMAND = exports.ExtendedTextNode = exports.ElementNodeWithBlockStyle = exports.ElementNode = exports.DecoratorNode = exports.DROP_COMMAND = exports.DRAGSTART_COMMAND = exports.DRAGOVER_COMMAND = exports.DRAGEND_COMMAND = exports.DEPRECATED_GridRowNode = exports.DEPRECATED_GridNode = exports.DEPRECATED_GridCellNode = exports.DEPRECATED_$isGridSelection = exports.DEPRECATED_$isGridRowNode = exports.DEPRECATED_$isGridNode = exports.DEPRECATED_$isGridCellNode = exports.DEPRECATED_$getNodeTriplet = exports.DEPRECATED_$getGridCellNodeRect = exports.DEPRECATED_$createGridSelection = exports.DEPRECATED_$computeGridMap = exports.DELETE_WORD_COMMAND = exports.DELETE_LINE_COMMAND = exports.DELETE_CHARACTER_COMMAND = exports.CUT_COMMAND = exports.COPY_COMMAND = exports.CONTROLLED_TEXT_INSERTION_COMMAND = exports.COMMAND_PRIORITY_NORMAL = exports.COMMAND_PRIORITY_LOW = exports.COMMAND_PRIORITY_HIGH = exports.COMMAND_PRIORITY_EDITOR = exports.COMMAND_PRIORITY_CRITICAL = exports.CLICK_COMMAND = exports.CLEAR_HISTORY_COMMAND = void 0;
exports.parseColorStr = exports.isSelectionWithinEditor = exports.isSelectionCapturedInDecoratorInput = exports.isHTMLElement = exports.isHTMLAnchorElement = exports.getNearestEditorFromDOMNode = exports.getElementOuterTag = exports.getCssTextForElementNodeWithBlockStyle = exports.extractStylesFromCssText = exports.errorOnReadOnly = exports.createEditor = exports.createCommand = exports.VALID_HEX_REGEX = exports.UNDO_COMMAND = exports.TextNode = exports.TableWrapperNode = exports.TabNode = exports.SELECT_ALL_COMMAND = exports.SELECTION_CHANGE_COMMAND = exports.RootNode = exports.REMOVE_TEXT_COMMAND = exports.REDO_COMMAND = exports.ParagraphNode = exports.PASTE_COMMAND = exports.OUTDENT_CONTENT_COMMAND = exports.MOVE_TO_START = exports.MOVE_TO_END = exports.MAX_INDENT_PARAGRAPH_LEVEL = exports.LineBreakNode = exports.KEY_TAB_COMMAND = void 0;
/**
...
const IS_QUOTE = 1 << 8;
const IS_KBD = 1 << 9;
const IS_ALL_FORMATTING = IS_BOLD | IS_ITALIC | IS_STRIKETHROUGH | IS_UNDERLINE | IS_CODE | IS_SUBSCRIPT | IS_SUPERSCRIPT | IS_HIGHLIGHT | IS_QUOTE | IS_KBD;
// Text node details
 ...
 *
 * Returns:
 * - **true** when the node is a decorator node and not inline
 * - **false** when the node is the root node
 * - **true** when the node is not inline, can be empty, and the first child of the node
 * is a leaf element
 * - **false** otherwise
 *
 */
...
function createNode(key, parentDOM, insertDOM) {
    ...
    // this attribute).
    if ($isTextNode(node)) {
        dom.setAttribute('data-frank-text', 'true');
    }
    else if ($isDecoratorNode(node)) {
        dom.setAttribute('data-frank-decorator', 'true');
        dom.setAttribute('data-node-key', key);
    }
    if ($isElementNode(node)) {
...
function onBeforeInput(event, editor) {
    ...
    updateEditor(editor, () => {
        ...
        switch (inputType) {
            ...
            case 'formatQuote':
                {
                    dispatchCommand(editor, FORMAT_TEXT_COMMAND, 'quote');
                    break;
                }
            case 'formatKbd':
                {
                    dispatchCommand(editor, FORMAT_TEXT_COMMAND, 'kbd');
                    break;
                }
            case 'historyUndo':
                {
...
class LexicalNode {
    ...
    constructor(key) {
        ...
        /** @internal */
        /** @internal */
        this.__first_element = false;
        this.__last_element = false;
        // @ts-expect-error
    ...
    /**
     * Moves selection to the previous sibling of this node,
    ...
    getFirstElement() {
        const self = this.getLatest();
        return self.__first_element;
    }
    setFirstElement(b) {
        const self = this.getWritable();
        self.__first_element = b;
        return self;
    }
    getLastElement() {
        const self = this.getLatest();
...
class LineBreakNode extends LexicalNode {
    ...
    createDOM() {
        ...
        br.setAttribute("data-v", String(CURRENT_VERSION$8));
        if (this.getFirstElement())
            br.classList.add('first-rte-element');
        if (this.getLastElement())
            br.classList.add('last-rte-element');
        return br;
    }
    updateDOM() {
        return false;
...
exports.getElementOuterTag = getElementOuterTag;
...
class TextNode extends LexicalNode {
    ...
    createDOM(config) {
        ...
        dom.setAttribute('data-v', String(CURRENT_VERSION$7));
        if (this.getFirstElement())
    ...
    return {
        forChild: lexicalNode => {
            if ($isTextNode(lexicalNode) && !lexicalNode.hasFormat(format)) {
                ...
                if (format === "subscript" && lexicalNode.hasFormat('superscript'))
                    lexicalNode.toggleFormat('superscript');
                if (format === "superscript" && lexicalNode.hasFormat('subscript'))
                    lexicalNode.toggleFormat('subscript');
            }
            return lexicalNode;
        },
...
class RangeSelection {
    ...
    /**
     * Attempts to "intelligently" insert an arbitrary list of Lexical nodes into the
     * EditorState at the current Selection according to a
     * set of heuristics that determine how surrounding nodes
    ...
    deleteCharacter(isBackward) {
        ...
        if (this.isCollapsed()) {
            ...
            if ($isDecoratorNode(possibleNode) && !possibleNode.isIsolated()) {
                // Make it possible to move selection from range selection to
                // node selection on the node.
                if (possibleNode.isKeyboardSelectable() && $isElementNode(anchorNode) && anchorNode.getChildrenSize() === 0 || possibleNode.getType() === 'math') {
                    anchorNode.remove();
                    const nodeSelection = $createNodeSelection();
                    nodeSelection.add(possibleNode.__key);
                    $setSelection(nodeSelection);
...
exports.ALLOWED_BORDER_STYLES = ALLOWED_BORDER_STYLES;
const CURRENT_VERSION$5 = 1;
const IS_REAL_BROWSER$1 = (_c = (_b = (_a = Object.getOwnPropertyDescriptor(globalThis, 'window')) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.toString().includes('[native code]')) !== null && _c !== void 0 ? _c : false;
/** @noInheritDoc */
class ElementNode extends LexicalNode {
    constructor(key) {
        ...
        /** @internal */
        /** @internal */
        this.__version = CURRENT_VERSION$5;
        this.__first = null;
        this.__last = null;
        this.__size = 0;
        this.__format = 0;
...
exports.BLOCK_STYLE_DEFAULT = BLOCK_STYLE_DEFAULT;
class ElementNodeWithBlockStyle extends ElementNode {
    constructor(key, styleObject) {
        super(key);
        this.__blockStyle = structuredClone(BLOCK_STYLE_DEFAULT);
        this.__version = CURRENT_VERSION$5;
        if (styleObject) {
    ...
    exportDOM(editor) {
        ...
        if (this.getFirstElement() && !!!IS_REAL_BROWSER$1 && element instanceof HTMLElement) {
            element.classList.add('first-rte-element');
        }
        if (this.getLastElement() && !!!IS_REAL_BROWSER$1 && element instanceof HTMLElement) {
...
exports.ElementNodeWithBlockStyle = ElementNodeWithBlockStyle;
/**
 ...
 * @param s2
 */
function isEqualStringOrStringArray(s1, s2) {
...
function getCssTextForElementNodeWithBlockStyle(node1, type) {
    ...
    // Background Color  
    if (style.backgroundColor !== BLOCK_STYLE_DEFAULT.backgroundColor)
        cssText += 'background-color:'.concat(style.backgroundColor).concat(';');
    // Text Color
    if (style.textColor !== BLOCK_STYLE_DEFAULT.textColor)
        cssText += 'color:'.concat(style.textColor).concat(';');
    // Margin - Always Set
    if (Array.isArray(style.margin))
        cssText += 'margin:'.concat(style.margin.join(' ')).concat(';');
    else
        cssText += 'margin:'.concat(style.margin).concat(';');
    // Padding - Always set
    if (LIST) {
        ...
        if (Array.isArray(style.padding)) {
            var paddingLeftStart;
            if (style.padding.length === 2) {
                paddingLeftStart = parseInt(style.padding[1].replace('px', ''));
                ...
                paddingLeftStart = parseInt(style.padding[3].replace('px', ''));
                const paddingLeft = (paddingLeftStart + indent * 20).toString().concat('px');
            ...
            const paddingLeftStart = parseInt(style.padding.replace('px', ''));
            const paddingLeft = (paddingLeftStart + indent * 20).toString().concat('px');
    ...
    if (!!!isEqualStringOrStringArray(style.borderRadius, BLOCK_STYLE_DEFAULT.borderRadius)) {
        if (Array.isArray(style.borderRadius))
            cssText += 'border-radius: '.concat(style.borderRadius.join(' ')).concat(';');
        else
            cssText += 'border-radius:'.concat(style.borderRadius).concat(';');
    }
    // Border Color
    if (!!!isEqualStringOrStringArray(style.borderColor, BLOCK_STYLE_DEFAULT.borderColor)) {
        if (Array.isArray(style.borderColor))
            cssText += 'border-color:'.concat(style.borderColor.join(' ')).concat(';');
        else
            cssText += 'border-color:'.concat(style.borderColor).concat(';');
    }
    // Border Width
    if (!!!isEqualStringOrStringArray(style.borderWidth, BLOCK_STYLE_DEFAULT.borderWidth)) {
        if (Array.isArray(style.borderWidth))
            cssText += 'border-width:'.concat(style.borderWidth.join(' ')).concat(';');
        else
            cssText += 'border-width:'.concat(style.borderWidth).concat(';');
    }
    // Border Type
    if (!!!isEqualStringOrStringArray(style.borderType, BLOCK_STYLE_DEFAULT.borderType)) {
        if (Array.isArray(style.borderType))
            cssText += 'border-style:'.concat(style.borderType.join(' ')).concat(';');
        else
            cssText += 'border-style:'.concat(style.borderType).concat(';');
    }
    if (style.boxShadowInset !== BLOCK_STYLE_DEFAULT.boxShadowInset || style.boxShadowOffsetX !== BLOCK_STYLE_DEFAULT.boxShadowOffsetX || style.boxShadowOffsetY !== BLOCK_STYLE_DEFAULT.boxShadowOffsetY || style.boxShadowSpreadRadius !== BLOCK_STYLE_DEFAULT.boxShadowSpreadRadius || style.boxShadowBlurRadius !== BLOCK_STYLE_DEFAULT.boxShadowBlurRadius) {
        // Box Shadow
...
exports.getCssTextForElementNodeWithBlockStyle = getCssTextForElementNodeWithBlockStyle;
 ...
 * @param str string
 */
function parseColorStr(str, defaultRet) {
    if (!!!str)
        return defaultRet;
    const s = str.trim();
    if (s.startsWith('rgb')) {
...
const VALID_PX = /^\d+px$/;
function clampSize(str, min, max) {
    const num = parseInt(str);
    if (isNaN(num) || !!!isFinite(num))
        return '0px';
    if (num < min)
        return min.toString().concat('px');
    else if (num > max)
        return max.toString().concat('px');
    else
        return str;
}
function parseSizeStr(str, defaultStr, minMax, validLength) {
    if (typeof str === 'string') {
        ...
        for (let i = 0; i < arr.length; i++) {
            if (validLength && i + 1 > validLength)
                break;
            ...
            else if (Array.isArray(defaultStr) && defaultStr[i])
                arr[i] = defaultStr[i];
            else if (Array.isArray(defaultStr))
                arr[i] = defaultStr[0];
            else
                arr[i] = defaultStr[0];
        }
...
function parseBorderColorStr(s) {
    const str = s.trim();
    const startColorIndexes = [];
    const colors = [];
    for (let i = 0; i < str.length; i++) {
        if (str[i] === 'r')
            startColorIndexes.push(i);
        else if (str[i] === '#')
            startColorIndexes.push(i);
    }
...
function parseBorderCssText(obj) {
    const retObj = {
    ...
    if (obj['border']) {
        ...
        if (borderArr.length === 1 && ALLOWED_BORDER_STYLES.has(borderArr[0]))
    ...
    if (!!!retObj.borderRadius && obj['border-radius']) {
        retObj.borderRadius = parseSizeStr(obj['border-radius'], '0px', {
            min: 0,
            max: 50
        });
    }
    ...
    if (!!!retObj.borderWidth && obj['border-width']) {
        retObj.borderWidth = parseSizeStr(obj['border-width'], '0px', {
            min: 0,
            max: 15
        });
    }
 ...
 * @returns
 */
const numSpaces = my_string => my_string.split(" ").length - 1;
function parseBoxShadowCssText(obj) {
    var _a;
    const RET = {
        boxShadowOffsetX: '0px',
        boxShadowOffsetY: '0px',
    ...
    var str = (_a = obj['box-shadow']) === null || _a === void 0 ? void 0 : _a.trim();
    if (str) {
...
const VALID_FORMAT_TYPES = new Set(['left', 'start', 'center', 'right', 'end']);
/**
 ...
 * @returns
 */
function extractStylesFromCssText(cssText, tag) {
    const obj = getStyleObjectFromRawCSS(cssText);
    const textAlign = VALID_FORMAT_TYPES.has(obj['text-align']) ? obj['text-align'] : 'left';
    const backgroundColor = parseColorStr(obj['background-color'], 'transparent');
    const textColor = parseColorStr(obj['color'], 'inherit'); //'inherit' or color
    const margin = parseSizeStr(obj['margin'], ['6px', '0px', '6px', '0px'], {
        min: 0,
        max: 50
    });
    var padding;
    if (tag === 'ul' || tag === 'ol') {
        const paddingTop = parseSizeStr(obj['padding-top'], '0px', {
            min: 0,
            max: 50
        }, 1);
        const paddingBottom = parseSizeStr(obj['padding-bottom'], '0px', {
            min: 0,
            max: 50
        }, 1);
        padding = [paddingTop, '5px', paddingBottom, '5px'];
    }
    else {
        padding = parseSizeStr(obj['padding'], '0px', {
            min: 0,
            max: 50
        });
    }
    const { borderRadius, borderColor, borderWidth, borderType } = parseBorderCssText(obj);
    const { boxShadowOffsetX, boxShadowOffsetY, boxShadowBlurRadius, boxShadowSpreadRadius, boxShadowInset, boxShadowColor } = parseBoxShadowCssText(obj);
...
exports.extractStylesFromCssText = extractStylesFromCssText;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
class RootNode extends ElementNode {
    ...
    constructor() {
        super('root');
        /** @internal */
        this.__version = CURRENT_VERSION$4;
 ...
 *
 */
const IS_REAL_BROWSER = (_f = (_e = (_d = Object.getOwnPropertyDescriptor(globalThis, 'window')) === null || _d === void 0 ? void 0 : _d.get) === null || _e === void 0 ? void 0 : _e.toString().includes('[native code]')) !== null && _f !== void 0 ? _f : false;
const MAX_INDENT_PARAGRAPH_LEVEL = 5;
exports.MAX_INDENT_PARAGRAPH_LEVEL = MAX_INDENT_PARAGRAPH_LEVEL;
const CURRENT_VERSION$3 = 1;
/** @noInheritDoc */
class ParagraphNode extends lexicalLexical_js_1.ElementNodeWithBlockStyle {
    constructor(key, styleObj) {
        super(key);
        this.__format = 1;
        this.__dir = 'ltr';
    ...
    createDOM(config) {
        ...
        const cssText = (0, lexicalLexical_js_1.getCssTextForElementNodeWithBlockStyle)(this.getLatest(), "p");
        dom.style.cssText = cssText;
        dom.setAttribute("data-v", String(CURRENT_VERSION$3));
        if (this.getFirstElement())
            dom.classList.add('first-rte-element');
        if (this.getLastElement())
            dom.classList.add('last-rte-element');
    ...
    updateDOM(prevNode, dom, config) {
        const nextStyle = (0, lexicalLexical_js_1.getCssTextForElementNodeWithBlockStyle)(this, "p");
        dom.style.cssText = nextStyle;
        return false;
    }
    static importDOM() {
    ...
    exportDOM(editor) {
        ...
        if (element && isHTMLElement(element)) {
            ...
            if (this.getFirstElement() && !!!IS_REAL_BROWSER)
                element.classList.add('first-rte-element');
            if (this.getLastElement() && !!!IS_REAL_BROWSER)
                element.classList.add('last-rte-element');
        }
        return {
            element
    ...
    collapseAtStart() {
        ...
        if (children.length === 0 || $isTextNode(children[0]) && children[0].getTextContent().trim() === '') {
            ...
            if (prevSibling && prevSibling.getType() === "details") {
                prevSibling.setOpen(true);
                const accordionContentArr = prevSibling.getChildren().filter(c => c.getType() === "accordion-content");
                if (accordionContentArr.length) {
                    const accordionContent = accordionContentArr[0];
            ...
            const parent = this.getParent();
            if (!!!(0, lexicalLexical_js_1.$isRootNode)(parent)) {
...
function convertParagraphElement(element) {
    ...
    if (element.style.cssText) {
        const obj = (0, lexicalLexical_js_1.extractStylesFromCssText)(element.style.cssText, 'p');
...
function createEditor(editorConfig) {
    ...
    const editor = new LexicalEditor(editorState, parentEditor, registeredNodes, {
        ...
        namespace,
        theme
    }, onError ? onError : console.error, initializeConversionCache(registeredNodes, html ? html.import : undefined), isEditable, editorConfig === null || editorConfig === void 0 ? void 0 : editorConfig.editorType);
...
class LexicalEditor {
    ...
    /** @internal */
    /** @internal */
    constructor(editorState, parentEditor, nodes, config, onError, htmlConversions, editable, editorType) {
        ...
        this._editorType = (editorType === null || editorType === void 0 ? void 0 : editorType.length) ? editorType : 'full';
    }
    /**
     *
    ...
    toJSON() {
        ...
        if (obj.editorState.root.children[0].hasOwnProperty('first_element')) {
            obj.editorState.root.children[0]['first_element'] = true;
        }
        return obj;
    }
}
...
/** @noInheritDoc */
class TableWrapperNode extends lexicalLexical_js_1.ElementNode {
    constructor(key) {
        super(key);
        this.__first = null;
        this.__last = null;
...
exports.TableWrapperNode = TableWrapperNode;
function convertTableWrapperElement(element) {
    const node = $createTableWrapperNode();
    return {
        node
    };
}
function $createTableWrapperNode() {
    return (0, lexicalLexical_js_1.$applyNodeReplacement)(new TableWrapperNode());
}
exports.$createTableWrapperNode = $createTableWrapperNode;
function $isTableWrapperNode(node) {
    return node instanceof TableWrapperNode;
}
exports.$isTableWrapperNode = $isTableWrapperNode;
const CURRENT_VERSION = 1;
class ExtendedTextNode extends lexicalLexical_js_1.TextNode {
    constructor(text, key) {
        super(text, key);
    ...
    static importDOM() {
        const importers = lexicalLexical_js_1.TextNode.importDOM();
        return {
            ...importers,
            code: () => ({
    ...
    static importJSON(serializedNode) {
        return lexicalLexical_js_1.TextNode.importJSON(serializedNode);
    }
    isSimpleText() {
    ...
    return node => {
        ...
        return {
            ...
            forChild: (lexicalNode, parent) => {
                ...
                if ((0, lexicalLexical_js_1.$isTextNode)(result)) {
