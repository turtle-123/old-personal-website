...
exports.createChildrenArray = exports.OffsetView = exports.$createOffsetView = void 0;
/**
...
class OffsetView {
    ...
    createSelectionFromOffsets(originalStart, originalEnd, diffOffsetView) {
        ...
        const startNode = (0, lexicalLexical_js_1.$getNodeByKey)(startKey);
        const endNode = (0, lexicalLexical_js_1.$getNodeByKey)(endKey);
        ...
        if (startOffsetNode.type === 'text') {
            ...
            if (start !== end && startOffset === startNode.getTextContentSize() && (0, lexicalLexical_js_1.$isTextNode)(sibling)) {
                startOffset = 0;
...
function $createOffsetNode(state, key, parent, nodeMap, offsetMap, blockOffsetSize) {
    ...
    const isText = (0, lexicalLexical_js_1.$isTextNode)(node);
