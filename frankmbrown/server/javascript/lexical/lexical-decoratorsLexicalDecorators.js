...
exports.INSERT_YOUTUBE_COMMAND = exports.INSERT_NEWS_NODE = exports.INSERT_IMAGE_COMMAND = exports.INSERT_IMAGES_COMMAND = exports.INSERT_HTML_COMMAND = exports.INSERT_HORIZONTAL_RULE_COMMAND = exports.INSERT_CAROUSEL_COMMAND = exports.INSERT_AUDIO_NODES = exports.INSERT_AUDIO_NODE = exports.INSERT_AI_CHAT_NODE = exports.HtmlNode = exports.HorizontalRuleNode = exports.GET_MAX_IMAGE_WIDTH = exports.GET_MAX_IMAGE_HEIGHT = exports.FORMAT_HORIZONTAL_RULE_COMMAND = exports.DecoratorBlockNode = exports.CarouselImageNode = exports.AudioNode = exports.AiChatNode = exports.$onDropImage = exports.$onDragStartImage = exports.$onDragOverImage = exports.$isYouTubeNode = exports.$isVideoNode = exports.$isTwitterNode = exports.$isTikTokNode = exports.$isRedditNode = exports.$isNewsNode = exports.$isLoadingNode = exports.$isInstagramNode = exports.$isImageNode = exports.$isHtmlNode = exports.$isHorizontalRuleNode = exports.$isDecoratorBlockNode = exports.$isCarouselImageNode = exports.$isAudioNode = exports.$isAiChatNode = exports.$createYouTubeNode = exports.$createVideoNode = exports.$createTwitterNode = exports.$createTikTokNode = exports.$createRedditNode = exports.$createNewsNode = exports.$createLoadingNode = exports.$createInstagramNode = exports.$createImageNode = exports.$createHorizontalRuleNode = exports.$createCarouselImageNode = exports.$createAudioNode = exports.$createAiChatNode = void 0;
exports.validateYoutubeUrl = exports.registerYoutube = exports.registerTwitterEditable = exports.registerTikTokEditable = exports.registerRedditEditable = exports.registerNewsNode = exports.registerInstagramEditable = exports.registerHorizontalRule = exports.registerHTMLNodeNotEditable = exports.registerHTMLNodeEditable = exports.registerDecoratorsNotEditable = exports.registerDecoratorsEditable = exports.YouTubeNode = exports.YOUTUBE_REGEX = exports.VideoNode = exports.VALID_ALIGN_DECORATOR_BLOCK = exports.TwitterNode = exports.TikTokNode = exports.RedditNode = exports.NewsNode = exports.MIN_IMAGE_DIMENSION = exports.LoadingNode = exports.InstagramNode = exports.ImageNode = void 0;
/**
...
exports.VALID_ALIGN_DECORATOR_BLOCK = VALID_ALIGN_DECORATOR_BLOCK;
const CURRENT_VERSION$c = 1;
class DecoratorBlockNode extends lexicalLexical_js_1.DecoratorNode {
    constructor(format, key) {
        super(key);
        this.__version = CURRENT_VERSION$c;
    ...
    createDOM() {
        ...
        if (this.getFirstElement())
            el.classList.add('first-rte-element');
        if (this.getLastElement())
            el.classList.add('last-rte-element');
        return el;
    }
...
class NewsNode extends DecoratorBlockNode {
    ...
    constructor(obj, format, key) {
        ...
        this.__version = CURRENT_VERSION$b;
        this.__url = obj.url;
...
exports.$isNewsNode = $isNewsNode;
const INSERT_NEWS_NODE$1 = (0, lexicalLexical_js_1.createCommand)('INSERT_NEWS_NODE');
exports.INSERT_NEWS_NODE = INSERT_NEWS_NODE$1;
function registerNewsNode(editor) {
    return editor.registerCommand(INSERT_NEWS_NODE$1, obj => {
        ...
        (0, lexical_utilsLexicalUtils_js_1.$insertNodeToNearestRoot)(node);
        return true;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR);
}
exports.registerNewsNode = registerNewsNode;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
class YouTubeNode extends DecoratorBlockNode {
    constructor(id, format, key) {
        super(format, key);
        this.__version = CURRENT_VERSION$a;
        this.__id = id;
    }
    static getType() {
        return 'youtube';
...
const INSERT_YOUTUBE_COMMAND$1 = (0, lexicalLexical_js_1.createCommand)('INSERT_YOUTUBE_COMMAND');
exports.INSERT_YOUTUBE_COMMAND = INSERT_YOUTUBE_COMMAND$1;
function registerYoutube(editor) {
    return editor.registerCommand(INSERT_YOUTUBE_COMMAND$1, payload => {
        const youTubeNode = $createYouTubeNode(payload);
        (0, lexical_utilsLexicalUtils_js_1.$insertNodeToNearestRoot)(youTubeNode);
        return true;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR);
}
...
class HorizontalRuleNode extends DecoratorBlockNode {
    constructor(styleObj, key, format) {
        super(format, key);
        this.__version = HORIZONTAL_RULE_VERSION;
        if (styleObj) {
            if (lexicalLexical_js_1.VALID_HEX_REGEX.test(String(styleObj.color))) {
    ...
    setHorizontalRuleStyle({ color, width }) {
        const self = this.getWritable();
        self.__color = lexicalLexical_js_1.VALID_HEX_REGEX.test(color) ? color : 'var(--divider)';
        ...
        if (element) {
            if (element.children.length === 0) {
                ...
                if (this.__color === "var(--divider)") {
                    ...
                    if (element.classList.contains('divider-color'))
                        element.classList.remove('divider-color');
...
function createHorizontalRule(styleObj) {
    ...
    else if (lexicalLexical_js_1.VALID_HEX_REGEX.test(styleObj.color)) {
...
function convertHorizontalRuleElement(domNode) {
    ...
    const first_element = domNode.classList.contains('first-rte-element');
    const last_element = domNode.classList.contains('last-rte-element');
    if (!!!lexicalLexical_js_1.VALID_HEX_REGEX.test(color))
        color = 'var(--divider)';
...
const INSERT_HORIZONTAL_RULE_COMMAND$1 = (0, lexicalLexical_js_1.createCommand)('INSERT_HORIZONTAL_RULE_COMMAND');
exports.INSERT_HORIZONTAL_RULE_COMMAND = INSERT_HORIZONTAL_RULE_COMMAND$1;
const FORMAT_HORIZONTAL_RULE_COMMAND$1 = (0, lexicalLexical_js_1.createCommand)('FORMAT_HORIZONTAL_RULE_COMMAND');
exports.FORMAT_HORIZONTAL_RULE_COMMAND = FORMAT_HORIZONTAL_RULE_COMMAND$1;
function registerHorizontalRule(editor) {
    return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(INSERT_HORIZONTAL_RULE_COMMAND$1, payload => {
        const horizontalRuleNode = $createHorizontalRuleNode({
            color: String(payload.color),
            width: payload.width
        });
        (0, lexical_utilsLexicalUtils_js_1.$insertNodeToNearestRoot)(horizontalRuleNode);
        return true;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerCommand(FORMAT_HORIZONTAL_RULE_COMMAND$1, payload => {
        const color = lexicalLexical_js_1.VALID_HEX_REGEX.test(String(payload.color)) ? String(payload.color) : 'var(--divider)';
        const width = clampWidth$1(payload.width);
        const selection = (0, lexicalLexical_js_1.$getSelection)();
        if ((0, lexicalLexical_js_1.$isNodeSelection)(selection) || (0, lexicalLexical_js_1.$isRangeSelection)(selection)) {
...
function getAudioHTML(src, defaultAudio) {
    const desktop = !!!(0, lexical_sharedLexicalShared_js_1.isTouchDevice)();
    ...
    const useTooltips = Boolean(!!!(0, lexical_sharedLexicalShared_js_1.isTouchDevice)());
    return ( /*html*/`
...
const INSERT_AUDIO_NODE$1 = (0, lexicalLexical_js_1.createCommand)('INSERT_AUDIO_NODE');
exports.INSERT_AUDIO_NODE = INSERT_AUDIO_NODE$1;
const INSERT_AUDIO_NODES = (0, lexicalLexical_js_1.createCommand)('INSERT_AUDIO_NODES');
exports.INSERT_AUDIO_NODES = INSERT_AUDIO_NODES;
...
class VideoNode extends DecoratorBlockNode {
    constructor(obj, key, format) {
        super(format, key);
        this.__version = CURRENT_VERSION$8;
        this.__text = undefined;
        this.__src = obj.src;
        this.__title = obj.title;
        this.__description = obj.description;
...
const SCROLL_INTO_VIEW_OPTIONS = {
    ...lexical_sharedLexicalShared_js_1.SCROLL_INTO_VIEW_OPTIONS,
    block: "end"
};
/*---------------------------------------------------- Variables -------------------------------------------*/
/**
...
/* --------------------------------------------------------- Commands ------------------------------------------------ */
const INSERT_AUDIO_NODE = (0, lexicalLexical_js_1.createCommand)('INSERT_AUDIO_NODE');
const INSERT_HORIZONTAL_RULE_COMMAND = (0, lexicalLexical_js_1.createCommand)('INSERT_HORIZONTAL_RULE_COMMAND');
const FORMAT_HORIZONTAL_RULE_COMMAND = (0, lexicalLexical_js_1.createCommand)('FORMAT_HORIZONTAL_RULE_COMMAND');
const INSERT_IMAGE_COMMAND$1 = (0, lexicalLexical_js_1.createCommand)('INSERT_IMAGE_COMMAND');
const INSERT_IMAGES_COMMAND$1 = (0, lexicalLexical_js_1.createCommand)('INSERT_IMAGES_COMMAND');
const INSERT_NEWS_NODE = (0, lexicalLexical_js_1.createCommand)('INSERT_NEWS_NODE');
const INSERT_VIDEO_NODE = (0, lexicalLexical_js_1.createCommand)('INSERT_VIDEO_NODE');
const INSERT_YOUTUBE_COMMAND = (0, lexicalLexical_js_1.createCommand)('INSERT_YOUTUBE_COMMAND');
const CAROUSEL_CLICK = (0, lexicalLexical_js_1.createCommand)('CAROUSEL_CLICK');
/*------------------------------------------------------ Helpers ------------------------------------------- */
...
function clearSelectedDecorators(editor) {
    ...
    if (decorators && rootElement) {
        Object.keys(decorators).forEach(key => {
            ...
            if (blockElement)
                blockElement.classList.remove('selected-decorator-block');
        });
    }
...
function setSelectedDecorators(editor) {
    ...
    if (Array.isArray(SELECTED_DECORATORS) && rootElement) {
        SELECTED_DECORATORS.forEach(key => {
            ...
            if (blockElement && !!!((node === null || node === void 0 ? void 0 : node.getType()) === "math" && node.getEditable()))
                blockElement.classList.add('selected-decorator-block');
            if (node)
                typesSet.add(node.getType());
        });
    }
    return typesSet;
}
                ...
                editor.update(() => {
                    ...
                    if (node && $isImageNode(node)) {
                        ...
                        if (typeof cW === 'number' && typeof cH === 'number') {
                            ...
                            if (SELECTED_IMAGE)
                                SELECTED_IMAGE.style.removeProperty('height');
                            node.setWidth(Number(width.toFixed(2)));
                            node.setHeight(Number(height.toFixed(2)));
                            node.setOriginalDevice((0, lexical_sharedLexicalShared_js_1.getDeviceType)());
                        }
                    }
                });
...
function onDeleteDecorators(editor, event) {
    ...
    if ((0, lexicalLexical_js_1.$isNodeSelection)(selection)) {
        const nodes = selection.getNodes();
        for (let node of nodes) {
            const closestToParent = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(node, n => { var _a; return Boolean(n.getParent() && ((_a = n.getParent()) === null || _a === void 0 ? void 0 : _a.__type) === 'root'); });
            if (closestToParent) {
                ...
                for (let i = 0; i < Math.max(previousSiblings.length, nextSiblings.length); i++) {
                    if (previousSiblings[i]) {
                        if ((0, lexicalLexical_js_1.$isElementNode)(previousSiblings[i])) {
                            nodeToSelectTemp = previousSiblings[i];
                            break;
                        }
                    }
                    if (nextSiblings[i]) {
                        if ((0, lexicalLexical_js_1.$isElementNode)(nextSiblings[i])) {
        ...
        nodes.forEach(node => {
            if (node && node.getType && node.getType() === "math" && node.getEditable() && node.getTextContent().length > 0)
                return;
            else if (node && node.getType && node.getType() === 'math' && node.getTextContent().length > 0)
                return;
        ...
        const rangeSelection = (0, lexicalLexical_js_1.$createRangeSelection)();
        if (nodeToSelect) {
        ...
        (0, lexicalLexical_js_1.$setSelection)(rangeSelection);
        return true;
    }
    return false;
}
...
function clearSelectedImage() {
    var _a;
    if (SELECTED_IMAGE) {
        (_a = SELECTED_IMAGE.nextElementSibling) === null || _a === void 0 ? void 0 : _a.remove();
        SELECTED_IMAGE.classList.remove('focused', 'draggable');
        if (SELECTED_IMAGE.parentElement)
            SELECTED_IMAGE.parentElement.setAttribute('draggable', 'false');
    }
}
function onChangeImageBackgroundColorSubmit(e) {
    ...
    if (CURRENT_IMAGE_BG_EDIT) {
        ...
        const editor = (0, lexical_sharedLexicalShared_js_1.getEditorInstances)()[CURRENT_IMAGE_BG_EDIT.editorNamespace];
        if (editor && colorInput && transparentInput && dilaog && shortDescriptionEl && longDescriptionEl) {
            ...
            if (transparent || !!!lexicalLexical_js_1.VALID_HEX_REGEX.test(bgColor)) {
                editor.update(() => {
                    const image = (0, lexicalLexical_js_1.$getNodeByKey)(String(CURRENT_IMAGE_BG_EDIT === null || CURRENT_IMAGE_BG_EDIT === void 0 ? void 0 : CURRENT_IMAGE_BG_EDIT.nodeKey));
                    ...
                    (0, lexical_sharedLexicalShared_js_1.closeDialog)(dilaog);
                });
            }
            else {
                editor.update(() => {
...
function getOpenImageBackgroundColorDialog(key, editorNamespace, currentBgColor, shortDescription, longDescription) {
    const func = function () {
        ...
        if (insertAfterDiv) {
            const str = (0, lexical_sharedLexicalShared_js_1.GET_BACKGROUND_COLOR_DIALOG)((0, lexical_sharedLexicalShared_js_1.getDefaultBackground)());
            ...
            if (bgForm)
                bgForm.addEventListener('submit', onChangeImageBackgroundColorSubmit);
            if (colorInput && transparentInput && shortDescriptionEl && longDescriptionEl) {
                if (currentBgColor === undefined || !!!lexicalLexical_js_1.VALID_HEX_REGEX.test(currentBgColor)) {
                    colorInput.value = (0, lexical_sharedLexicalShared_js_1.getDefaultBackground)();
        ...
        switch (dataType) {
            case 'image':
                ...
                if (dataCount === "single" && input) {
                    ...
                    if (!!!imageUrl.startsWith('https://image.storething.org/frankmbrown/'))
                        return;
                    ...
                    if (shortDescription && longDescription) {
                        getImageWidthAndHeight(imageUrl).then(({ width, height }) => {
                            const imageObj = {
                                src: imageUrl,
            ...
            case 'audio':
                if (dataCount === "single") {
                    ...
                    if (srcInput) {
                        ...
                        const audioObj = {
                            src: srcInput.value,
                            title: (title === null || title === void 0 ? void 0 : title.value) ? title.value : ''
                        };
                        ...
                        if (videoWrapper) {
                            ...
                            if (video) {
                                ...
                                const videoObj = {
                                    src: srcInput.value,
                                    title: (title === null || title === void 0 ? void 0 : title.value) ? title.value : '',
                                    description: (description === null || description === void 0 ? void 0 : description.value) ? description.value : '',
                                    height,
                                    width
                                };
...
function resetInsertMediaSectionForm(b, e) {
    ...
    if (form) {
        ...
        inputs.forEach(input => {
            ...
            if (input.hasAttribute('data-image-input'))
                input.dispatchEvent(new CustomEvent('delete-image', {
                    detail: {
                        inputName: name
                    }
                }));
            ...
            if (name) {
                ...
                if (inputThatHoldsDBValues)
                    inputThatHoldsDBValues.remove();
                newInput.setAttribute('name', name);
            }
            if (multiple)
                newInput.setAttribute('multiple', '');
            if (input.hasAttribute('data-image-input'))
                newInput.setAttribute('data-image-input', '');
            if (input.hasAttribute('data-audio-input'))
                newInput.setAttribute('data-audio-input', '');
            if (input.hasAttribute('data-video-input'))
                newInput.setAttribute('data-video-input', '');
            const parentElement = input.parentElement;
            if (parentElement)
                parentElement.replaceChild(newInput, input);
            document.dispatchEvent(new CustomEvent('NEW_CONTENT_LOADED', {
                detail: {
                    el: form
                }
...
function handleHorizontalRuleSubmit(e) {
    ...
    const color = form === null || form === void 0 ? void 0 : form.color;
    const width = form === null || form === void 0 ? void 0 : form.width;
    const checkbox = form === null || form === void 0 ? void 0 : form.checkbox;
    const dialog = form === null || form === void 0 ? void 0 : form.dialog;
            ...
            editor.update(() => {
                ...
                if (SELECTED_DECORATORS && SELECTED_DECORATORS.length >= 1) {
                    SELECTED_DECORATORS.forEach(dec => {
                        var node = (0, lexicalLexical_js_1.$getNodeByKey)(dec);
                        if (node) {
                            if ($isHorizontalRuleNode(node)) {
                                node.setHorizontalRuleStyle({
                                ...
                                if (dom) {
                                    ...
                                    if (hr) {
                                        ...
                                        if (checkbox.checked) {
                                            ...
                                            if (hr.classList.contains('divider-color'))
                                                hr.classList.remove('divider-color');
...
function handleHorizontalRuleChange(e) {
    ...
    if (form && form.checkbox && form.color && form.width && form.example) {
        ...
        const colorInput = lexicalLexical_js_1.VALID_HEX_REGEX.test(form.color.value) ? form.color.value : 'var(--divider)';
...
async function handleEmbedNews(form, e, dialog) {
    try {
        ...
        if (!!!VALID_URL_REGEX.test(url.value))
            throw new Error('Please enter a valid url.');
        const body = {
            embed_type: 'news',
            url: url.value
        };
        (0, lexical_sharedLexicalShared_js_1.openLoadingDialog)("Generating News Article Embed...");
        ...
        const editor = (0, lexical_sharedLexicalShared_js_1.getCurrentEditor)();
        if (editor)
            editor.dispatchCommand(INSERT_NEWS_NODE, obj);
        (0, lexical_sharedLexicalShared_js_1.closeLoadingDialog)();
        if (resp.status !== 200)
            throw new Error('Something went wrong embedding news content.');
...
function handleEmbedYoutube(form, e, dialog) {
    try {
        ...
        if (!!!textInput)
            throw new Error('Can\'t find url for youtube video.');
...
function setToolbarSelectedImage(wrapper) {
    ...
    Object.values(buttons).forEach(b => {
        if (b && b.nodeName === "BUTTON") {
            ...
            else if (b.getAttribute('data-dispatch') === "FORMAT_ELEMENT_COMMAND")
                return;
            else {
...
function onGifButtonClick(e) {
    ...
    if (div) {
        ...
        if (input) {
            if (input)
                input.addEventListener('gif-upload', handleGifUpload);
            input.click();
        }
    }
}
...
function registerDecoratorsListeners(editor) {
    ...
    if (wrapper) {
        ...
        if (insertImageButton)
            insertImageButton.addEventListener('click', handleInsertImageClick);
        // Handle with registerAudioNodes
        const insertAudioButton = wrapper.querySelector('button[data-lexical-audio-button]');
        if (insertAudioButton)
            insertAudioButton.addEventListener('click', handleInsertAudioClick);
        ...
        if (insertVideoButton)
            insertVideoButton.addEventListener('click', handleInsertVideoClick);
        if (Array.isArray(closeInsertMediaSectionButtons))
            closeInsertMediaSectionButtons.forEach(b => b.addEventListener('click', closeInsertMediaSection));
        if (Array.isArray(submitInsertMediaSectionButtons))
            submitInsertMediaSectionButtons.forEach(b => b.addEventListener('click', handleInsertMediaSectionSubmit));
        if (Array.isArray(resetInsertMediaSectionButtons))
            resetInsertMediaSectionButtons.forEach(b => b.addEventListener('click', handleInsertMediaSectionReset));
        ...
        if (horizontalRuleForm && horizontalRuleForm.form) {
            ...
            if (editor && SELECTED_DECORATORS && SELECTED_DECORATORS.length) {
                editor.getEditorState().read(() => {
                    if (SELECTED_DECORATORS && SELECTED_DECORATORS.length >= 1) {
                        const node = (0, lexicalLexical_js_1.$getNodeByKey)(SELECTED_DECORATORS[0]);
                        if ($isHorizontalRuleNode(node)) {
                            ...
                            if (colorInput)
                                colorInput.value = String(color === "var(--divider)" ? (0, lexical_sharedLexicalShared_js_1.getDefaultTextColor)() : color);
                            if (defaultHR)
                                defaultHR.checked = Boolean(color === 'var(--divider)');
                        }
                    }
                });
            }
...
function registerDecoratorsEditable(editor) {
    ...
    if (editor.hasNode(AudioNode)) {
        arr.push(editor.registerCommand(INSERT_AUDIO_NODE, payload => {
            if (payload.src.startsWith('https://audio.storething.org/frankmbrown/', 0) && payload.title.length) {
                ...
                (0, lexical_utilsLexicalUtils_js_1.$insertNodeToNearestRoot)(audioNode);
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(AudioNode, nodeMutations => {
    ...
    if (editor.hasNode(VideoNode)) {
        arr.push(editor.registerCommand(INSERT_VIDEO_NODE, payload => {
            if (payload.src.startsWith('https://video.storething.org/frankmbrown/', 0) && payload.title.length) {
                ...
                (0, lexical_utilsLexicalUtils_js_1.$insertNodeToNearestRoot)(videoNode);
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(VideoNode, nodeMutations => {
            for (const [nodeKey, mutation] of nodeMutations) {
                if (mutation === 'created') {
                    const el_id = editor._config.namespace;
                    setTimeout(() => {
    ...
    if (editor.hasNode(ImageNode)) {
        ...
        arr.push(editor.registerCommand(INSERT_IMAGE_COMMAND$1, payload => {
            const deviceType = (0, lexical_sharedLexicalShared_js_1.getDeviceType)();
            ...
            if (!!!(0, lexicalLexical_js_1.$isParagraphNode)(node.getParentOrThrow())) {
                (0, lexical_utilsLexicalUtils_js_1.$wrapNodeInElement)(node, lexicalLexical_js_1.$createParagraphNode).selectEnd();
                const parent = node.getParent();
                if ((0, lexicalLexical_js_1.$isParagraphNode)(parent)) {
                    parent.setFormat('center');
                }
            }
            else if ((0, lexicalLexical_js_1.$isParagraphNode)(node.getParentOrThrow())) {
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerCommand(INSERT_IMAGES_COMMAND$1, payload => {
            const deviceType = (0, lexical_sharedLexicalShared_js_1.getDeviceType)();
            ...
            (0, lexicalLexical_js_1.$insertNodes)(nodes);
            if (!!!(0, lexicalLexical_js_1.$isParagraphNode)(nodes[0].getParentOrThrow())) {
                (0, lexical_utilsLexicalUtils_js_1.$wrapNodeInElement)(nodes[0], lexicalLexical_js_1.$createParagraphNode).selectEnd();
            }
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR));
    ...
    if (editor.hasNode(CarouselImageNode)) {
        arr.push(editor.registerCommand(INSERT_CAROUSEL_COMMAND, payload => {
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerCommand(CAROUSEL_CLICK, key => {
            const nodeSelection = (0, lexicalLexical_js_1.$createNodeSelection)();
            nodeSelection.add(key);
            (0, lexicalLexical_js_1.$setSelection)(nodeSelection);
            SELECTED_DECORATORS = [key];
            setSelectedDecorators(editor);
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(CarouselImageNode, nodeMutations => {
            for (const [nodeKey, mutation] of nodeMutations) {
                if (mutation === 'created') {
                    const el_id = editor._config.namespace;
                    setTimeout(() => {
    ...
    if (editor.hasNode(InstagramNode))
        arr.push(registerInstagramEditable(editor));
    if (editor.hasNode(TwitterNode))
        arr.push(registerTwitterEditable(editor));
    if (editor.hasNode(TikTokNode))
        arr.push(registerTikTokEditable(editor));
    return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(...arr, editor.registerCommand(lexicalLexical_js_1.FORMAT_ELEMENT_COMMAND, formatType => {
        const selection = (0, lexicalLexical_js_1.$getSelection)();
        if ((0, lexicalLexical_js_1.$isNodeSelection)(selection) || (0, lexicalLexical_js_1.$isRangeSelection)(selection)) {
            const nodes = selection.getNodes();
            for (let node of nodes) {
                if ((0, lexicalLexical_js_1.$isDecoratorNode)(node)) {
                    ...
                    const element = (0, lexical_utilsLexicalUtils_js_1.$getNearestBlockElementAncestorOrThrow)(node);
        ...
        return false;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexicalLexical_js_1.CLICK_COMMAND, event => {
        var CLEAR_IMAGE = true;
        if (event.target) {
            var el = event.target;
            var i = 0;
            while (i < 10) {
                if (el.hasAttribute('data-frank-decorator'))
                    break;
                else {
                    el = el.parentElement;
                    if (!!!el)
                    ...
                    if (el.classList.contains('rte-image')) {
                        ...
                        if (img) {
                            ...
                            arr.forEach(dir => {
                                ...
                                if (!!!(0, lexical_sharedLexicalShared_js_1.isTouchDevice)())
                                    newDiv.addEventListener('mousedown', onImageResizeStart);
                                else
                                    newDiv.addEventListener('touchstart', onImageResizeStart);
                                div.append(newDiv);
                            });
                            ...
                            SELECTED_IMAGE = img;
                            if (wrapper)
                                setToolbarSelectedImage(wrapper);
                        }
                        if (div)
        ...
        return false;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexicalLexical_js_1.KEY_DELETE_COMMAND, payload => {
        const resp = onDeleteDecorators(editor, payload);
        if (window.closeFloatingContextMenu)
            window.closeFloatingContextMenu();
        return resp;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexicalLexical_js_1.KEY_BACKSPACE_COMMAND, payload => {
        const resp = onDeleteDecorators(editor, payload);
        if (window.closeFloatingContextMenu)
            window.closeFloatingContextMenu();
        return resp;
        ...
        if ((0, lexicalLexical_js_1.$isNodeSelection)(selection)) {
            ...
            if (isMathNode(nodes[0])) {
                ...
                Object.keys(decorators).forEach(key2 => {
                    if (key2 !== key && (0, lexicalLexical_js_1.$getNodeByKey)(key2) && isMathNode((0, lexicalLexical_js_1.$getNodeByKey)(key2)))
                        (0, lexicalLexical_js_1.$getNodeByKey)(key2).setEditable(false);
                });
            ...
            nodes.forEach(n => {
                ...
                if ($isHorizontalRuleNode(n) && editor.isEditable()) {
                    ...
                    const colorInput = document.getElementById('lex-horizontal-rule-color');
                    if (colorInput)
                        (0, lexical_sharedLexicalShared_js_1.setColorInput)(colorInput, color === 'var(--divider)' ? (0, lexical_sharedLexicalShared_js_1.getDefaultTextColor)() : color);
                    const widthInput = document.getElementById('lex-horizontal-rule-width');
                    if (widthInput) {
                        widthInput.value = String(width);
            ...
            for (let key of Object.keys(decorators)) {
                const node = (0, lexicalLexical_js_1.$getNodeByKey)(key);
                if (node && isMathNode(node) && node.getEditable())
                    node.setEditable(false);
            }
        }
        if (wrapper) {
            const wrapper = document.getElementById(editor._config.namespace) || ((_b = editor._rootElement) === null || _b === void 0 ? void 0 : _b.closest('div.lexical-wrapper'));
            if (wrapper) {
                if (SELECTED_IMAGE)
                    selectedTypes.add('image');
                const buttons = (0, lexical_sharedLexicalShared_js_1.getEditorButtons)(wrapper);
                Object.values(buttons).forEach(b => {
                    if (b && b.nodeName === "BUTTON") {
                        if (b.hasAttribute('data-lexical-image-button')) {
        ...
        return false;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_HIGH), editor.registerCommand(lexicalLexical_js_1.KEY_ENTER_COMMAND, e => {
        const selection = (0, lexicalLexical_js_1.$getSelection)();
                            ...
                            if (firstIndexBracket !== -1) {
                                ...
                                if (endBracketFirst !== -1) {
                                    ...
                                    if (firstGroup.startsWith('#'))
                                        ...
                                        width = parseInt(firstGroup);
                                    const newStr = textContent.slice(endBracketFirst + 1);
                                    if (newStr.length) {
                                        const secondGroup = newStr.slice(1, newStr.length - 1);
                                        if (secondGroup.startsWith('#'))
                                            hexColor = secondGroup;
                                        else
                                            width = parseInt(secondGroup);
                                    }
                                }
                            }
                            parent.remove();
        ...
        return false;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_HIGH), editor.registerCommand(lexical_rich_textLexicalRichText_js_1.DRAG_DROP_PASTE, files => {
        var _a;
        const wrapper = document.getElementById(editor._config.namespace) || ((_a = editor._rootElement) === null || _a === void 0 ? void 0 : _a.closest('div.lexical-wrapper'));
        if (files.length && wrapper) {
            ...
            if (file.type === "image/gif" && editor.hasNode(ImageNode)) {
                ...
                if (input) {
                    input.files = (0, lexical_sharedLexicalShared_js_1.getFileListForFileInput)([file]);
                ...
                if (imageButton) {
                    ...
                    if (files.length > 1) {
                        ...
                        if (input) {
                            input.files = (0, lexical_sharedLexicalShared_js_1.getFileListForFileInput)(imageFiles);
                            input.dispatchEvent(new Event("change"));
                            return true;
                        }
                    }
                ...
                if (audioButton) {
                    ...
                    if (audioInput) {
                        audioInput.files = (0, lexical_sharedLexicalShared_js_1.getFileListForFileInput)([file]);
                ...
                if (videoButton) {
                    ...
                    if (videoInput) {
                        videoInput.files = (0, lexical_sharedLexicalShared_js_1.getFileListForFileInput)([file]);
        ...
        return false;
    }, lexicalLexical_js_1.COMMAND_PRIORITY_HIGH), editor.registerCommand(lexicalLexical_js_1.DRAGSTART_COMMAND, event => {
        return $onDragStartImage(event);
    }, lexicalLexical_js_1.COMMAND_PRIORITY_HIGH), editor.registerCommand(lexicalLexical_js_1.DRAGOVER_COMMAND, event => {
        return $onDragOverImage(event);
    }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexicalLexical_js_1.DROP_COMMAND, event => {
...
exports.registerDecoratorsEditable = registerDecoratorsEditable;
function registerDecoratorsNotEditable(editor, setImagesInitialNotEditable = true) {
    if (editor.hasNode(ImageNode)) {
        if (setImagesInitialNotEditable) {
            editor.update(() => {
                const imageNodes = (0, lexicalLexical_js_1.$nodesOfType)(ImageNode);
...
exports.registerDecoratorsNotEditable = registerDecoratorsNotEditable;
...
exports.MIN_IMAGE_DIMENSION = MIN_IMAGE_DIMENSION;
const getUseragent = () => { var _a; return ((_a = window === null || window === void 0 ? void 0 : window.navigator) === null || _a === void 0 ? void 0 : _a.userAgent) || global.userAgent; };
const GET_MAX_IMAGE_WIDTH = editorType => {
    if (editorType === "comment" || editorType === "survey-question" || editorType === "survey-short-blog" || editorType === "survey-option" || editorType === "range-description") {
        return (0, lexical_sharedLexicalShared_js_1.isMobileDevice)(getUseragent()) ? MAX_WIDTH_MOBILE_COMMENT : MAX_WIDTH_DESKTOP_COMMENT;
    }
    else {
        return (0, lexical_sharedLexicalShared_js_1.isMobileDevice)(getUseragent()) ? MAX_WIDTH_MOBILE : MAX_WIDTH_DESKTOP;
    }
};
exports.GET_MAX_IMAGE_WIDTH = GET_MAX_IMAGE_WIDTH;
const GET_MAX_IMAGE_HEIGHT = editorType => {
    if (editorType === "comment" || editorType === "survey-question" || editorType === "survey-short-blog" || editorType === "survey-option" || editorType === "range-description") {
        return (0, lexical_sharedLexicalShared_js_1.isMobileDevice)(getUseragent()) ? MAX_HEIGHT_MOBILE_COMMENT : MAX_HEIGHT_DESKTOP_COMMENT;
    }
    else {
        return (0, lexical_sharedLexicalShared_js_1.isMobileDevice)(getUseragent()) ? MAX_HEIGHT_MOBILE : MAX_HEIGHT_DESKTOP;
    }
};
exports.GET_MAX_IMAGE_HEIGHT = GET_MAX_IMAGE_HEIGHT;
...
function getSizesAndAspectRatio(widthProperty, heightProperty) {
    ...
    const greatestCommonDenom = (0, lexical_sharedLexicalShared_js_1.gcd)(newWidthProperty, newHeightProperty);
...
class ImageNode extends lexicalLexical_js_1.DecoratorNode {
    constructor(obj, key) {
        super(key);
        this.__originalDevice = 'mobile';
        this.__version = CURRENT_VERSION$7;
        ...
        this.__dialogOnClick = false;
        if (obj.originalDevice)
            this.__originalDevice = obj.originalDevice;
        else
            this.__originalDevice = (0, lexical_sharedLexicalShared_js_1.getDeviceType)();
        if (obj.backgroundColor)
            this.__backgroundColor = obj.backgroundColor;
    }
    static getType() {
        return 'image';
    }
    ...
    createDOM(config) {
        ...
        if (this.getDialogOnClick())
            span.setAttribute('data-dialog-click', 'true');
        if (this.getBackgroundColor())
            span.setAttribute('data-bg-color', String(this.getBackgroundColor()));
        if (this.getFirstElement())
    ...
    decorate(editor, config) {
        ...
        if (element) {
            if (element.children.length === 0) {
                ...
                const img = document.createElement('img');
                if (this.getFirstElement())
                    img.classList.add('first-rte-element');
                if (this.getLastElement())
                    img.classList.add('last-rte-element');
                const bgColor = this.getBackgroundColor();
                if (bgColor) {
                ...
                if (!!!this.getDialogOnClick()) {
                    if ((0, lexical_sharedLexicalShared_js_1.isTouchDevice)())
                        img.addEventListener('dblclick', getOpenImageBackgroundColorDialog(this.__key, editor._config.namespace, this.getBackgroundColor(), this.getShort(), this.getLong()), true);
                    else
                        img.addEventListener('dblclick', getOpenImageBackgroundColorDialog(this.__key, editor._config.namespace, this.getBackgroundColor(), this.getShort(), this.getLong()), true);
                }
                ...
                const widthProperty = this.getWidth();
                const heightProperty = this.getHeight();
                if (!!!isNaN(widthProperty))
                    img.setAttribute('width', String(widthProperty.toFixed(0)));
                if (!!!isNaN(widthProperty))
                    img.style.setProperty('width', String(widthProperty.toFixed(0)).concat('px'));
                img.style.setProperty('max-width', '100%', 'important');
                if ((0, lexical_sharedLexicalShared_js_1.getDeviceType)() === "desktop" && !!!isNaN(widthProperty) && !!!isNaN(heightProperty)) {
...
function convertImageElement(node) {
    ...
    var backgroundColor;
    if (typeof backgroundColorString === "string" && lexicalLexical_js_1.VALID_HEX_REGEX.test(backgroundColorString)) {
    ...
    if (deviceTypePre === 'mobile' || deviceTypePre === 'tablet' || deviceTypePre === 'desktop')
        deviceType = deviceTypePre;
    var width;
    var height;
    if (!!!isNaN(widthNum))
        width = widthNum;
...
function $createImageNode(obj) {
    if (typeof obj.backgroundColor === "string" && !!!lexicalLexical_js_1.VALID_HEX_REGEX.test(obj.backgroundColor)) {
...
const INSERT_IMAGE_COMMAND = (0, lexicalLexical_js_1.createCommand)('INSERT_IMAGE_COMMAND');
exports.INSERT_IMAGE_COMMAND = INSERT_IMAGE_COMMAND;
const INSERT_IMAGES_COMMAND = (0, lexicalLexical_js_1.createCommand)('INSERT_IMAGES_COMMAND');
exports.INSERT_IMAGES_COMMAND = INSERT_IMAGES_COMMAND;
const getImg = () => {
...
const getDOMSelection = targetWindow => { var _a; return (_a = (targetWindow || window)) === null || _a === void 0 ? void 0 : _a.getSelection(); };
function canDropImage(event) {
    const target = event.target;
    return !!(target && (0, lexical_sharedLexicalShared_js_1.isHTMLElementCustom)(target) && !target.closest('code') && target.parentElement && target.parentElement.closest('div[data-rich-text-editor]'));
}
...
exports.$onDragStartImage = $onDragStartImage;
...
exports.$onDragOverImage = $onDragOverImage;
...
class CarouselImageNode extends lexicalLexical_js_1.DecoratorNode {
    constructor(imageList, key) {
        super(key);
        this.__version = CURRENT_VERSION$6;
...
exports.CarouselImageNode = CarouselImageNode;
function convertCarouselImageElement(div) {
    try {
        ...
        if (!!!imageList.length)
            throw new Error('No Valid Images in ImageType array.');
...
function getCarouselClick(key) {
    const onCarouselClick = function () {
        ...
        if (lexical_wrapper) {
            ...
            if (id) {
                const editor = (0, lexical_sharedLexicalShared_js_1.getEditorInstances)()[id];
                if (editor) {
...
exports.$isCarouselImageNode = $isCarouselImageNode;
function $createCarouselImageNode(imageList) {
    return new CarouselImageNode(imageList);
}
exports.$createCarouselImageNode = $createCarouselImageNode;
const INSERT_CAROUSEL_COMMAND = (0, lexicalLexical_js_1.createCommand)('INSERT_CAROUSEL_COMMAND');
exports.INSERT_CAROUSEL_COMMAND = INSERT_CAROUSEL_COMMAND;
...
class HtmlNode extends DecoratorBlockNode {
    constructor(html, key) {
        super(undefined, key);
        this.__version = HTML_NODE_VERSION;
...
const INSERT_HTML_COMMAND = (0, lexicalLexical_js_1.createCommand)('INSERT_HTML_COMMAND');
...
function registerHTMLNodeEditable(editor) {
    ...
    if (editor.hasNode(HtmlNode)) {
        ...
        return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(INSERT_HTML_COMMAND, payload => {
...
exports.registerHTMLNodeEditable = registerHTMLNodeEditable;
function registerHTMLNodeNotEditable(editor) {
    return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerEditableListener(editable => {
        editor.update(() => {
            const htmlNodes = (0, lexicalLexical_js_1.$nodesOfType)(HtmlNode);
            if (editable) {
...
exports.registerHTMLNodeNotEditable = registerHTMLNodeNotEditable;
...
function convertInstagramElement(domNode) {
    ...
    const node = $createInstagramNode(html);
    if (domNode.classList.contains('first-rte-element'))
        node.setFirstElement(true);
    if (domNode.classList.contains('last-rte-element'))
...
exports.$createInstagramNode = $createInstagramNode;
function $isInstagramNode(node) {
    return node instanceof InstagramNode;
}
exports.$isInstagramNode = $isInstagramNode;
const EMBED_INSTA_COMMAND = (0, lexicalLexical_js_1.createCommand)('EMBED_INSTA_COMMAND');
function handleInstagramFormSubmit(e) {
    ...
    try {
        ...
        if (!!!textarea)
            throw new Error("Unable to find textarea to embed instagram post.");
...
function registerInstagramEditable(editor) {
    if (editor.hasNode(InstagramNode)) {
        ...
        return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(EMBED_INSTA_COMMAND, embedCode => {
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(InstagramNode, nodeMutations => {
            for (const [nodeKey, mutation] of nodeMutations) {
                if (mutation === 'created') {
                    setTimeout(() => {
                        document.dispatchEvent(new CustomEvent("EMBED_INSTAGRAM"));
            ...
            const instagramNodes = (0, lexicalLexical_js_1.$nodesOfType)(InstagramNode);
...
exports.registerInstagramEditable = registerInstagramEditable;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
            ...
            if (rect) {
                ...
                if (height > 300) {
                    ...
                    if (wrapperNode && wrapper) {
                        ...
                        const id = wrapper.id;
                        const instances = (0, lexical_sharedLexicalShared_js_1.getEditorInstances)();
                        if (instances[id] && /\d+/.test(String(key))) {
                            const editor = instances[id];
                            editor.update(() => {
                                const node = (0, lexicalLexical_js_1.$getNodeByKey)(String(key));
                                if ($isTwitterNode(node)) {
                                    node.setCalculatedHeight({
                                        height,
                                        deviceDetected: (0, lexical_sharedLexicalShared_js_1.getDeviceType)()
                                    });
                                }
                            });
                        }
...
class TwitterNode extends DecoratorBlockNode {
    ...
    constructor(obj, format, key) {
        ...
        if (obj.calculatedHeight)
            this.__calculatedHeight = obj.calculatedHeight;
    }
    getHTML() {
        const self = this.getLatest();
        return self.__html;
...
exports.$createTwitterNode = $createTwitterNode;
function $isTwitterNode(node) {
    return node instanceof TwitterNode;
}
exports.$isTwitterNode = $isTwitterNode;
const EMBED_TWEET_COMMAND = (0, lexicalLexical_js_1.createCommand)('EMBED_TWEET_COMMAND');
function handleTwitterFormSubmit(e) {
    ...
    try {
        const textarea = this.querySelector('textarea');
        if (!!!textarea)
            throw new Error("Unable to find textarea to embed tweet.");
        const value = textarea.value;
        if (value && value.length) {
            Promise.resolve().then(() => __importStar(require(/* webpackChunkName: "personal-website-shared" */ '../personal-website-shared'))).then(res => {
...
function registerTwitterEditable(editor) {
    if (editor.hasNode(TwitterNode)) {
        ...
        return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(EMBED_TWEET_COMMAND, embedCode => {
            const node = $createTwitterNode({
                html: embedCode
            });
            (0, lexical_utilsLexicalUtils_js_1.$insertNodeToNearestRoot)(node);
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(TwitterNode, nodeMutations => {
            for (const [nodeKey, mutation] of nodeMutations) {
                if (mutation === 'created') {
                    setTimeout(() => {
                        document.dispatchEvent(new CustomEvent("EMBED_TWITTER"));
            ...
            const tiktokNodes = (0, lexicalLexical_js_1.$nodesOfType)(TwitterNode);
...
exports.registerTwitterEditable = registerTwitterEditable;
...
exports.$createRedditNode = $createRedditNode;
function $isRedditNode(node) {
    return node instanceof RedditNode;
}
exports.$isRedditNode = $isRedditNode;
const EMBED_REDDIT_COMMAND = (0, lexicalLexical_js_1.createCommand)('EMBED_REDDIT_COMMAND');
function handleRedditFormSubmit(e) {
    ...
    try {
        ...
        if (value && value.length) {
            Promise.resolve().then(() => __importStar(require(/* webpackChunkName: "personal-website-shared" */ '../personal-website-shared'))).then(res => {
                const { html: str, minHeight } = res.validateRedditEmbed(value);
                const editor = (0, lexical_sharedLexicalShared_js_1.getCurrentEditor)();
                if (editor) {
...
function registerRedditEditable(editor) {
    if (editor.hasNode(RedditNode)) {
        ...
        return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(EMBED_REDDIT_COMMAND, embedCode => {
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(RedditNode, nodeMutations => {
            for (const [nodeKey, mutation] of nodeMutations) {
                if (mutation === 'created') {
                    setTimeout(() => {
                        document.dispatchEvent(new CustomEvent("EMBED_REDDIT"));
            ...
            const redditNodes = (0, lexicalLexical_js_1.$nodesOfType)(RedditNode);
...
exports.registerRedditEditable = registerRedditEditable;
...
exports.$createTikTokNode = $createTikTokNode;
function $isTikTokNode(node) {
    return node instanceof TikTokNode;
}
exports.$isTikTokNode = $isTikTokNode;
const EMBED_TikTok_COMMAND = (0, lexicalLexical_js_1.createCommand)('EMBED_TikTok_COMMAND');
...
function registerTikTokEditable(editor) {
    if (editor.hasNode(TikTokNode)) {
        ...
        return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(EMBED_TikTok_COMMAND, embedCode => {
            ...
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(TikTokNode, nodeMutations => {
            for (const [nodeKey, mutation] of nodeMutations) {
                if (mutation === 'created') {
                    setTimeout(() => {
                        document.dispatchEvent(new CustomEvent("EMBED_TIKTOK"));
            ...
            const tiktokNodes = (0, lexicalLexical_js_1.$nodesOfType)(TikTokNode);
            if (tiktokNodes.length) {
                setTimeout(() => {
                    document.dispatchEvent(new CustomEvent("EMBED_TIKTOK"));
                }, 1000);
...
exports.registerTikTokEditable = registerTikTokEditable;
const CURRENT_VERSION$1 = 1;
class LoadingNode extends lexicalLexical_js_1.DecoratorNode {
    constructor(obj, key) {
        super(key);
        this.__version = CURRENT_VERSION$1;
        if (obj && obj.size)
            this.__size = obj.size;
        else
            this.__size = 'medium';
        if (obj && typeof obj.inline === "boolean")
            this.__inline = obj.inline;
        else
            this.__inline = true;
    }
    static clone(node) {
    ...
    static importDOM() {
        return {
            span: domNode => {
                if (domNode.getAttribute('data-lex-loader') !== 'true')
                    return null;
                return {
...
function convertLoadingElement(domNode) {
    var size;
    if (domNode.classList.contains('small'))
        size = 'small';
    else if (domNode.classList.contains('large'))
        size = 'large';
    else
        size = 'medium';
...
exports.$isLoadingNode = $isLoadingNode;
function $createLoadingNode({ size, inline }) {
    return new LoadingNode({
        size,
        inline
    });
}
exports.$createLoadingNode = $createLoadingNode;
const CURRENT_VERSION = 1;
class AiChatNode extends lexicalLexical_js_1.DecoratorNode {
    constructor(obj, key) {
        super(key);
    ...
    static importJSON({ chat_id, chat_name, html }) {
...
function $createAiChatNode({ chat_id, chat_name, html }) {
    return new AiChatNode({
        chat_id,
        chat_name,
        html
...
exports.$createAiChatNode = $createAiChatNode;
const INSERT_AI_CHAT_NODE = (0, lexicalLexical_js_1.createCommand)('INSERT_AI_CHAT_NODE');
exports.INSERT_AI_CHAT_NODE = INSERT_AI_CHAT_NODE;
