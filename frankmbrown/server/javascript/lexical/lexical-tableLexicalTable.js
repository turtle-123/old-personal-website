...
exports.registerTableNotEditableListener = exports.registerTableEditable = exports.isGridSelectionRectangular = exports.getTableSelectionFromTableElement = exports.getCellFromTarget = exports.currentCellBackgroundColor = exports.computeSelectionCount = exports.applyTableHandlers = exports.TableSelection = exports.TableRowNode = exports.TableNode = exports.TableCellNode = exports.TableCellHeaderStates = exports.INSERT_TABLE_COMMAND_WITH_DATA = exports.INSERT_TABLE_COMMAND = exports.CellParagraphNode = exports.$unmergeCell = exports.$selectLastDescendant = exports.$removeTableRowAtIndex = exports.$removeHighlightStyleToTable = exports.$isTableRowNode = exports.$isTableNode = exports.$isTableCellNode = exports.$isCellParagraphNode = exports.$insertTableRow__EXPERIMENTAL = exports.$insertTableRow = exports.$insertTableColumn__EXPERIMENTAL = exports.$insertTableColumn = exports.$getTableRowNodeFromTableCellNodeOrThrow = exports.$getTableRowIndexFromTableCellNode = exports.$getTableNodeFromLexicalNodeOrThrow = exports.$getTableColumnIndexFromTableCellNode = exports.$getTableCellNodeFromLexicalNode = exports.$getRowHeaderCellsInRange = exports.$getElementGridForTableNode = exports.$getColumnHeaderCellsInRange = exports.$deleteTableRow__EXPERIMENTAL = exports.$deleteTableColumn__EXPERIMENTAL = exports.$deleteTableColumn = exports.$createTableRowNode = exports.$createTableNodeWithDimensions = exports.$createTableNode = exports.$createTableCellNode = exports.$createCellParagraphNode = exports.$cellContainsEmptyParagraph = exports.$canUnmerge = void 0;
/**
...
/** @noInheritDoc */
class CellParagraphNode extends lexicalLexical_js_1.ElementNode {
    constructor(key) {
        super(key);
        this.__version = CURRENT_VERSION$3;
        this.__first = null;
        this.__last = null;
        this.__size = 0;
        this.__format = 2;
    ...
    collapseAtStart() {
        ...
        if (children.length === 0 || (0, lexicalLexical_js_1.$isTextNode)(children[0]) && children[0].getTextContent().trim() === '') {
...
exports.CellParagraphNode = CellParagraphNode;
...
function $createCellParagraphNode() {
    return (0, lexicalLexical_js_1.$applyNodeReplacement)(new CellParagraphNode());
}
exports.$createCellParagraphNode = $createCellParagraphNode;
function $isCellParagraphNode(node) {
    return node instanceof CellParagraphNode;
}
exports.$isCellParagraphNode = $isCellParagraphNode;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
/** @noInheritDoc */
class TableRowNode extends lexicalLexical_js_1.DEPRECATED_GridRowNode {
    static getType() {
        return 'tablerow';
    }
    static clone(node) {
    ...
    constructor(height, key) {
        super(key);
        /** @internal */
        this.__version = CURRENT_VERSION$2;
    ...
    createDOM(config) {
        ...
        (0, lexical_utilsLexicalUtils_js_1.addClassNamesToElement)(element, config.theme.tableRow);
        if (this.getFirstElement())
...
function $createTableRowNode(height) {
    return (0, lexicalLexical_js_1.$applyNodeReplacement)(new TableRowNode(height));
}
...
/** @noInheritDoc */
class TableNode extends lexicalLexical_js_1.DEPRECATED_GridNode {
    static getType() {
        return 'table';
    }
    static clone(node) {
    ...
    static importJSON(_serializedNode) {
        ...
        node.setFirstElement(_serializedNode === null || _serializedNode === void 0 ? void 0 : _serializedNode.first_element);
        return node;
    }
    constructor(obj, key) {
        super(key);
        ...
        this.__caption = obj === null || obj === void 0 ? void 0 : obj.caption;
        this.__bandedRows = (obj === null || obj === void 0 ? void 0 : obj.bandedRows) || false;
        this.__bandedCols = (obj === null || obj === void 0 ? void 0 : obj.bandedCols) || false;
        this.__align = (obj === null || obj === void 0 ? void 0 : obj.align) || 'center';
    }
    exportJSON() {
        return {
            ...super.exportJSON(),
    ...
    createDOM(config, editor) {
        ...
        (0, lexical_utilsLexicalUtils_js_1.addClassNamesToElement)(tableElement, config.theme.table);
        if (this.__caption) {
        ...
        if (this.__bandedRows)
            tableElement.classList.add('banded-row');
        if (this.__bandedCols)
            tableElement.classList.add('banded-col');
        ...
        if (this.getFirstElement())
            tableElement.classList.add('first-rte-element');
        if (this.getLastElement())
            tableElement.classList.add('last-rte-element');
        return tableElement;
    }
    updateDOM(prevNode, dom, config) {
        ...
        return {
            ...
            after: tableElement => {
                if (tableElement) {
                    ...
                    if ((0, lexical_utilsLexicalUtils_js_1.isHTMLElement)(tableElement)) {
                        ...
                        if (this.getLastElement() && !!!lexical_sharedLexicalShared_js_1.IS_REAL_BROWSER)
                            tableElement.classList.add('last-rte-element');
                        if (caption)
                            tableElement.setAttribute('data-caption', caption);
                        if (bandedCols)
                            tableElement.classList.add('banded-col');
                        if (bandedRows)
                            tableElement.classList.add('banded-row');
        ...
        for (let y = 0; y < rows; y++) {
            ...
            const x = row.findIndex(cell => {
                if (!cell)
                    return;
                const { elem } = cell;
                const cellNode = (0, lexicalLexical_js_1.$getNearestNodeFromDOMNode)(elem);
    ...
    getCellNodeFromCords(x, y, grid) {
        ...
        const node = (0, lexicalLexical_js_1.$getNearestNodeFromDOMNode)(cell.elem);
...
function convertTableElement(_domNode) {
    if ((0, lexical_sharedLexicalShared_js_1.isHTMLElementCustom)(_domNode)) {
        ...
        var align;
        if (alignText === ALIGN_LEFT_TEXT)
            align = "left";
        else if (alignText === ALIGN_CENTER_TEXT)
            align = "center";
        else if (alignText === ALIGN_RIGHT_TEXT)
            align = "right";
        const node = $createTableNode({
...
function $createTableNode(obj) {
    const tableNode = (0, lexicalLexical_js_1.$applyNodeReplacement)(new TableNode(obj));
    return tableNode;
}
...
function clearTableState(editorNamespace) {
    if (!!!TABLE_STATE[editorNamespace])
        TABLE_STATE[editorNamespace] = getDefaultTableState();
    ...
    if (dialog) {
        ...
        if (form) {
            ...
            if (Array.isArray(alignInputs)) {
                ...
                if (VALID_ALIGN_TABLE.has(alignValue))
                    align = alignValue;
            }
    ...
    if (tableForm) {
        ...
        if (output) {
            ...
            if (table) {
                ...
                if (tableForm.bandedCols && !!!table.classList.contains('banded-col'))
                    table.classList.add("banded-col");
                if (tableForm.bandedRows && !!!table.classList.contains('banded-row'))
                    table.classList.add("banded-row");
                if (tableForm.align === "left")
                    table.style.setProperty('margin', '10px auto 10px 0px', 'important');
                else if (tableForm.align === "center")
                    table.style.setProperty('margin', '10px auto', 'important');
                else if (tableForm.align === "right")
                    table.style.setProperty('margin', '10px 0px 10px auto', 'important');
                if (tableForm.includeCaption) {
                    if (tableForm.captionInput)
                        tableForm.captionInput.removeAttribute('disabled');
                    if (!!!captionEl) {
                    ...
                    if (captionEl)
                        captionEl.remove();
                    if (tableForm.captionInput)
                        tableForm.captionInput.setAttribute('disabled', '');
                }
                ...
                if (possibleTableColNodes.length) {
                    ...
                    if (tableForm.headingCol) {
                        possibleTableColNodes.forEach(cell => {
                            ...
                            if (cellToCheck.className !== cellHeadingClassName)
                                cellToCheck.className = cellHeadingClassName;
                        });
                    }
                    else {
                        possibleTableColNodes.forEach(cell => {
                            ...
                            if (cellToCheck.className !== cellClassName)
                                cellToCheck.className = cellClassName;
                        });
                    }
                }
...
function handleUploadData(e) {
    ...
    if (this.files && this.files.length && htmlEl && editor) {
        ...
        (0, lexical_sharedLexicalShared_js_1.openLoadingDialog)('Creating table from uploaded file...');
        fetch('/api/lexical-table', {
            ...
            (0, lexical_sharedLexicalShared_js_1.closeLoadingDialog)();
...
function handleUploadTableFormChange() {
    ...
    if (tableForm && editor) {
        ...
        if (submitButton) {
            if (RECENT_JSON && RECENT_JSON.editorNamespace === editor._config.namespace && submitButton.hasAttribute('disabled'))
                submitButton.removeAttribute('disabled');
            else if (!!!submitButton.hasAttribute('disabled') && (!!!RECENT_JSON || RECENT_JSON.editorNamespace !== editor._config.namespace))
...
function getEditTableForm() {
    ...
    if (form) {
        ...
        const align = Array.isArray(alignInputs) ? (_b = (_a = alignInputs.filter(inputEl => inputEl.checked)) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.value : 'center';
        return {
            bandedRowsCheckbox,
            bandedColsCheckbox,
            captionCheckbox,
...
function setEditTableForm({ bandedRows, bandedCols, caption, align }) {
    const form = getEditTableForm();
    if (form) {
        const { bandedRowsCheckbox, bandedColsCheckbox, captionCheckbox, captionInput, captionLabel, alignInputs } = form;
        if (bandedRowsCheckbox) {
            if (bandedRows)
                bandedRowsCheckbox.checked = true;
            else
                bandedRowsCheckbox.checked = false;
        }
        if (bandedColsCheckbox) {
            if (bandedCols)
                bandedColsCheckbox.checked = true;
            else
                bandedColsCheckbox.checked = false;
        }
        if (captionCheckbox) {
        ...
        if (captionLabel && captionInput) {
            if (caption === undefined)
                captionLabel.classList.add('disabled');
            else
                captionLabel.classList.remove('disabled');
        }
        if (Array.isArray(alignInputs)) {
...
function handleEditTableFormSubmit(e) {
    ...
    if (dialog && editor) {
        ...
        editor.update(() => {
            if (tempTableKey) {
                const table = (0, lexicalLexical_js_1.$getNodeByKey)(tempTableKey);
                if ($isTableNode(table)) {
                    if (bandedColsCheckbox && bandedColsCheckbox.checked !== table.getBandedCols())
                        table.setBandedCols(bandedColsCheckbox.checked);
                    if (bandedRowsCheckbox && bandedRowsCheckbox.checked !== table.getBandedRows())
                        table.setBandedRows(bandedRowsCheckbox.checked);
                    if (captionCheckbox) {
                        if (captionCheckbox.checked && captionInput)
                            table.setCaption(captionInput.value);
                        else
                            table.setCaption(undefined);
                    }
                    if (VALID_ALIGN_TABLE.has(tempAlignValue))
                        table.setAlign(tempAlignValue);
                }
            }
    ...
    if (menu) {
        ...
        buttons.forEach(b => {
            if (b.hasAttribute('data-table-merge')) {
                if (TABLE_STATE[editorNamespace].canMergeCells)
                    b.removeAttribute('hidden');
                else
                    b.setAttribute('hidden', '');
            }
            else if (b.hasAttribute('data-table-unmerge')) {
                if (TABLE_STATE[editorNamespace].canUnmergeCells)
                    b.removeAttribute('hidden');
                else
                    b.setAttribute('hidden', '');
            }
                ...
                if (TABLE_STATE[editorNamespace].canDeleteColumn)
                    b.removeAttribute('hidden');
                else
                    b.setAttribute('hidden', '');
                const columns = TABLE_STATE[editorNamespace].columns;
                ...
                const rows = TABLE_STATE[editorNamespace].rows;
                if (TABLE_STATE[editorNamespace].canAddRowHeader)
                    b.removeAttribute('hidden');
                else
                    b.setAttribute('hidden', '');
                ...
                const columns = TABLE_STATE[editorNamespace].columns;
                if (TABLE_STATE[editorNamespace].canAddColHeader)
                    b.removeAttribute('hidden');
                else
                    b.setAttribute('hidden', '');
                ...
                const rows = TABLE_STATE[editorNamespace].rows;
                if (TABLE_STATE[editorNamespace].canRemoveRowHeader)
                    b.removeAttribute('hidden');
                else
                    b.setAttribute('hidden', '');
                ...
                const columns = TABLE_STATE[editorNamespace].columns;
                if (TABLE_STATE[editorNamespace].canRemoveColHeader)
                    b.removeAttribute('hidden');
                else
                    b.setAttribute('hidden', '');
    ...
    if (menu) {
        ...
        const updatePopover = function () {
            const options = {
                ...
                middleware: [(0, dom_1.offset)(2), (0, dom_1.shift)(), (0, dom_1.flip)()]
            };
            if (!!!this.isConnected)
                handleTableActionButtonBlur();
        ...
        updatePopover();
        const cleanup = (0, dom_1.autoUpdate)(this, menu, updatePopover);
    ...
    if (editor) {
        ...
        editor.update(() => {
            ...
            if (TABLE_STATE[editorNamespace].selection && TABLE_STATE[editorNamespace].tableKey) {
                ...
                const firstCell = (_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell;
                ...
                if (key) {
                    if (tableSelections[editorNamespace]) {
                        ...
                        if (tableSelection instanceof TableSelection)
...
function unmergeCells(e) {
    ...
    if (editor) {
        ...
        editor.update(() => {
            var _a, _b;
            if ((_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell)
                ((_b = TABLE_STATE[editorNamespace]) === null || _b === void 0 ? void 0 : _b.activeCell).setActive(false);
            $unmergeCell();
            const key = TABLE_STATE[editorNamespace].tableKey;
            clearTableState(editorNamespace);
            handleTableActionButtonBlur();
...
function insertRowAbove(e) {
    ...
    if (editor) {
        ...
        editor.update(() => {
            var _a, _b;
            if (((_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell) && TABLE_STATE[editorNamespace].rows) {
                ((_b = TABLE_STATE[editorNamespace]) === null || _b === void 0 ? void 0 : _b.activeCell).setActive(false);
                const rows = TABLE_STATE[editorNamespace].rows;
...
function insertColRight(e) {
    ...
    if (editor) {
        ...
        editor.update(() => {
            var _a, _b;
            if (((_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell) && TABLE_STATE[editorNamespace].columns) {
                ((_b = TABLE_STATE[editorNamespace]) === null || _b === void 0 ? void 0 : _b.activeCell).setActive(false);
                const columns = TABLE_STATE[editorNamespace].columns;
...
function deleteTable(e) {
    ...
    if (editor) {
        ...
        editor.update(() => {
            ...
            if ((_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell) {
                ((_b = TABLE_STATE[editorNamespace]) === null || _b === void 0 ? void 0 : _b.activeCell).setActive(false);
                const tableNode = $getTableNodeFromLexicalNodeOrThrow((_c = TABLE_STATE[editorNamespace]) === null || _c === void 0 ? void 0 : _c.activeCell);
                const key = TABLE_STATE[editorNamespace].tableKey;
                clearTableState(editorNamespace);
                if (tableNode) {
                    const parent = tableNode.getParent();
                    if ((0, lexicalLexical_js_1.$isTableWrapperNode)(parent)) {
                        parent.remove();
                    }
                    else {
                        tableNode.remove();
    ...
    if (editor) {
        ...
        editor.update(() => {
            ...
            if (TABLE_STATE[editorNamespace].rowIndexes.size && TABLE_STATE[editorNamespace].tableKey) {
                if ((_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell)
                    ((_b = TABLE_STATE[editorNamespace]) === null || _b === void 0 ? void 0 : _b.activeCell).setActive(false);
                const table = (0, lexicalLexical_js_1.$getNodeByKey)(TABLE_STATE[editorNamespace].tableKey);
                ...
                if ($isTableNode(table) && !!!isNaN(minRow) && !!!isNaN(maxRow)) {
                    ...
                    if (rowHeaders)
                        rowHeaders.forEach(cell => cell.setHeaderStyles(2));
                }
            }
            const key = TABLE_STATE[editorNamespace].tableKey;
            clearTableState(editorNamespace);
        ...
        editor.update(() => {
            ...
            if (TABLE_STATE[editorNamespace].colIndexes.size && TABLE_STATE[editorNamespace].tableKey) {
                ...
                if ($isTableNode(table) && !!!isNaN(minCol) && !!!isNaN(maxCol)) {
                    ...
                    if (colHeaders)
                        colHeaders.forEach(cell => cell.setHeaderStyles(3));
                }
            }
            const key = TABLE_STATE[editorNamespace].tableKey;
            clearTableState(editorNamespace);
        ...
        editor.update(() => {
            ...
            if (TABLE_STATE[editorNamespace].rowIndexes.size && TABLE_STATE[editorNamespace].tableKey) {
                ...
                if ($isTableNode(table) && !!!isNaN(minRow) && !!!isNaN(maxRow)) {
                    const rowHeaders = $getRowHeaderCellsInRange(table, minRow, maxRow);
                    if (rowHeaders)
                        rowHeaders.forEach(cell => cell.setHeaderStyles(0));
                }
            }
            const key = TABLE_STATE[editorNamespace].tableKey;
            clearTableState(editorNamespace);
        ...
        editor.update(() => {
            ...
            if (TABLE_STATE[editorNamespace].colIndexes.size && TABLE_STATE[editorNamespace].tableKey) {
                ...
                if ($isTableNode(table) && !!!isNaN(minCol) && !!!isNaN(maxCol)) {
                    const colHeaders = $getColumnHeaderCellsInRange(table, minCol, maxCol);
                    if (colHeaders)
                        colHeaders.forEach(cell => cell.setHeaderStyles(0));
                }
            }
            const key = TABLE_STATE[editorNamespace].tableKey;
            clearTableState(editorNamespace);
...
function setTableActionMenuButtonsListeners() {
    ...
    if (menu) {
        ...
        for (let b of buttons) {
            if (b.hasAttribute('data-table-merge'))
                b.addEventListener('click', mergeCells);
            else if (b.hasAttribute('data-table-unmerge'))
                b.addEventListener('click', unmergeCells);
            else if (b.hasAttribute('data-table-row-above'))
                b.addEventListener('click', insertRowAbove);
            else if (b.hasAttribute('data-table-row-below'))
                b.addEventListener('click', insertRowBelow);
            else if (b.hasAttribute('data-table-col-left'))
                b.addEventListener('click', insertColRight);
            else if (b.hasAttribute('data-table-col-right'))
                b.addEventListener('click', insertColLeft);
            else if (b.hasAttribute('data-table-delete-row'))
                b.addEventListener('click', deleteRow);
            else if (b.hasAttribute('data-table-delete-column'))
                b.addEventListener('click', deleteColumn);
            else if (b.hasAttribute('data-table-delete-table'))
                b.addEventListener('click', deleteTable);
            else if (b.hasAttribute('data-table-add-row-header'))
                b.addEventListener('click', addRowHeader);
            else if (b.hasAttribute('data-table-add-col-header'))
                b.addEventListener('click', addColumnHeader);
            else if (b.hasAttribute('data-table-remove-row-header'))
                b.addEventListener('click', removeRowHeader);
            else if (b.hasAttribute('data-table-remove-col-header'))
                b.addEventListener('click', removeColumnHeader);
            else
                continue;
        }
    }
...
function parseBorderStr(s) {
    try {
        ...
        const style = lexicalLexical_js_1.ALLOWED_BORDER_STYLES.has(styleStr.trim()) ? styleStr.trim() : undefined;
        const color = String((0, lexicalLexical_js_1.parseColorStr)(colorStr.trim(), (0, lexical_sharedLexicalShared_js_1.getDefaultTextColor)()));
        return {
            width,
            style,
            color
...
function handleChangeCellsFormSubmit(e) {
    ...
    const dialog = this.closest('div.dialog-wrapper');
    const editor = (0, lexical_sharedLexicalShared_js_1.getCurrentEditor)();
    const { colorInput, transparentInput, borderColor, transparentBorder, borderStyle, borderWidth, verticalAlign } = getChangeCellsForm();
    if (colorInput && transparentInput && editor && dialog && borderColor && transparentBorder && borderStyle && borderWidth) {
        ...
        const newBackgroundColor = transparentInput.checked ? null : lexicalLexical_js_1.VALID_HEX_REGEX.test(colorInput.value) ? colorInput.value : null;
        const newBorderColor = transparentBorder.checked ? undefined : lexicalLexical_js_1.VALID_HEX_REGEX.test(borderColor.value) ? borderColor.value : undefined;
        const newBorderStyle = lexicalLexical_js_1.ALLOWED_BORDER_STYLES.has(borderStyle.value) ? borderStyle.value : undefined;
        ...
        else if (((_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell) && editor) {
            editor.update(() => {
                var _a;
                ((_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell).setCustomStyles({
                    border: newBorder,
                    backgroundColor: newBackgroundColor,
                    verticalAlign: newVerticalAlign
                });
...
function handleChangeCellsFormReset(e) {
    const { form, colorInput, transparentInput, verticalAlign, borderColor, transparentBorder, borderStyle, borderWidth } = getChangeCellsForm();
    if (form && colorInput && transparentInput && verticalAlign && borderColor && transparentBorder && borderStyle && borderWidth) {
        const backgroundColor = (0, lexical_sharedLexicalShared_js_1.getDefaultBackground)();
        ...
        Array.from(form.querySelectorAll('input[name="table-cell-vertical-align"]')).forEach(input => {
            if (input.value !== defaultVerticalAlign)
                input.checked = false;
            else
                input.checked = true;
        });
        const defaultBorder = (0, lexical_sharedLexicalShared_js_1.getDefaultTextColor)();
        borderColor.value = defaultBorder;
        transparentBorder.checked = true;
        (0, lexical_sharedLexicalShared_js_1.setSelectInput)(borderStyle, 'none', 'None');
        borderWidth.value = '0';
    }
}
...
function handleTableFormChange() {
    ...
    if (tableForm && tableForm.preview) {
        ...
        if (tableForm.bandedCols && tableForm.bandedRows)
            table.classList.add("banded-col", "banded-row");
        else if (tableForm.bandedCols)
            table.classList.add("banded-col");
        else if (tableForm.bandedRows)
            table.classList.add("banded-row");
        if (tableForm.align === "left")
            table.style.setProperty('margin', '10px auto 10px 0px', 'important');
        else if (tableForm.align === "center")
...
function handleTableFormSubmit(e) {
    ...
    if (tableForm && tableForm.preview) {
        ...
        if (editor) {
            ...
            handleTableActionButtonBlur();
            (0, lexical_sharedLexicalShared_js_1.closeDialog)(tableForm.dialog);
        }
    }
}
function handleTableFormReset(e) {
    if (this.id === "lexical-insert-table-form")
        handleTableFormChange.bind(this)();
...
function initializeTableNode(editor, tableNode) {
    ...
    if (tableElement && (!!!tableSelections[id] || !!!tableSelections[id].has(nodeKey))) {
        ...
        if (!!!tableSelections[id])
            tableSelections[id] = new Map();
...
function clearEditorTableSelection(editorNamespace) {
    const EDITOR_INSTANCES = (0, lexical_sharedLexicalShared_js_1.getEditorInstances)();
...
function $handleDispatchCommandOnGridSelection(editor, selection, dispatchObj) {
    switch (dispatchObj.name) {
        case 'FORMAT_TEXT_COMMAND':
            {
                editor.dispatchCommand(lexicalLexical_js_1.FORMAT_TEXT_COMMAND, dispatchObj.formatType);
                break;
            }
        case 'TEXT_COLOR_CHANGE':
            {
                if (!!!(0, lexical_sharedLexicalShared_js_1.getNoColor)(editor))
                    (0, lexical_toolbarLexicalToolbar_js_1.textColorChangeCallback)(selection, dispatchObj.color);
                break;
            }
        case 'MAKE_TRANSPARENT':
            {
                (0, lexical_toolbarLexicalToolbar_js_1.makeTransparentCallback)(selection, dispatchObj.payload);
                break;
            }
        case 'CLEAR_TEXT_FORMATTING':
            {
                (0, lexical_toolbarLexicalToolbar_js_1.clearTextFormattingCallback)(selection);
                break;
            }
        case 'BACKGROUND_COLOR_CHANGE':
            {
                if (!!!(0, lexical_sharedLexicalShared_js_1.getNoColor)(editor))
                    (0, lexical_toolbarLexicalToolbar_js_1.backgroundColorChangeCallback)(selection, dispatchObj.color);
                break;
            }
        case 'FONT_FAMILY_CHANGE':
            {
                (0, lexical_toolbarLexicalToolbar_js_1.fontFamilyChangeCallback)(selection, dispatchObj.fontWithSemiColon);
                break;
            }
        case 'FONT_WEIGHT_CHANGE':
            {
                (0, lexical_toolbarLexicalToolbar_js_1.fontWeightChangeCallback)(selection, dispatchObj.fontWeight);
                break;
            }
        case 'FONT_SIZE_CHANGE':
            {
                if ((0, lexical_sharedLexicalShared_js_1.editorCanChangeSize)(editor))
                    (0, lexical_toolbarLexicalToolbar_js_1.fontSizeChangeCallback)(selection, dispatchObj.fontSize);
                break;
            }
    }
    return true;
...
function handleFocusOut(e) {
    FOCUS_OUT_TIMEOUT = setTimeout(() => {
        ...
        const editor = (0, lexical_sharedLexicalShared_js_1.getEditorInstances)()[editorNamespace];
        if (editor) {
            editor.update(() => {
                var _a;
                const activeCell = (_a = TABLE_STATE[editorNamespace]) === null || _a === void 0 ? void 0 : _a.activeCell;
...
function $onTableSelectionChange(editor) {
    ...
    const editorNamespace = editor._config.namespace;
    if (RECENT_JSON && editorNamespace !== RECENT_JSON.editorNamespace)
        RECENT_JSON = undefined;
    const selection = (0, lexicalLexical_js_1.$getSelection)();
    if (LAST_SELECTED_TABLE_NAMESPACE !== editorNamespace)
    ...
    if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
        ...
        const anchorNode = (0, lexicalLexical_js_1.$getNodeByKey)(anchorKey);
        if (anchorNode) {
            if ($isTableCellNode(anchorNode)) {
                if (TABLE_STATE[editorNamespace]) {
                    TABLE_STATE[editorNamespace].activeCell = anchorNode;
                    if (editor.isEditable())
                        ((_c = TABLE_STATE[editorNamespace]) === null || _c === void 0 ? void 0 : _c.activeCell).setActive(true);
                }
            }
        }
        ...
        for (let node of selection.getNodes()) {
            if ($isTableCellNode(node)) {
                ...
                if (backgroundColorCell !== 'transparent') {
                    ...
                    if (backgroundColorCell === undefined)
                        backgroundColorCell = bgColor ? bgColor : 'transparent';
                    else
                        backgroundColorCell = bgColor === backgroundColorCell ? backgroundColorCell : 'transparent';
                }
                    ...
                    for (let row of rowIndexes) {
                        for (let col of colIndexes) {
                            ...
                            if (rowHeader) {
                                ...
                                if (!!!canRemoveRowHeader)
                                    canRemoveRowHeader = Boolean(rowHeader.getTag() === 'th' && rowHeader.getScope() === 'row');
                            }
                            if (colHeader) {
                                if (!!!canAddColHeader)
                                    canAddColHeader = Boolean(colHeader.getTag() !== 'th' || colHeader.getScope() !== 'col');
                                if (!!!canRemoveColHeader)
                                    canRemoveColHeader = Boolean(colHeader.getTag() === 'th' && colHeader.getScope() === 'col');
                            }
                        }
                    }
                }
        ...
        for (let node of selectionNodes) {
            const tableCellNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(node, n => $isTableCellNode(n));
        ...
        if (newActiveCell) {
            if (((_d = TABLE_STATE[editorNamespace]) === null || _d === void 0 ? void 0 : _d.activeCell) && ((_e = TABLE_STATE[editorNamespace]) === null || _e === void 0 ? void 0 : _e.activeCell).getKey() !== newActiveCell.getKey()) {
                handleTableActionButtonBlur();
                ((_f = TABLE_STATE[editorNamespace]) === null || _f === void 0 ? void 0 : _f.activeCell).setActive(false);
            }
            if (TABLE_STATE[editorNamespace]) {
            ...
            const rowIndexes = new Set();
            const colIndexes = new Set();
            const rowIndex = $getTableRowIndexFromTableCellNode((_g = TABLE_STATE[editorNamespace]) === null || _g === void 0 ? void 0 : _g.activeCell);
            const colIndex = $getTableColumnIndexFromTableCellNode((_h = TABLE_STATE[editorNamespace]) === null || _h === void 0 ? void 0 : _h.activeCell);
            rowIndexes.add(rowIndex);
            colIndexes.add(colIndex);
            const table = $getTableNodeFromLexicalNodeOrThrow((_j = TABLE_STATE[editorNamespace]) === null || _j === void 0 ? void 0 : _j.activeCell);
            if (table) {
                TABLE_STATE[editorNamespace].tableKey = table.getKey();
                bandedCols = table.getBandedCols();
                bandedRows = table.getBandedRows();
            ...
            TABLE_STATE[editorNamespace].rectangular = Boolean(((_k = TABLE_STATE[editorNamespace]) === null || _k === void 0 ? void 0 : _k.activeCell).getRowSpan() === ((_l = TABLE_STATE[editorNamespace]) === null || _l === void 0 ? void 0 : _l.activeCell).getColSpan());
            TABLE_STATE[editorNamespace].canMergeCells = false;
            TABLE_STATE[editorNamespace].canUnmergeCells = $canUnmerge();
            ...
            if ((_m = TABLE_STATE[editorNamespace]) === null || _m === void 0 ? void 0 : _m.activeCell) {
                handleTableActionButtonBlur();
                ((_o = TABLE_STATE[editorNamespace]) === null || _o === void 0 ? void 0 : _o.activeCell).setActive(false);
            }
            clearTableState(editorNamespace);
        }
    }
    else {
        if ((_p = TABLE_STATE[editorNamespace]) === null || _p === void 0 ? void 0 : _p.activeCell) {
            handleTableActionButtonBlur();
            ((_q = TABLE_STATE[editorNamespace]) === null || _q === void 0 ? void 0 : _q.activeCell).setActive(false);
        }
    }
...
function $setActiveCell(editor, cell) {
    ...
    if (TABLE_STATE[editor._config.namespace].activeCell) {
        (_a = TABLE_STATE[editor._config.namespace].activeCell) === null || _a === void 0 ? void 0 : _a.setActive(false);
        cell.setActive(true);
...
function getOnOpenEditTableDialog(e) {
    if (e.detail.el.id === "edit-table-lexical") {
        ...
        if (editTableIncludeCaption)
            editTableIncludeCaption.addEventListener('change', handleEditTableIncludeCaptionChange);
        if (editTableForm) {
...
function getOnOpenEditTableCellDialog(e) {
    ...
    if (e.detail.el.id === "lexical-table-cell-bg") {
        ...
        const editor = (0, lexical_sharedLexicalShared_js_1.getCurrentEditor)();
        const { colorInput, transparentInput, borderColor, transparentBorder, borderStyle, borderWidth, verticalAlign, form } = getChangeCellsForm();
        if (editor && borderColor && transparentBorder && borderStyle && borderWidth && verticalAlign && colorInput && transparentInput && form) {
            const canChangeColor = (0, lexical_sharedLexicalShared_js_1.getNoColor)(editor);
            if (!!!canChangeColor)
            ...
            if (TABLE_STATE[id].selection && editor) {
                editor.getEditorState().read(() => {
                    ...
                    for (let node of nodes) {
                        if ($isTableCellNode(node)) {
                            ...
                            if (bgColor === undefined)
                                bgColor = nodeBgColor;
                            else if (bgColor !== nodeBgColor)
                                bgColor = null;
                            if (border === null)
                                border = nodeBorder;
                            else if (border !== nodeBorder)
                                border = undefined;
                        }
                    }
                    // Set the form inputs
                    ...
                    if (border) {
                        ...
                        (0, lexical_sharedLexicalShared_js_1.setSelectInput)(borderStyle, style ? style : 'none', style ? style[0].toUpperCase().concat(style.slice(1)) : 'None');
            ...
            else if (((_a = TABLE_STATE[id]) === null || _a === void 0 ? void 0 : _a.activeCell) && editor) {
                editor.getEditorState().read(() => {
                    var _a, _b, _c;
                    const bgColor = ((_a = TABLE_STATE[id]) === null || _a === void 0 ? void 0 : _a.activeCell).getBackgroundColor();
                    const border = ((_b = TABLE_STATE[id]) === null || _b === void 0 ? void 0 : _b.activeCell).getBorder();
                    const verticalAlign = ((_c = TABLE_STATE[id]) === null || _c === void 0 ? void 0 : _c.activeCell).getVerticalAlign();
                    // Set the form inputs
                    const backgroundColor = (0, lexical_sharedLexicalShared_js_1.getDefaultBackground)();
                    colorInput.value = !!!bgColor ? backgroundColor : bgColor;
                    transparentInput.checked = !!!bgColor;
...
function getOnOpenTablesLexical(e) {
    if (e.detail.el.id === "tables-lexical") {
        ...
        if (mainTableForm && mainTableForm.form) {
            if (mainTableForm.captionInput)
                mainTableForm.captionInput.addEventListener('input', handleTableFormChange);
        ...
        if (uploadTableFrom && uploadTableFrom.form) {
            if (uploadTableFrom.fileUpload)
                uploadTableFrom.fileUpload.addEventListener('change', handleUploadData);
            if (uploadTableFrom.form) {
                if (uploadTableFrom.captionInput)
                    uploadTableFrom.captionInput.addEventListener('input', handleUploadTableFormChange);
        ...
        if (UPLOAD_CURRENT_FILE) {
            ...
            if (tabButton) {
                ...
                if (input) {
                    input.files = (0, lexical_sharedLexicalShared_js_1.getFileListForFileInput)([UPLOAD_CURRENT_FILE]);
...
function registerTableEditableListeners(editor) {
    ...
    if (wrapper)
        wrapper.addEventListener('focusout', handleFocusOut, true);
    const menu = document.getElementById(TABLE_ACTION_MENU_ID);
    if (menu)
        menu.addEventListener('focusin', handleTableActionMenuFocusIn);
}
function registerTableEditable(editor) {
    const editorNamespace = editor._config.namespace;
    if (editor.hasNodes([TableCellNode, TableNode, TableRowNode, lexicalLexical_js_1.TableWrapperNode, CellParagraphNode])) {
        ...
        if (editor.isEditable()) {
            editor.getEditorState().read(() => {
                const tableNodes = (0, lexicalLexical_js_1.$nodesOfType)(TableNode);
                tableNodes.forEach(node => {
                    if (!!!(0, lexicalLexical_js_1.$isTableWrapperNode)(node.getParent()))
                        (0, lexical_utilsLexicalUtils_js_1.$wrapNodeInElement)(node, lexicalLexical_js_1.$createTableWrapperNode);
                    initializeTableNode(editor, node);
                });
            });
        }
        return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(INSERT_TABLE_COMMAND, ({ rows, columns, includeHeaders, caption, bandedRows, bandedCols, align }) => {
            ...
            const wrapper = (0, lexicalLexical_js_1.$createTableWrapperNode)();
            (0, lexical_utilsLexicalUtils_js_1.$insertNodeToNearestRoot)(wrapper);
            wrapper.append(tableNode);
            const firstDescendant = tableNode.getFirstDescendant();
            if ((0, lexicalLexical_js_1.$isTextNode)(firstDescendant)) {
                firstDescendant.select();
            }
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerCommand(INSERT_TABLE_COMMAND_WITH_DATA, ({ rows, columns, includeHeaders, caption, bandedRows, bandedCols, align, json }) => {
            const tableNode = $createTableNodeWithDimensions(Number(rows), Number(columns), includeHeaders, caption, bandedRows, bandedCols, align);
                    ...
                    for (let j = 0; j < cellNodes.length; j++) {
                        ...
                        if ($isTableCellNode(cellNode)) {
                            ...
                            if ($isCellParagraphNode(cellParagraph)) {
                                ...
                                replacementNode.append((0, lexicalLexical_js_1.$createTextNode)(json[i][j]));
            ...
            RECENT_JSON = undefined;
            return true;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_EDITOR), editor.registerMutationListener(TableNode, nodeMutations => {
            for (const [nodeKey, mutation] of nodeMutations) {
                if (mutation === 'created') {
                    editor.getEditorState().read(() => {
                        const tableNode = (0, lexicalLexical_js_1.$getNodeByKey)(nodeKey);
                        if ($isTableNode(tableNode)) {
                            if (!!!(0, lexicalLexical_js_1.$isTableWrapperNode)(tableNode.getParent()))
                                (0, lexical_utilsLexicalUtils_js_1.$wrapNodeInElement)(tableNode, lexicalLexical_js_1.$createTableWrapperNode);
        ...
        }), editor.registerCommand(lexicalLexical_js_1.SELECTION_CHANGE_COMMAND, () => {
            $onTableSelectionChange(editor);
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_CRITICAL), editor.registerCommand(lexicalLexical_js_1.FORMAT_TEXT_COMMAND, formatType => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexicalLexical_js_1.FORMAT_TEXT_COMMAND,
                    name: 'FORMAT_TEXT_COMMAND',
                    formatType
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexicalLexical_js_1.FORMAT_ELEMENT_COMMAND, elementFormat => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                ...
                for (let node of nodes) {
                    if ($isTableCellNode(node)) {
                        ...
                        for (let child of children) {
                            if ((0, lexicalLexical_js_1.$isElementNode)(child)) {
            ...
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_sharedLexicalShared_js_1.TEXT_COLOR_CHANGE, color => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexical_sharedLexicalShared_js_1.TEXT_COLOR_CHANGE,
                    name: 'TEXT_COLOR_CHANGE',
                    color
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_sharedLexicalShared_js_1.BACKGROUND_COLOR_CHANGE, color => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexical_sharedLexicalShared_js_1.BACKGROUND_COLOR_CHANGE,
                    name: 'BACKGROUND_COLOR_CHANGE',
                    color
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_sharedLexicalShared_js_1.MAKE_TRANSPARENT, payload => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexical_sharedLexicalShared_js_1.MAKE_TRANSPARENT,
                    name: 'MAKE_TRANSPARENT',
                    payload
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_sharedLexicalShared_js_1.CLEAR_TEXT_FORMATTING, () => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexical_sharedLexicalShared_js_1.CLEAR_TEXT_FORMATTING,
                    name: 'CLEAR_TEXT_FORMATTING'
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_toolbarLexicalToolbar_js_1.FONT_FAMILY_CHANGE, fontFamily => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexical_toolbarLexicalToolbar_js_1.FONT_FAMILY_CHANGE,
                    name: 'FONT_FAMILY_CHANGE',
                    fontWithSemiColon: fontFamily
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_toolbarLexicalToolbar_js_1.FONT_WEIGHT_CHANGE, fontWeight => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexical_toolbarLexicalToolbar_js_1.FONT_WEIGHT_CHANGE,
                    name: 'FONT_WEIGHT_CHANGE',
                    fontWeight
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_toolbarLexicalToolbar_js_1.FONT_SIZE_CHANGE, fontSize => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
                return $handleDispatchCommandOnGridSelection(editor, selection, {
                    command: lexical_toolbarLexicalToolbar_js_1.FONT_SIZE_CHANGE,
                    name: 'FONT_SIZE_CHANGE',
                    fontSize
                });
            }
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_LOW), editor.registerCommand(lexical_rich_textLexicalRichText_js_1.DRAG_DROP_PASTE, files => {
            if (files.length) {
                const file = files[0];
            ...
            return false;
        }, lexicalLexical_js_1.COMMAND_PRIORITY_HIGH), registerTableNotEditableListener(editor), editor.registerCommand(lexical_sharedLexicalShared_js_1.REGISTER_TOOLBAR_LISTENERS, () => {
            registerTableEditableListeners(editor);
            return false;
...
exports.registerTableEditable = registerTableEditable;
/**
...
function registerTableNotEditableListener(editor) {
    const editorNamespace = editor._config.namespace;
    return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerEditableListener(isEditable => {
        const editorNamespace = editor._config.namespace;
        ...
        if (isEditable) {
            editor.update(() => {
                const tableCellNodes = (0, lexicalLexical_js_1.$nodesOfType)(TableCellNode);
    ...
    }), editor.registerCommand(lexical_sharedLexicalShared_js_1.SET_EDITOR_COMMAND, newEditorNamespace => {
        ...
        if (RECENT_JSON && RECENT_JSON.editorNamespace === editor._config.namespace)
            RECENT_JSON = undefined;
    });
}
exports.registerTableNotEditableListener = registerTableNotEditableListener;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
class TableSelection {
    ...
    clearHighlight() {
        ...
        editor.update(() => {
            const tableNode = (0, lexicalLexical_js_1.$getNodeByKey)(this.tableNodeKey);
            if (!$isTableNode(tableNode)) {
            ...
            (0, lexicalLexical_js_1.$setSelection)(null);
    ...
    enableHighlightStyle() {
        ...
        editor.update(() => {
            ...
            (0, lexical_utilsLexicalUtils_js_1.removeClassNamesFromElement)(tableElement, editor._config.theme.tableSelection);
    ...
    disableHighlightStyle() {
        ...
        editor.update(() => {
            ...
            (0, lexical_utilsLexicalUtils_js_1.addClassNamesToElement)(tableElement, editor._config.theme.tableSelection);
    ...
    setFocusCellForSelection(cell, ignoreStart = false) {
        ...
        editor.update(() => {
            ...
            if (this.isHighlightingCells) {
                const focusTableCellNode = (0, lexicalLexical_js_1.$getNearestNodeFromDOMNode)(cell.elem);
                if (this.gridSelection != null && this.anchorCellNodeKey != null && $isTableCellNode(focusTableCellNode)) {
                    const focusNodeKey = focusTableCellNode.getKey();
                    this.gridSelection = this.gridSelection.clone() || (0, lexicalLexical_js_1.DEPRECATED_$createGridSelection)();
                    this.focusCellNodeKey = focusNodeKey;
                    this.gridSelection.set(this.tableNodeKey, this.anchorCellNodeKey, this.focusCellNodeKey);
                    (0, lexicalLexical_js_1.$setSelection)(this.gridSelection);
                    editor.dispatchCommand(lexicalLexical_js_1.SELECTION_CHANGE_COMMAND, undefined);
                    $updateDOMForSelection(editor, this.grid, this.gridSelection);
                }
            }
    ...
    setAnchorCellForSelection(cell) {
        ...
        this.anchorY = cell.y;
        this.editor.update(() => {
            const anchorTableCellNode = (0, lexicalLexical_js_1.$getNearestNodeFromDOMNode)(cell.elem);
            if ($isTableCellNode(anchorTableCellNode)) {
                $setActiveCell(this.editor, anchorTableCellNode);
                const anchorNodeKey = anchorTableCellNode.getKey();
                this.gridSelection = this.gridSelection != null ? this.gridSelection.clone() : (0, lexicalLexical_js_1.DEPRECATED_$createGridSelection)();
    ...
    formatCells(type) {
        this.editor.update(() => {
            ...
            const formatSelection = (0, lexicalLexical_js_1.$createRangeSelection)();
            ...
            this.editor.dispatchCommand(lexicalLexical_js_1.SELECTION_CHANGE_COMMAND, undefined);
        });
    }
    clearText() {
        const editor = this.editor;
        editor.update(() => {
            ...
            selectedNodes.forEach(cellNode => {
                if ((0, lexicalLexical_js_1.$isElementNode)(cellNode)) {
                    const paragraphNode = $createCellParagraphNode();
                    const textNode = (0, lexicalLexical_js_1.$createTextNode)();
...
function $createTableNodeWithDimensions(rowCount, columnCount, includeHeaders = true, caption, bandedRows, bandedCols, align) {
    ...
    for (let iRow = 0; iRow < rowCount; iRow++) {
        ...
        for (let iColumn = 0; iColumn < columnCount; iColumn++) {
            ...
            const paragraphNode = $createCellParagraphNode();
            paragraphNode.append((0, lexicalLexical_js_1.$createTextNode)());
...
function $getTableCellNodeFromLexicalNode(startingNode) {
    const node = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(startingNode, n => $isTableCellNode(n));
    if ($isTableCellNode(node)) {
        return node;
    }
    return null;
...
function $getTableRowNodeFromTableCellNodeOrThrow(startingNode) {
    const node = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(startingNode, n => $isTableRowNode(n));
...
function $getTableNodeFromLexicalNodeOrThrow(startingNode) {
    const node = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(startingNode, n => $isTableNode(n));
    if ($isTableNode(node)) {
        return node;
    }
...
function $insertTableRow__EXPERIMENTAL(insertAfter = true, numOfRows = 1, includeRowHeader) {
    ...
    const [focusCell, , grid] = (0, lexicalLexical_js_1.DEPRECATED_$getNodeTriplet)(focus);
    const [gridMap, focusCellMap] = (0, lexicalLexical_js_1.DEPRECATED_$computeGridMap)(grid, focusCell, focusCell);
    ...
    if (insertAfter) {
        ...
        if (!(0, lexicalLexical_js_1.DEPRECATED_$isGridRowNode)(focusEndRowNode)) {
        ...
        if (!(0, lexicalLexical_js_1.DEPRECATED_$isGridRowNode)(focusStartRowNode)) {
            throw Error(`focusEndRow is not a GridRowNode`);
        }
        for (let i = 0; i < rowsToAdd.length; i++) {
...
function $insertTableColumn__EXPERIMENTAL(insertAfter = true, columns = 1, hasHeaderColumn = false) {
    ...
    const focus = selection.focus.getNode();
    const [anchorCell] = (0, lexicalLexical_js_1.DEPRECATED_$getNodeTriplet)(anchor);
    const [focusCell, , grid] = (0, lexicalLexical_js_1.DEPRECATED_$getNodeTriplet)(focus);
    const [gridMap, focusCellMap, anchorCellMap] = (0, lexicalLexical_js_1.DEPRECATED_$computeGridMap)(grid, focusCell, anchorCell);
    const rowCount = gridMap.length;
    const startColumn = insertAfter ? Math.max(focusCellMap.startColumn, anchorCellMap.startColumn) : Math.min(focusCellMap.startColumn, anchorCellMap.startColumn);
    const insertAfterColumn = insertAfter ? startColumn + focusCell.__colSpan - 1 : startColumn - 1;
    const gridFirstChild = grid.getFirstChild();
    if (!(0, lexicalLexical_js_1.DEPRECATED_$isGridRowNode)(gridFirstChild)) {
    ...
    for (let j = 0; j < columns; j++) {
        ...
        rowLoop: for (let i = 0; i < rowCount; i++) {
            if (i !== 0) {
                ...
                if (!(0, lexicalLexical_js_1.DEPRECATED_$isGridRowNode)(currentRow)) {
...
function $deleteTableRow__EXPERIMENTAL() {
    ...
    const anchor = selection.anchor.getNode();
    const focus = selection.focus.getNode();
    const [anchorCell, , grid] = (0, lexicalLexical_js_1.DEPRECATED_$getNodeTriplet)(anchor);
    const [focusCell] = (0, lexicalLexical_js_1.DEPRECATED_$getNodeTriplet)(focus);
    const [gridMap, anchorCellMap, focusCellMap] = (0, lexicalLexical_js_1.DEPRECATED_$computeGridMap)(grid, anchorCell, focusCell);
    ...
    for (let row = focusEndRow; row >= anchorStartRow; row--) {
        ...
        if (!(0, lexicalLexical_js_1.DEPRECATED_$isGridRowNode)(rowNode)) {
...
function $unmergeCell() {
    ...
    const anchor = selection.anchor.getNode();
    const [cell, row, grid] = (0, lexicalLexical_js_1.DEPRECATED_$getNodeTriplet)(anchor);
    ...
    if (rowSpan > 1) {
        const [map, cellMap] = (0, lexicalLexical_js_1.DEPRECATED_$computeGridMap)(grid, cell, cell);
        ...
        for (let i = 1; i < rowSpan; i++) {
            ...
            if (!(0, lexicalLexical_js_1.DEPRECATED_$isGridRowNode)(currentRowNode)) {
...
exports.$getColumnHeaderCellsInRange = $getColumnHeaderCellsInRange;
...
exports.$getRowHeaderCellsInRange = $getRowHeaderCellsInRange;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
function applyTableHandlers(tableNode, tableElement, editor, hasTabHandler) {
    ...
    const mouseDownCallback = event => {
        ...
        editor.update(() => {
            ...
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection) && selection.gridKey === tableSelection.tableNodeKey && rootElement.contains(target)) {
    ...
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_ARROW_DOWN_COMMAND, event => $handleArrowKey(editor, event, 'down', tableNode, tableSelection), lexicalLexical_js_1.COMMAND_PRIORITY_HIGH));
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_ARROW_UP_COMMAND, event => $handleArrowKey(editor, event, 'up', tableNode, tableSelection), lexicalLexical_js_1.COMMAND_PRIORITY_HIGH));
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_ARROW_LEFT_COMMAND, event => $handleArrowKey(editor, event, 'backward', tableNode, tableSelection), lexicalLexical_js_1.COMMAND_PRIORITY_HIGH));
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_ARROW_RIGHT_COMMAND, event => $handleArrowKey(editor, event, 'forward', tableNode, tableSelection), lexicalLexical_js_1.COMMAND_PRIORITY_HIGH));
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_ESCAPE_COMMAND, event => {
        const selection = (0, lexicalLexical_js_1.$getSelection)();
        if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
            const focusCellNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(selection.focus.getNode(), $isTableCellNode);
    ...
    const deleteTextHandler = command => () => {
        ...
        if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
            ...
            const tableCellNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(selection.anchor.getNode(), n => $isTableCellNode(n));
            if (!$isTableCellNode(tableCellNode)) {
                return false;
            }
            ...
            const nearestElementNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(selection.anchor.getNode(), n => (0, lexicalLexical_js_1.$isElementNode)(n));
            const topLevelCellElementNode = nearestElementNode && (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(nearestElementNode, n => (0, lexicalLexical_js_1.$isElementNode)(n) && $isTableCellNode(n.getParent()));
            if (!(0, lexicalLexical_js_1.$isElementNode)(topLevelCellElementNode) || !(0, lexicalLexical_js_1.$isElementNode)(nearestElementNode)) {
                return false;
            }
            if (command === lexicalLexical_js_1.DELETE_LINE_COMMAND && topLevelCellElementNode.getPreviousSibling() === null) {
                // TODO: Fix Delete Line in Table Cells.
                return true;
            }
            if (command === lexicalLexical_js_1.DELETE_CHARACTER_COMMAND || command === lexicalLexical_js_1.DELETE_WORD_COMMAND) {
    ...
    [lexicalLexical_js_1.DELETE_WORD_COMMAND, lexicalLexical_js_1.DELETE_LINE_COMMAND, lexicalLexical_js_1.DELETE_CHARACTER_COMMAND].forEach(command => {
        tableSelection.listenersToRemove.add(editor.registerCommand(command, deleteTextHandler(command), lexicalLexical_js_1.COMMAND_PRIORITY_CRITICAL));
    });
    const deleteCellHandler = event => {
        ...
        if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
            ...
            if (tableCellNode.getChildren().length === 1) {
                ...
                else if ((0, lexicalLexical_js_1.$isLineBreakNode)(node)) {
                    node.replace($createCellParagraphNode().append((0, lexicalLexical_js_1.$createTextNode)()), false);
                    event.preventDefault();
                    event.stopPropagation();
                }
    ...
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_BACKSPACE_COMMAND, deleteCellHandler, lexicalLexical_js_1.COMMAND_PRIORITY_CRITICAL));
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_DELETE_COMMAND, deleteCellHandler, lexicalLexical_js_1.COMMAND_PRIORITY_CRITICAL));
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.FORMAT_TEXT_COMMAND, payload => {
        const selection = (0, lexicalLexical_js_1.$getSelection)();
        if (!$isSelectionInTable(selection, tableNode)) {
            return false;
        }
    ...
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.CONTROLLED_TEXT_INSERTION_COMMAND, payload => {
        const selection = (0, lexicalLexical_js_1.$getSelection)();
        if (!$isSelectionInTable(selection, tableNode)) {
            return false;
        }
    ...
    if (hasTabHandler) {
        tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.KEY_TAB_COMMAND, event => {
            const selection = (0, lexicalLexical_js_1.$getSelection)();
            if (!(0, lexicalLexical_js_1.$isRangeSelection)(selection) || !selection.isCollapsed() || !$isSelectionInTable(selection, tableNode)) {
                return false;
            }
    ...
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.FOCUS_COMMAND, payload => {
    ...
    tableSelection.listenersToRemove.add(editor.registerCommand(lexicalLexical_js_1.SELECTION_CHANGE_COMMAND, () => {
        const selection = (0, lexicalLexical_js_1.$getSelection)();
        const prevSelection = (0, lexicalLexical_js_1.$getPreviousSelection)();
        if ((0, lexicalLexical_js_1.$isRangeSelection)(selection)) {
            ...
            if (isPartialyWithinTable) {
                ...
                (0, lexicalLexical_js_1.$setSelection)(newSelection);
        ...
        if (selection && !selection.is(prevSelection) && ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection) || (0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(prevSelection)) && tableSelection.gridSelection && !tableSelection.gridSelection.is(prevSelection)) {
            if ((0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection) && selection.gridKey === tableSelection.tableNodeKey) {
                tableSelection.updateTableGridSelection(selection);
            }
            else if (!(0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection) && (0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(prevSelection) && prevSelection.gridKey === tableSelection.tableNodeKey) {
...
function getTableElementFromGrid(editor, grid) {
    ...
    if (row) {
        const cell = row[0];
        if (cell) {
            const lexicalNode = (0, lexicalLexical_js_1.$getNearestNodeFromDOMNode)(cell.elem);
            if (lexicalNode) {
...
function $updateDOMForSelection(editor, grid, selection) {
    ...
    if (selectedCellNodes.size) {
        ...
        if (tableHTMLElement)
            tableHTMLElement.classList.add('selecting');
    }
    else {
        const tableHTMLElement = getTableElementFromGrid(editor, grid);
        if (tableHTMLElement)
            tableHTMLElement.classList.remove('selecting');
    }
...
exports.$removeHighlightStyleToTable = $removeHighlightStyleToTable;
...
function $addHighlightToDOM(editor, cell) {
    ...
    const node = (0, lexicalLexical_js_1.$getNearestNodeFromDOMNode)(element);
    if (!$isTableCellNode(node)) {
...
function $findCellNode(node) {
    const cellNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(node, $isTableCellNode);
    return $isTableCellNode(cellNode) ? cellNode : null;
}
function $findTableNode(node) {
    const tableNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(node, $isTableNode);
...
function $handleArrowKey(editor, event, direction, tableNode, tableSelection) {
    ...
    if ((0, lexicalLexical_js_1.$isRangeSelection)(selection) && selection.isCollapsed()) {
        const { anchor, focus } = selection;
        const anchorCellNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(anchor.getNode(), $isTableCellNode);
        const focusCellNode = (0, lexical_utilsLexicalUtils_js_1.$findMatchingParent)(focus.getNode(), $isTableCellNode);
    ...
    const onMouseMove = function (e) {
        setTimeout(() => {
            ...
            try {
                ...
                if (isNaN(jsonStart.x) || isNaN(jsonStart.y))
                    return;
...
function onDocumentMouseUp(thisEl) {
    const func = function (e) {
        var _a, _b;
        const IS_POINTER_EVENT = e instanceof MouseEvent;
        if (!!!thisEl.classList.contains('resizing'))
            return;
        if (!!!mouseMoveListener)
            return;
        document.removeEventListener((0, lexical_sharedLexicalShared_js_1.isTouchDevice)() ? 'touchmove' : 'mousemove', mouseMoveListener);
        if (mouseUpHandler)
            document.removeEventListener((0, lexical_sharedLexicalShared_js_1.isTouchDevice)() ? 'touchend' : 'mouseup', mouseUpHandler);
        mouseMoveListener = undefined;
        thisEl.classList.remove('resizing');
        const tableEl = (_b = (_a = thisEl.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.parentElement;
        if (tableEl)
            ...
            if (thisEl.classList.contains('row-resize')) {
                ...
                try {
                    ...
                    if (editor && editor.isEditable() && cell) {
                        editor.update(() => {
                            const tableCellNode = (0, lexicalLexical_js_1.$getNearestNodeFromDOMNode)(cell.elem);
                            if (!tableCellNode) {
                        ...
                        editor.update(() => {
                            ...
                            for (let r = 0; r < tableRows.length; r++) {
                                ...
                                const aggregatedRowSpans = rowCellsSpan.reduce((rowSpans, cellSpan) => {
                                    var _a;
                                    const previousCell = (_a = rowSpans[rowSpans.length - 1]) !== null && _a !== void 0 ? _a : 0;
...
function handleMouseDown(e) {
    ...
    if (tableHTMLElement && (tableHTMLElement === null || tableHTMLElement === void 0 ? void 0 : tableHTMLElement.classList.contains('selecting')))
        return;
...
/** @noInheritDoc */
class TableCellNode extends lexicalLexical_js_1.DEPRECATED_GridCellNode {
    static getType() {
        return 'tablecell';
    }
    static clone(node) {
    ...
    static importJSON(serializedNode) {
        ...
        if (serializedNode.border)
            cellNode.__border = serializedNode.border;
        if (serializedNode.verticalAlign)
            cellNode.__verticalAlign = serializedNode.verticalAlign;
        return cellNode;
    }
    ...
    createDOM(config) {
        ...
        (0, lexical_utilsLexicalUtils_js_1.addClassNamesToElement)(element, config.theme.tableCell, this.hasHeader() && config.theme.tableCellHeader);
    ...
    exportDOM(editor) {
        ...
        if (element) {
            ...
            if (verticalAlign)
                element_.style.verticalAlign = verticalAlign;
            if (border)
    ...
    setCustomStyles({ border, verticalAlign, backgroundColor }) {
        const self = this.getWritable();
...
function convertTableCellNodeElement(domNode) {
    ...
    if (verticalAlign && (verticalAlign === 'top' || verticalAlign === 'middle' || verticalAlign === 'bottom'))
        tableCellNode.__verticalAlign = verticalAlign;
    if (border)
        tableCellNode.__border = border;
    return {
        forChild: (lexicalNode, parentLexicalNode) => {
            if ($isTableCellNode(parentLexicalNode) && !(0, lexicalLexical_js_1.$isElementNode)(lexicalNode)) {
                const paragraphNode = $createCellParagraphNode();
                if ((0, lexicalLexical_js_1.$isLineBreakNode)(lexicalNode) && lexicalNode.getTextContent() === '\n') {
                    return null;
                }
...
function $createTableCellNode(headerState, colSpan = 1, width) {
    return (0, lexicalLexical_js_1.$applyNodeReplacement)(new TableCellNode(headerState, colSpan, width));
}
...
exports.computeSelectionCount = computeSelectionCount;
...
exports.isGridSelectionRectangular = isGridSelectionRectangular;
function $canUnmerge() {
    const selection = (0, lexicalLexical_js_1.$getSelection)();
    if ((0, lexicalLexical_js_1.$isRangeSelection)(selection) && !selection.isCollapsed() || (0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection) && !selection.anchor.is(selection.focus) || !(0, lexicalLexical_js_1.$isRangeSelection)(selection) && !(0, lexicalLexical_js_1.DEPRECATED_$isGridSelection)(selection)) {
        return false;
    }
    const [cell] = (0, lexicalLexical_js_1.DEPRECATED_$getNodeTriplet)(selection.anchor);
    return cell.__colSpan > 1 || cell.__rowSpan > 1;
}
exports.$canUnmerge = $canUnmerge;
...
exports.$cellContainsEmptyParagraph = $cellContainsEmptyParagraph;
function $selectLastDescendant(node) {
    const lastDescendant = node.getLastDescendant();
    if ((0, lexicalLexical_js_1.$isTextNode)(lastDescendant)) {
        lastDescendant.select();
    }
    else if ((0, lexicalLexical_js_1.$isElementNode)(lastDescendant)) {
...
exports.$selectLastDescendant = $selectLastDescendant;
...
exports.currentCellBackgroundColor = currentCellBackgroundColor;
/** @module @lexical/table */
const INSERT_TABLE_COMMAND = (0, lexicalLexical_js_1.createCommand)('INSERT_TABLE_COMMAND');
exports.INSERT_TABLE_COMMAND = INSERT_TABLE_COMMAND;
const INSERT_TABLE_COMMAND_WITH_DATA = (0, lexicalLexical_js_1.createCommand)('INSERT_TABLE_COMMAND_WITH_DATA');
exports.INSERT_TABLE_COMMAND_WITH_DATA = INSERT_TABLE_COMMAND_WITH_DATA;
