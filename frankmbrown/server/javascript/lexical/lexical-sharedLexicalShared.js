...
exports.openLoadingDialog = exports.openDialog = exports.mergePrevious = exports.isTouchDevice = exports.isMobileDevice = exports.isIOS = exports.isHTMLElementCustom = exports.handleOpenLexDialog = exports.handleEditorFocus = exports.handleCloseLexDialog = exports.getNoColor = exports.getLightModeDarkMode = exports.getFileListForFileInput = exports.getEditorInstances = exports.getEditorButtons = exports.getDeviceType = exports.getDefaultTextColor = exports.getDefaultFontFamily = exports.getDefaultBackground = exports.getDOMRangeRectAbsolute = exports.getDOMRangeRect = exports.getCurrentEditorID = exports.getCurrentEditor = exports.getCsrfToken = exports.gcd = exports.editorCanChangeSize = exports.disableButton = exports.disableAndSelect = exports.closeLoadingDialog = exports.closeDialog = exports.calculateZoomLevel = exports.addSwipeUpListener = exports.addSwipeRightListener = exports.addSwipeLeftListener = exports.addSwipeDownListener = exports.UPDATE_ON_SET_HTML = exports.TEXT_COLOR_CHANGE = exports.SET_EDITOR_COMMAND = exports.SCROLL_INTO_VIEW_OPTIONS = exports.REGISTER_TOOLBAR_LISTENERS = exports.MAKE_TRANSPARENT = exports.LAUNCH_TEXT_INSERTION_COMMAND = exports.IS_TABLET = exports.IS_REAL_BROWSER = exports.IS_PHONE = exports.IS_DESKTOP = exports.GET_BACKGROUND_COLOR_DIALOG = exports.CLEAR_TEXT_FORMATTING = exports.BACKGROUND_COLOR_CHANGE = exports.$rootTextContent = void 0;
exports.unselectButton = exports.setSelectOptionsStyle = exports.setSelectInput = exports.setSelectButtonText = exports.setMarkRadioGroupChecked = exports.setHeadingNodeButtons = exports.setEditorInstance = exports.setCurrentEditor = exports.setColorInput = exports.selectButton = exports.removeDisabledButton = exports.registerStickyNavbar = exports.registerMaxLengthEditable = exports.q = void 0;
/**
...
const lexical_overflowLexicalOverflow_js_1 = require("./lexical-overflowLexicalOverflow.js");
...
const GET_HORIZONTAL_RULE_DIALOG = textColor => `<div style="display: none;" hidden class="dialog-wrapper" id="horizontal-rule-lexical" data-close-backdrop data-esc>
...
const GET_BLOCK_EDIT_DIALOG = (background, textColor) => `<div style="display: none;" hidden class="dialog-wrapper" id="lexical-block-edit-dialog" data-close-backdrop data-esc>
...
const GET_CELL_EDIT_DIALOG = (background, textColor) => `<div style="display: none;" hidden class="dialog-wrapper" id="lexical-table-cell-bg" data-close-backdrop data-esc>
  <div class="dialog large" data-click-capture>
    <div class="dialog-header">
...
const GET_BACKGROUND_COLOR_DIALOG = background => `<div style="display: none;" hidden class="dialog-wrapper" id="image-bg-color-dialog" data-close-backdrop data-esc>
...
exports.GET_BACKGROUND_COLOR_DIALOG = GET_BACKGROUND_COLOR_DIALOG;
...
/*------------------------ Custom Events --------------------------- */ // Define an interface for the event data
/*--------------------- Types ---------------------------- */
function editorCanChangeSize(editor) {
 ...
 */
const SET_EDITOR_COMMAND = (0, lexicalLexical_js_1.createCommand)('SET_EDITOR_COMMAND');
exports.SET_EDITOR_COMMAND = SET_EDITOR_COMMAND;
/**
...
function getCurrentEditorID() {
    const input = document.getElementById('LEXICAL_EDITOR_CURRENT');
    if (input && input.value)
        return input.value;
    else
        return null;
}
exports.getCurrentEditorID = getCurrentEditorID;
/**
...
function setCurrentEditor(id) {
    ...
    if (input) {
        ...
        if (oldFocusedEditor)
            oldFocusedEditor.setAttribute('data-current', 'false');
        if (id === '') {
            input.value = id;
            return true;
        }
        if (id && EDITOR_INSTANCES[id]) {
            ...
            if (newFocusedEditor)
                newFocusedEditor.setAttribute('data-current', 'true');
            return true;
        }
        else {
...
function getCurrentEditor() {
    ...
    if (typeof id === "string" && EDITOR_INSTANCES[id])
        return EDITOR_INSTANCES[id];
    else
        return null;
}
...
function handleEditorFocus(e) {
    const wrapper = this.classList.contains('lexical-wrapper') ? this : this.closest('div.lexical-wrapper');
    if (!!!wrapper)
        return;
    const id = wrapper.id;
    if (typeof id === "string" && getCurrentEditorID() !== id) {
        ...
        if (res)
            EDITOR_INSTANCES[id].dispatchCommand(SET_EDITOR_COMMAND, id);
    }
}
...
exports.getEditorInstances = getEditorInstances;
function setEditorInstance(id, editor) {
...
exports.SCROLL_INTO_VIEW_OPTIONS = SCROLL_INTO_VIEW_OPTIONS;
function closeDialog(dialog) {
    document.dispatchEvent(new CustomEvent("CLOSE_DIALOG", {
        detail: {
            dialog
        }
    }));
...
function openLoadingDialog(text) {
    ...
    if (dialog) {
        const indicator = dialog.querySelector('div[data-indicator]');
        if (indicator)
            indicator.setAttribute('aria-busy', 'true');
        const textEl = dialog.querySelector('p[data-text]');
        if (textEl && text)
            textEl.innerText = text;
        openDialog(dialog);
    }
}
exports.openLoadingDialog = openLoadingDialog;
...
exports.closeLoadingDialog = closeLoadingDialog;
/* ------------------------------------------------------------------------------------------- */
/**
 *
 ...
 * @param {HTMLButtonElement} button
*/
function removeDisabledButton(button) {
    if (button && button.removeAttribute)
        button.removeAttribute('disabled');
}
exports.removeDisabledButton = removeDisabledButton;
/**
 *
 * @param {HTMLButtonElement} button
*/
...
function unselectButton(button) {
    if (button && button.classList && button.classList.remove)
        button.classList.remove('selected');
}
exports.unselectButton = unselectButton;
/**
 *
 ...
 */
function disableAndSelect(button, disable, select) {
    if (disable)
...
exports.disableAndSelect = disableAndSelect;
/**
 ...
 */
function q(wrapper, dispatch, payload) {
    var str = 'button[data-dispatch="'.concat(dispatch).concat('"]');
    if (payload) {
        str = str.concat('[data-payload="').concat(payload).concat('"]');
    }
    return wrapper.querySelector(str);
}
exports.q = q;
/**
 * Get the current light mode or dark mode
 */
function getLightModeDarkMode() {
...
exports.getLightModeDarkMode = getLightModeDarkMode;
/**
 * Get the current font family
 * @returns {string}
 */
function getDefaultFontFamily() {
    const input = document.getElementById('font-family-settings');
    if (input && input.value)
        return input.value;
...
function getDefaultBackground() {
    ...
    if (input && input.value && lexicalLexical_js_1.VALID_HEX_REGEX.test(input.value))
        return input.value;
    return '#000000';
}
exports.getDefaultBackground = getDefaultBackground;
/**
 ...
 * @param {string} val
 */
function setSelectOptionsStyle(button, val) {
    /* @ts-ignore */
    if (button && button.nextElementSibling) {
        ...
        if (Array.isArray(options)) {
            options.forEach(btn => {
                if (val === btn.getAttribute('data-val'))
...
exports.setSelectOptionsStyle = setSelectOptionsStyle;
/**
...
function setSelectButtonText(button, text) {
    if (button && typeof text === 'string') {
        Array.from(button.children).filter(c => c.nodeName === 'SPAN').map(a => {
            a.innerText = text.trim();
        });
    }
}
exports.setSelectButtonText = setSelectButtonText;
/**
...
exports.setMarkRadioGroupChecked = setMarkRadioGroupChecked;
/**
 *
 * @param {HTMLButtonElement[]} buttons
 * @param {string|undefined} type
 */
function setHeadingNodeButtons(buttons, type) {
...
exports.setHeadingNodeButtons = setHeadingNodeButtons;
/**
...
function setColorInput(input, value) {
    if (input)
        input.value = value;
    if ((input === null || input === void 0 ? void 0 : input.nextElementSibling) && (input === null || input === void 0 ? void 0 : input.nextElementSibling.nodeName) === 'SPAN') {
        input.nextElementSibling.innerText = value;
    }
}
exports.setColorInput = setColorInput;
/**
 ...
 * @param {string} text
 */
function setSelectInput(input, value, text) {
    var _a, _b, _c;
    if (input)
        input.value = value;
    if (input && (input === null || input === void 0 ? void 0 : input.parentElement) && ((_a = input === null || input === void 0 ? void 0 : input.parentElement) === null || _a === void 0 ? void 0 : _a.previousElementSibling) && ((_c = (_b = input === null || input === void 0 ? void 0 : input.parentElement) === null || _b === void 0 ? void 0 : _b.previousElementSibling) === null || _c === void 0 ? void 0 : _c.nodeName) === "BUTTON") {
        const button = input.parentElement.previousElementSibling;
        setSelectButtonText(button, text);
        setSelectOptionsStyle(button, value);
    }
}
exports.setSelectInput = setSelectInput;
...
function getDOMRangeRectAbsolute(nativeSelection, rootElement) {
    const domRange = nativeSelection.getRangeAt(0);
    let rect;
    if (nativeSelection.anchorNode === rootElement) {
        let inner = rootElement;
...
exports.getDOMRangeRectAbsolute = getDOMRangeRectAbsolute;
function getEditorButtons(wrapper) {
    return {
        fontButton: wrapper.querySelector('button[data-lexical-font-button]'),
        headingButton: wrapper.querySelector('button[data-lexical-heading-button]'),
        ...
        textColorButton: wrapper.querySelector('button[data-lexical-text-color-button]'),
        ...
        markButton: wrapper.querySelector('button[data-lexical-mark-button]'),
        fontWeightButton: wrapper.querySelector('button[data-lexical-font-weight-button]'),
        blockStyleButton: wrapper.querySelector('button[data-lexical-block-style-button]'),
        fontSizeButton: wrapper.querySelector('button[data-lexical-font-size-button]'),
        undoButton: wrapper.querySelector('buttom[data-dispatch="UNDO_COMMAND"]'),
        redoButton: wrapper.querySelector('buttom[data-dispatch="REDO_COMMAND"]'),
        clearContentButton: wrapper.querySelector('buttom[data-dispatch="CLEAR_EDITOR_COMMAND"]'),
        ...
        inlineQuoteButtonToolbar: wrapper.querySelector('button.toggle-button[data-dispatch="FORMAT_TEXT_COMMAND"][data-payload="quote"]'),
        ...
        imageButton: wrapper.querySelector('button[data-lexical-image-button]'),
        audioButton: wrapper.querySelector('button[data-lexical-audio-button]'),
        videoButton: wrapper.querySelector('button[data-lexical-video-button]'),
        linkButton: wrapper.querySelector('button[data-lexical-link-button]'),
        removeLinkButton: wrapper.querySelector('button[data-lexical-remove-link]'),
        embedMediaButton: wrapper.querySelector('button[data-lexical-embed-media]'),
        embedNews: wrapper.querySelector('button[data-embed-news]'),
        embedYoutube: wrapper.querySelector('button[data-embed-youtube]'),
        embedX: wrapper.querySelector('button[data-embed-x]'),
        embedTikTok: wrapper.querySelector('button[data-embed-tiktok]'),
        embedInstagram: wrapper.querySelector('button[data-embed-instagram]'),
        embedReddit: wrapper.querySelector('button[data-embed-reddit]'),
        quoteButton: wrapper.querySelector('button[data-lexical-insert-quote-button]'),
        blockQuoteButton: wrapper.querySelector('button[data-lexical-quote-button]'),
        inlineQuoteButton: wrapper.querySelector('button[data-dispatch="FORMAT_TEXT_COMMAND"][data-payload="quote"]'),
        listButton: wrapper.querySelector('button[data-lexical-list-button]'),
        ...
        asideButton: wrapper.querySelector('button[data-lexical-aside-button]'),
        leftAside: q(wrapper, 'INSERT_ASIDE_COMMAND', 'left'),
        rightAside: q(wrapper, 'INSERT_ASIDE_COMMAND', 'right'),
        detailsButton: wrapper.querySelector('button[data-lexical-details-button]'),
        codeButton: wrapper.querySelector('button[data-lexical-insert-code]'),
        codeBlockButton: q(wrapper, 'INSERT_CODE_COMMAND', undefined),
        inlineCodeButton: q(wrapper, 'FORMAT_TEXT_COMMAND', 'code'),
        mathButton: wrapper.querySelector('button[data-lexical-math-button]'),
        tableButton: wrapper.querySelector('button[data-lexical-table-button]'),
        chartButton: wrapper.querySelector('button[data-lexical-chart-button]'),
        horizontalRuleButton: wrapper.querySelector('button[data-lexical-hr-button]'),
        viewButton: wrapper.querySelector('button[data-lexical-hr-button]'),
        downloadLexicalStateButton: wrapper.querySelector('button[data-download-state]'),
        uploadLexicalStateButton: wrapper.querySelector('button[data-dialog="lex-upload-file-dialog"]'),
        sectionHeadingButton: wrapper.querySelector('button[data-lexical-section-button]'),
        paragraphButton: wrapper.querySelector('button[data-insert-paragraph-button]'),
        htmlButton: wrapper.querySelector('button[data-custom-html-btn]'),
        //
        gifButton: wrapper.querySelector('button[data-lexical-gif-button]'),
        speechToTextButton: wrapper.querySelector('button[data-lexical-speech-to-text]'),
        copyContentButton: wrapper.querySelector('buttom[data-dispatch="COPY_EDITOR_COMMAND"]'),
        abbreviationButton: wrapper.querySelector('button[data-lexical-abbr-button]'),
        removeAbbreviationButton: wrapper.querySelector('button[data-lexical-remove-abbr]'),
        columnLayoutButton: wrapper.querySelector('button[data-lexical-column-button]')
    };
}
exports.getEditorButtons = getEditorButtons;
function isTouchDevice() {
    return 'ontouchstart' in window || window.navigator.maxTouchPoints > 0 || /* @ts-ignore */
        window.navigator.msMaxTouchPoints > 0;
}
exports.isTouchDevice = isTouchDevice;
const IS_REAL_BROWSER = (_c = (_b = (_a = Object.getOwnPropertyDescriptor(globalThis, 'window')) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.toString().includes('[native code]')) !== null && _c !== void 0 ? _c : false;
exports.IS_REAL_BROWSER = IS_REAL_BROWSER;
const MAKE_TRANSPARENT = (0, lexicalLexical_js_1.createCommand)('MAKE_TRANSPARENT');
exports.MAKE_TRANSPARENT = MAKE_TRANSPARENT;
const TEXT_COLOR_CHANGE = (0, lexicalLexical_js_1.createCommand)('TEXT_COLOR_CHANGE');
exports.TEXT_COLOR_CHANGE = TEXT_COLOR_CHANGE;
const BACKGROUND_COLOR_CHANGE = (0, lexicalLexical_js_1.createCommand)('BACKGROUND_COLOR_CHANGE');
exports.BACKGROUND_COLOR_CHANGE = BACKGROUND_COLOR_CHANGE;
const CLEAR_TEXT_FORMATTING = (0, lexicalLexical_js_1.createCommand)('CLEAR_TEXT_FORMATTING');
exports.CLEAR_TEXT_FORMATTING = CLEAR_TEXT_FORMATTING;
const LAUNCH_TEXT_INSERTION_COMMAND = (0, lexicalLexical_js_1.createCommand)('LAUNCH_TEXT_INSERTION_COMMAND');
exports.LAUNCH_TEXT_INSERTION_COMMAND = LAUNCH_TEXT_INSERTION_COMMAND;
const REGISTER_TOOLBAR_LISTENERS = (0, lexicalLexical_js_1.createCommand)('REGISTER_TOOLBAR_LISTENERS');
exports.REGISTER_TOOLBAR_LISTENERS = REGISTER_TOOLBAR_LISTENERS;
const UPDATE_ON_SET_HTML = (0, lexicalLexical_js_1.createCommand)('UPDATE_ON_SET_HTML');
exports.UPDATE_ON_SET_HTML = UPDATE_ON_SET_HTML;
...
function $wrapOverflowedNodes(offset) {
    const dfsNodes = (0, lexical_utilsLexicalUtils_js_1.$dfs)();
    const dfsNodesLength = dfsNodes.length;
    let accumulatedLength = 0;
    for (let i = 0; i < dfsNodesLength; i += 1) {
        const { node } = dfsNodes[i];
        if ((0, lexical_overflowLexicalOverflow_js_1.$isOverflowNode)(node)) {
            ...
            if (nextLength <= offset) {
                ...
                if ((0, lexicalLexical_js_1.$isRangeSelection)(selection) && (!selection.anchor.getNode().isAttached() || !selection.focus.getNode().isAttached())) {
                    if ((0, lexicalLexical_js_1.$isTextNode)(previousSibling)) {
                        previousSibling.select();
                    }
                    else if ((0, lexicalLexical_js_1.$isTextNode)(nextSibling)) {
                        nextSibling.select();
                    }
                    else if (parent !== null) {
                        parent.select();
                ...
                // container
                const firstDescendantIsSimpleText = (0, lexicalLexical_js_1.$isTextNode)(descendant) && descendant.isSimpleText();
        ...
        else if ((0, lexicalLexical_js_1.$isLeafNode)(node)) {
            const previousAccumulatedLength = accumulatedLength;
            accumulatedLength += node.getTextContentSize();
            if (accumulatedLength > offset && !(0, lexical_overflowLexicalOverflow_js_1.$isOverflowNode)(node.getParent())) {
                const previousSelection = (0, lexicalLexical_js_1.$getSelection)();
                let overflowNode;
                // For simple text we can improve the limit accuracy by splitting the TextNode
                // on the split point
                if (previousAccumulatedLength < offset && (0, lexicalLexical_js_1.$isTextNode)(node) && node.isSimpleText()) {
                ...
                if (previousSelection !== null) {
                    (0, lexicalLexical_js_1.$setSelection)(previousSelection);
                }
...
function $wrapNode(node) {
    const overflowNode = (0, lexical_overflowLexicalOverflow_js_1.$createOverflowNode)();
...
function mergePrevious(overflowNode) {
    ...
    if (!(0, lexical_overflowLexicalOverflow_js_1.$isOverflowNode)(previousNode)) {
        return;
    }
...
const TEXT_LENGTH = {};
const EDITOR_STATE = {};
function $addCharCounter(editor, { min, max }, initial = false) {
    var _a;
    const HAS_MIN = !!!isNaN(min);
...
function removeCharCounter(editor) {
    const p = document.getElementById(editor._config.namespace.concat('-char-counter'));
    if (p)
        p.remove();
}
function registerMaxLengthEditable(editor, { min, max, showCounter = true }) {
    TEXT_LENGTH[editor._config.namespace] = {
        lastLength: null,
        text: editor.getEditorState().read($rootTextContent)
    };
    if (showCounter)
        $addCharCounter(editor, {
            min,
            max
        }, true);
    return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerUpdateListener(({ dirtyLeaves, dirtyElements }) => {
        var _a, _b, _c;
        ...
        const textLength = ((_b = (_a = TEXT_LENGTH[editor._config.namespace]) === null || _a === void 0 ? void 0 : _a.text) === null || _b === void 0 ? void 0 : _b.length) || 0;
        const textLengthAboveThreshold = textLength > Number(max) || TEXT_LENGTH[editor._config.namespace].lastLength !== null && Number(TEXT_LENGTH[editor._config.namespace].lastLength) > max;
        if (TEXT_LENGTH[editor._config.namespace].lastLength === null || textLengthAboveThreshold) {
            const offset = findOffset(((_c = TEXT_LENGTH[editor._config.namespace]) === null || _c === void 0 ? void 0 : _c.text) || '', Number(max), s => s.length);
            editor.update(() => {
    ...
    }, editor.registerNodeTransform(lexicalLexical_js_1.RootNode, rootNode => {
        const selection = (0, lexicalLexical_js_1.$getSelection)();
        ...
        if (prevTextContentSize !== textContentSize) {
            ...
            if (delCount > 0) {
                ...
                if (prevTextContentSize === max && EDITOR_STATE[editor._config.namespace] !== prevEditorState) {
                    EDITOR_STATE[editor._config.namespace] = prevEditorState;
                    (0, lexical_utilsLexicalUtils_js_1.$restoreEditorState)(editor, prevEditorState);
                }
                else {
                    (0, lexical_selectionLexicalSelection_js_1.trimTextContentFromAnchor)(editor, anchor, delCount);
                }
            }
        }
    }));
}
exports.registerMaxLengthEditable = registerMaxLengthEditable;
...
function getFileListForFileInput(files) {
...
exports.getFileListForFileInput = getFileListForFileInput;
function getNoColor(editor) {
    return Boolean(editor._rootElement && editor._rootElement.hasAttribute('data-no-color'));
}
exports.getNoColor = getNoColor;
/**
...
var STICKY_NAVBAR_INTERVAL = null;
function registerStickyNavbar(editor) {
    // Element to keep track of virtual keyboard offset to keep sticky navbar sticky
    const virtualKeyboardOffset = document.getElementById('virual-keyboard-offset');
    if (virtualKeyboardOffset && window.visualViewport) {
        return (0, lexical_utilsLexicalUtils_js_1.mergeRegister)(editor.registerCommand(lexicalLexical_js_1.FOCUS_COMMAND, () => {
            STICKY_NAVBAR_INTERVAL = setInterval(() => {
                var _a;
                const height = (_a = window.visualViewport) === null || _a === void 0 ? void 0 : _a.offsetTop;
...
exports.registerStickyNavbar = registerStickyNavbar;
/**
...
exports.gcd = gcd;
const LEXICAL_DIALOG_IDS = new Set(["math-markup-lexical", "lex-embed-news", "lex-embed-youtube", "lex-embed-tiktok", "lex-embed-twitter", "lex-embed-instagram", "details-content-lexical", "tables-lexical", "horizontal-rule-lexical", "view-content-lexical", "lexical-block-edit-dialog", "lexical-table-cell-bg", "edit-table-lexical", "lex-upload-file-dialog", "lex-insert-custom-html", "image-bg-color-dialog", "column-layout-lexical", "coding-lang-lexical", "insert-previous-lexical"]);
function handleOpenLexDialog(e) {
    const id = e.detail.dialogID;
    const insertAfterDiv = document.getElementById('insert-after-lexical-layout');
    if (insertAfterDiv) {
        if (LEXICAL_DIALOG_IDS.has(id)) {
            switch (id) {
                case 'coding-lang-lexical':
                    {
                        // DONE
                ...
                case 'lexical-block-edit-dialog':
                    {
                        // DONE
            ...
            if (dialogEl) {
                ...
                document.dispatchEvent(new CustomEvent('OPEN_LEXICAL_DIALOG_FINAL', {
                    detail: {
                        el: dialogEl
                    }
                }));
...
exports.handleOpenLexDialog = handleOpenLexDialog;
function handleCloseLexDialog(e) {
    e.detail.dialog.setAttribute('hidden', '');
    e.detail.dialog.style.setProperty('display', 'none');
    if (window.unloadCodeEditorsBeforeSwap)
        window.unloadCodeEditorsBeforeSwap(e.detail.dialog);
    if (window.unloadLexicalEditorsBeforeSwap)
        window.unloadLexicalEditorsBeforeSwap(e.detail.dialog);
    e.detail.dialog.remove();
}
exports.handleCloseLexDialog = handleCloseLexDialog;
