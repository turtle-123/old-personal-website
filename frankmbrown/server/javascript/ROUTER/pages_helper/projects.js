...
exports.postToPythonBackend = exports.getVariousNlpTasks = exports.postGetFileInformationText = exports.postGetFileInformationVideo = exports.postGetFileInformationAudio = exports.postGetFileInformationImage = exports.getFileInformation = exports.postConvertTextFileType = exports.convertTextFileType = exports.postConvertVideoType = exports.postConvertAudioType = exports.postConvertImageType = exports.getConvertFileType = exports.getNeuralStyleTransfer = exports.postImageEditorResize = exports.resizeImage = exports.getImageEditor = exports.getTestCssEnvVariables = exports.getFontSizeAdjust = exports.onFontSizeAdjustChange = exports.getLookingIntoEmbedingSocialMediaPosts = exports.onPostLexicalImplementation = exports.getLexicalImplementations = exports.markdownToHTML = exports.informationNearYou = exports.threeJSPlayground = exports.createThreeJSTexture = exports.excalidrawImplementation = exports.createCssSpriteMaker = exports.getAllUserGradients = exports.deleteCreateGradient = exports.postCreateGradient = exports.createGradient = exports.createSvgWithPixi = exports.learningD3Js = exports.learningD3JsComponent = exports.recordMediaPageImage = exports.uploadPageImageFromUrl = exports.recordMediaTestPage = exports.htmlCssJavascriptPlayground = exports.htmlToJavascriptPage = exports.getCreateASurvey = exports.getArticleBuilder4 = exports.getArticleBuilder3 = exports.getArticleBuilder2 = exports.getArticleBuilder = exports.getLexicalPage = exports.getGoogleMaps = exports.getDesignSystemComponent = exports.getDesignSystemHome = void 0;
exports.getThreeJsPage = exports.getWebGLPage = exports.getWebGPUPage = exports.getBokehFunctionalityPage = exports.getTestingRecommendationSystems = exports.getGoogleColabClone = exports.getSortingMechanisms = exports.getTestingSelectImplementations = exports.getCreateChartPage = exports.getTableConversionPage = exports.postTableConversionUrl = exports.postTableConversionText = exports.postTableConversionFile = exports.getWebAPIs = exports.postSenseOfStyle = exports.getSenseOfStyle = exports.getAiChat = exports.getAiChatInformationOnModels = exports.postOpenAIImageModeration = exports.postKeypointDetection = exports.postImageSegmentation = exports.postObjectDetection = exports.postDepthEstimation = exports.postImageCaptioning = exports.postImageSafeSearch = exports.postImageFeatureExtraction = exports.convertImageToPillowCompatable = exports.getVariousImageTasks = exports.postOpenAITextModeration = exports.postKeywordExtraction = exports.postSummarization = exports.postFeatureExtraction = exports.postNlpClassification = exports.postNamedEntityRecognition = exports.postSentimentAnalysis = exports.postAnswerQuestion = exports.postFillMask = void 0;
...
const lexical_1 = require("../functions/lexical");
const html_1 = require("../html");
const TIME = __importStar(require("../../utils/time"));
const census_1 = require("../functions/census");
const DESIGN_SYSTEM_COMPONENTS_1 = require("../../CONSTANTS/DESIGN_SYSTEM_COMPONENTS");
const LEARNING_D3_COMPONENTS_1 = require("../../CONSTANTS/LEARNING_D3_COMPONENTS");
const markdownNotes_1 = require("./markdownNotes");
const LEXICAL_IMPLEMENTATIONS = __importStar(require("./lexicalImplementations"));
...
const static_pages_1 = require("./static-pages");
...
/*----------------------------------------------------- DESIGN_SYSTEM ------------------------------------------------*/
const COMPONENTS_SET = new Set(Object.keys(DESIGN_SYSTEM_COMPONENTS_1.COMPONENTS_OBJECT));
function getDesignSystemHome(req, res) {
    const breadcrumbs = [
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/design-system' };
...
exports.getDesignSystemHome = getDesignSystemHome;
function getDesignSystemComponent(req, res) {
    const breadcrumbs = [{ name: 'Home', item: '/', position: 1 }, { name: 'Projects', item: '/projects', position: 2 }, { name: 'My Design System', item: '/projects/design-system', position: 3 }];
    const { component } = req.params;
    if (!!!COMPONENTS_SET.has(component))
        return (0, redirect_override_1.redirect)(req, res, '/projects/design-system', 404, { severity: 'error', message: 'Component page not found.' });
    const { title, path, keywords, description, tableOfContents } = DESIGN_SYSTEM_COMPONENTS_1.COMPONENTS_OBJECT[component];
    breadcrumbs.push({ position: 4, name: title, item: path });
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path, noIndex: false };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.getDesignSystemComponent = getDesignSystemComponent;
function getGoogleMaps(req, res) {
    ...
    const keywords = ["Frank McKee Brown", "Frank\'s Design System", "Google Maps", "Google Maps JavaScript API", "htmx", "Google Maps", "geojson", "drawing geojson", "markers", "POSTGIS", "postgresql database", "markers", "Amazon S3", "geography input", "JavaScript"];
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/design-system/google-maps' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
function getLexicalPage(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
        { name: 'My Design System', item: '/projects/design-system', position: 3 },
    ...
    const keywords = ["Frank McKee Brown", "Frank\'s Design System", "Lexical", "Lexical Rich Text Editor", "Lexical Facebook", "Rich Text Editor JavaScript", "JavaScript"];
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/design-system/lexical-rich-text-editor' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.getLexicalPage = getLexicalPage;
function getArticleBuilder(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const keywords = ["Article Builder", "Frank McKee Brown", "Build an Article", "Submit the Article", "Copy HTML", "Frank McKee Brown", "frankmbrown.net", "Frank Brown", "Build an article using my lexical implementation"];
    ...
    const tableOfContents = [{ id: 'projects', text: 'Projects' }];
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/article-builder' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
    const articleBuilder1 = (0, lexical_1.renderLexicalArticleBuilder1)(req);
...
exports.getArticleBuilder = getArticleBuilder;
function getArticleBuilder2(req, res) {
    const breadcrumbs = [{ name: 'Home', item: '/', position: 1 }, { name: 'Projects', item: '/projects', position: 2 }, { name: 'Article Builder 2', item: '/projects/article-builder-2', position: 3 }];
    const title = "Frank's Article Builder Attempt 2";
    const keywords = ["Article Builder", "Frank McKee Brown", "Build an Article", "Submit the Article", "Copy HTML", "Frank McKee Brown", "frankmbrown.net", "Frank Brown",];
    ...
    const tableOfContents = [];
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/article-builder-2' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
    const articleBuilder2 = (0, lexical_1.renderLexicalArticleBuilder2)(req);
...
exports.getArticleBuilder2 = getArticleBuilder2;
function getArticleBuilder3(req, res) {
    const breadcrumbs = [{ name: 'Home', item: '/', position: 1 }, { name: 'Projects', item: '/projects', position: 2 }, { name: 'Article Builder 3', item: '/projects/article-builder-3', position: 3 }];
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/article-builder-3' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
    return res.status(200).render('pages/projects/article-builder-3', {
        layout: requiredVariables.fullPageRequest ? 'layout' : false,
        ...requiredVariables,
        ...(0, lexical_1.getArticleBuilder3RenderObj)({})
    });
}
exports.getArticleBuilder3 = getArticleBuilder3;
function getArticleBuilder4(req, res) {
    const breadcrumbs = [{ name: 'Home', item: '/', position: 1 }, { name: 'Projects', item: '/projects', position: 2 }, { name: 'Article Builder 4', item: '/projects/article-builder-4', position: 3 }];
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/article-builder-4' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.getArticleBuilder4 = getArticleBuilder4;
function getCreateASurvey(req, res) {
    const survey_uuid = 'survey_'.concat(node_crypto_1.default.randomUUID());
    const breadcrumbs = [{ name: 'Home', item: '/', position: 1 }, { name: 'Projects', item: '/projects', position: 2 }, { name: 'Create A Poll', item: '/projects/create-a-survey', position: 3 }];
    const title = "Create A Survey";
    const keywords = ["Frank McKee Brown", "frankmbrown.net", "Frank Brown", "Create A Poll", "Create A Poll Using My Design system", "Create A Poll using Lexical Rich Text Editor"];
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/create-a-survey' };
...
exports.getCreateASurvey = getCreateASurvey;
function htmlToJavascriptPage(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/html-to-javascript' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.htmlToJavascriptPage = htmlToJavascriptPage;
function htmlCssJavascriptPlayground(req, res) {
    var _a;
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/html-css-javascript-playground' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
    return res.status(200).render('pages/projects/html-css-javascript-playground', {
        layout: requiredVariables.fullPageRequest ? 'layout' : false,
        ...requiredVariables,
        pageObj: {
            theme: ((_a = req.session.settings) === null || _a === void 0 ? void 0 : _a.code_editor_theme) || 'vscode'
        }
    });
}
exports.htmlCssJavascriptPlayground = htmlCssJavascriptPlayground;
function recordMediaTestPage(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/record-media' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.recordMediaTestPage = recordMediaTestPage;
async function uploadPageImageFromUrl(req, url) {
    try {
        ...
        const buffer = await (0, image_1.getImageFromUrl)(url);
        const { twitter, linkedin } = await (0, image_1.createTwitterAndLinkedInImages)(buffer);
        const [twitterURL, linkedinURL] = await Promise.all([
            (0, aws_implementation_1.uploadImageObject)(twitterKey, twitter, 'jpg', {}, user_id, ip_id),
            (0, aws_implementation_1.uploadImageObject)(linkedinKey, linkedin, 'jpg', {}, user_id, ip_id)
        ]);
    }
    catch (e) {
        console.error(e);
...
exports.uploadPageImageFromUrl = uploadPageImageFromUrl;
async function recordMediaPageImage(req, res) {
    try {
        const image = req.file;
        const hexColorRegex = /^#[0-9A-Fa-f]{6}$/;
        if (!!!image) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to detect image in input."));
        }
        var imageBuffer = image.buffer;
        if (req.body["add-bg-color"] === "on" && req.body['bg-color'] && hexColorRegex.test(req.body["bg-color"])) {
            imageBuffer = await (0, cmd_1.executeWithArgument)('magick', ['convert', '-', '-background', req.body["bg-color"], 'jpeg:-'], imageBuffer);
        }
        else {
            imageBuffer = await (0, cmd_1.executeWithArgument)('magick', ['convert', '-', 'jpeg:-'], imageBuffer);
        }
        const { twitter, linkedin } = await (0, image_1.createTwitterAndLinkedInImages)(imageBuffer);
        ...
        const [url, twitterURL, linkedinURL] = await Promise.all([
            (0, aws_implementation_1.uploadImageObject)(key1, imageBuffer, 'jpg', {}, user_id, ip_id),
            (0, aws_implementation_1.uploadImageObject)(twitterKey, twitter, 'jpg', {}, user_id, ip_id),
            (0, aws_implementation_1.uploadImageObject)(linkedinKey, linkedin, 'jpg', {}, user_id, ip_id)
        ]);
...
<img src="${linkedinURL}" alt="Page Image" />`);
        ...
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong getting the page image URLs."));
    }
}
exports.recordMediaPageImage = recordMediaPageImage;
const D3_COMPONENTS_SET = new Set(Object.keys(LEARNING_D3_COMPONENTS_1.D3_COMPONENTS));
function learningD3JsComponent(req, res) {
    try {
        const { component } = req.params;
        if (D3_COMPONENTS_SET.has(component)) {
            const breadcrumbs = [{ name: 'Home', item: '/', position: 1 }, { name: 'Projects', item: '/projects', position: 2 }, { name: 'Learning D3.js', item: '/projects/learning-d3-js', position: 3 }];
            const { title, path, keywords, tableOfContents, description } = LEARNING_D3_COMPONENTS_1.D3_COMPONENTS[component];
            breadcrumbs.push({ position: 4, name: title, item: path });
            const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path, noIndex: false };
            const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
            ...
            return (0, redirect_override_1.redirect)(req, res, '/projects/learning-d3-js', 404, { severity: 'warning', message: 'This component does not exist.' });
        }
    }
    catch (error) {
        console.error(error);
...
exports.learningD3JsComponent = learningD3JsComponent;
function learningD3Js(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/learning-d3-js' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.learningD3Js = learningD3Js;
function createSvgWithPixi(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/create-svg' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.createSvgWithPixi = createSvgWithPixi;
function createGradient(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/create-gradient' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
 ...
 * @returns
 */
async function postCreateGradient(req, res) {
    var _a, _b;
    try {
        var queryStr = '';
        const arr = [];
        if (((_a = req.session.auth) === null || _a === void 0 ? void 0 : _a.userID) !== undefined) {
        ...
        if (typeof type !== 'string' || (type !== 'linear' && type !== 'radial'))
            throw new Error('Incorrect svg type.');
        if (typeof svg_obj !== 'object')
            throw new Error('Incorrect svg_obj');
        if (typeof svg !== 'string')
            throw new Error('Incorrect svg text.');
        const date_created = TIME.getUnixTime();
        arr.push(JSON.stringify(svg_obj), svg, type, date_created);
        const resp = await (0, database_1.default)().query(queryStr, arr);
        const id = (_b = resp === null || resp === void 0 ? void 0 : resp.rows) === null || _b === void 0 ? void 0 : _b[0].id;
        if (typeof id !== 'string')
            throw new Error('Typeof returned id should be a string.');
...
exports.postCreateGradient = postCreateGradient;
/**
 ...
 * @returns
 */
async function deleteCreateGradient(req, res) {
    var _a, _b, _c;
    try {
        const { id } = req.params;
        ...
        if (user_id) {
            ...
            const resp = await (0, database_1.default)().query(queryStr, [id, ip_id, user_id]);
            if (!!!resp || !!!((_b = resp.rows) === null || _b === void 0 ? void 0 : _b.length) || !!!resp.rows[0].id)
                throw new Error('Unable to delete svg from database.');
        }
        else {
            const queryStr = /*sql*/ `DELETE FROM svgs WHERE id=$1 AND ip_id=$2::integer AND user_id IS NULL RETURNING id;`;
            const resp = await (0, database_1.default)().query(queryStr, [id, ip_id]);
            if (!!!resp || !!!((_c = resp.rows) === null || _c === void 0 ? void 0 : _c.length) || !!!resp.rows[0].id)
                throw new Error('Unable to delete svg from database.');
        }
        return res.status(200).send((0, html_1.getSuccessSnackbar)('Deleted svg from database.'));
    }
    catch (error) {
        console.error(error);
        return res.status(400).send((0, html_1.getErrorSnackbar)('Unable to delete svg from database.'));
    }
}
exports.deleteCreateGradient = deleteCreateGradient;
/**
 * Get all gradients for this user / for this user
 * @param req
 * @param res
 */
async function getAllUserGradients(req, res) {
    var _a;
    try {
        ...
        if (user_id) {
            ...
            const dbResp = await (0, database_1.default)().query(queryStr, arr);
  ...
  <div class="flex-row align-center justify-between" style="max-width: 120px;">
    ...
    <button class="toggle-button small" type="button" hx-delete="/create-gradient/${obj.id}" hx-trigger="click" hx-target="closest div[data-grad-container]" hx-swap="outerHTML">
      <svg focusable="false" inert viewBox="0 0 24 24" tabindex="-1" title="Delete">
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorSnackbar)('Unable to get user gradients.'));
    }
}
exports.getAllUserGradients = getAllUserGradients;
function createCssSpriteMaker(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/implementing-auth' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.createCssSpriteMaker = createCssSpriteMaker;
function excalidrawImplementation(req, res) {
    const breadcrumbs = [
        { name: 'Home', item: '/', position: 1 },
        { name: 'Projects', item: '/projects', position: 2 },
    ...
    const tableOfContents = [];
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/excalidraw-implementation' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.excalidrawImplementation = excalidrawImplementation;
function createThreeJSTexture(req, res) {
    ...
    const tableOfContents = [];
    const keywords = [];
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/create-three-js-texture' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
...
exports.createThreeJSTexture = createThreeJSTexture;
function threeJSPlayground(req, res) {
    ...
    const tableOfContents = [];
    const keywords = [];
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/three-js-playground' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
    return res.status(200).render(view, {
        layout: requiredVariables.fullPageRequest ? 'layout' : false,
        ...requiredVariables
...
exports.threeJSPlayground = threeJSPlayground;
async function informationNearYou(req, res) {
    ...
    const keywords = [];
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/info-near-you', image: 'https://image.storething.org/frankmbrown/cfc7a28a-6c01-4725-a2d6-b3ae1df97692.png' };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
    var html = '';
    try {
        if (req.session.census_communities) {
            const cacheCommunities = await Promise.all(req.session.census_communities.map(id => (0, census_1.getCommunity)(req, id)));
            html = await (0, census_1.renderCensusCommunityHTML)(req, cacheCommunities.filter(obj => obj !== undefined));
        }
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
...
exports.informationNearYou = informationNearYou;
...
async function markdownToHTML(req, res) {
    var _a, _b;
    ...
    try {
        if (((_a = req.session.auth) === null || _a === void 0 ? void 0 : _a.level) && req.session.auth.level >= 3) {
            ...
            if (noteID) {
                const [notes, note] = await Promise.all([(0, markdownNotes_1.getAndRenderEditMarkdownNotesPreview)(req), (0, markdownNotes_1.getMarkdownNoteInDatabase)(req, String(noteID))]);
                ...
                const notes = await (0, markdownNotes_1.getAndRenderEditMarkdownNotesPreview)(req);
        ...
        const keywords = [];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/markdown-to-html' };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
            pageObj: {
                theme: ((_b = req.session.settings) === null || _b === void 0 ? void 0 : _b.code_editor_theme) || 'vscode',
                ...pageObj
            },
            bodyClass: 'main-only',
        });
        ...
        if (typeof req.query['note'] === 'string' && req.query['note'].length) {
            return (0, redirect_override_1.redirect)(req, res, '/projects/markdown-to-html', 404, { severity: 'error', message: 'This markdown note does not exist.' });
        }
        else {
            return (0, redirect_override_1.redirect)(req, res, '/', 500, { severity: 'error', message: 'Something went wrong getting this page.' });
        }
    }
}
exports.markdownToHTML = markdownToHTML;
async function getLexicalImplementations(req, res) {
    try {
        ...
        const keywords = ["Lexical", "Artcile", "Comment", "rich text editor"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/lexical-implementations' };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
        ...
        console.error(error);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the lexical implementations page. " });
    }
}
exports.getLexicalImplementations = getLexicalImplementations;
async function onPostLexicalImplementation(req, res) {
    try {
        const getHTML = (obj) => {
            var _a, _b;
        ...
        if (typeof req.body['article'] === 'string') {
            ...
            const obj = await (0, lexical_2.parseFullLexicalEditor)(body);
            ...
            const obj = await (0, lexical_2.parseTextOnlyLexicalEditor)(body, typeof req.body['text-implementation-no-color'] === 'string');
            const html = getHTML(obj);
            ...
            const obj = await (0, lexical_2.parseCommentLexicalEditor)(body);
            const html = getHTML(obj);
            ...
            const obj = await (0, lexical_2.parseTextWithLinksLexicalEditor)(body, typeof req.body['text-links-implementation-no-color'] === 'string');
            const html = getHTML(obj);
            ...
            const obj = await (0, lexical_2.parseTextWithBlockElementsLexicalEditor)(body, typeof req.body['text-blocks-implementation-no-color'] === 'string');
            const html = getHTML(obj);
            ...
            return res.status(200).send((0, html_1.getErrorSnackbar)('Unable to find lexical editor body. Try reloading the page.'));
        }
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorSnackbar)('Something went wrong parsing the lexical editor.'));
    }
}
exports.onPostLexicalImplementation = onPostLexicalImplementation;
function getLookingIntoEmbedingSocialMediaPosts(req, res) {
    try {
        ...
        const keywords = ["Social Media", "TikTok", "Instagram", "Twitter", "Reddit", "rich text editor", "Lexical"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/embed-social-media-posts' };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
        ...
        console.error(error);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the embedding social media posts page." });
    }
}
exports.getLookingIntoEmbedingSocialMediaPosts = getLookingIntoEmbedingSocialMediaPosts;
...
function renderFontFamilyChange(req, font1, font2Obj) {
...
async function onFontSizeAdjustChange(req, res) {
    try {
        ...
        if (typeof systemFont !== 'string' || typeof googleFont !== 'string' || !!!systemFonts.has(systemFont)) {
            ...
            return res.status(200).send((0, html_1.getErrorAlert)("Invalid body inputs.", '<svg focusable="false" inert viewBox="0 0 24 24" tabindex="-1" title="Input"><path d="M21 3.01H3c-1.1 0-2 .9-2 2V9h2V4.99h18v14.03H3V15H1v4.01c0 1.1.9 1.98 2 1.98h18c1.1 0 2-.88 2-1.98v-14c0-1.11-.9-2-2-2zM11 16l4-4-4-4v3H1v2h10v3z"></path></svg>'));
        }
        const db = (0, database_1.default)();
        const queryRes = await db.query(`SELECT * FROM google_fonts WHERE font_name=$1;`, [googleFont]);
        if (!!!queryRes.rows.length) {
            return res.status(200).send((0, html_1.getErrorAlert)("Invalid google font selection.", '<svg viewBox="0 0 488 512" title="google" focusable="false" inert tabindex="-1"><path d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg>'));
        }
        const row = queryRes.rows[0];
        const str = renderFontFamilyChange(req, systemFont, row);
        return res.status(200).send(str);
    }
    catch (error) {
        console.error(error);
...
exports.onFontSizeAdjustChange = onFontSizeAdjustChange;
function getFontSizeAdjust(req, res) {
    ...
    try {
        ...
        const keywords = ["Fonts"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/configure-size-adjust-property' };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
        ...
        console.error(error);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the font size adjust page." });
    }
}
exports.getFontSizeAdjust = getFontSizeAdjust;
function getTestCssEnvVariables(req, res) {
    try {
        ...
        const keywords = ["CSS env Variables"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/testing-css-env-variables' };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
        ...
        console.error(error);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the css env variables page." });
    }
}
exports.getTestCssEnvVariables = getTestCssEnvVariables;
function getImageEditor(req, res) {
    try {
        ...
        const keywords = ["Image Editor", "Pintura"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/image-editor' };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
        ...
        console.error(error);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the image editor page." });
    }
}
exports.getImageEditor = getImageEditor;
async function resizeImage(buffer, width, height, bgColor) {
    try {
        const newBuffer = await (0, cmd_1.executeWithArgument)('magick', ['convert', '-', '-gravity', 'center', '-thumbnail', `${parseInt(String(width))}x${parseInt(String(height))}`, '-background', bgColor, '-extent', `${parseInt(String(width))}x${parseInt(String(height))}`, 'jpeg:-'], buffer);
        return newBuffer;
    }
    catch (error) {
        console.error(error);
...
async function postImageEditorResize(req, res) {
    try {
        const file = req.file;
        ...
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find the posted file."));
        }
        if (!!!widthStr || !!!Number.isFinite(parseFloat(widthStr))) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find the posted desired width."));
        }
        if (!!!heightStr || !!!Number.isFinite(parseFloat(heightStr))) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find the posted desired height."));
        }
        if (!!!colorStr || !!!/^#([0-9a-fA-F]{2}){3}/.test(colorStr)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find the posted desired background color."));
        }
        const fileContents = file.buffer;
        const filename = node_crypto_1.default.randomUUID().concat(`.jpg`);
        ...
        const { user_id, ip_id } = (0, aws_implementation_1.getUserIdAndIpIdForImageUpload)(req);
        await (0, aws_implementation_1.uploadImageObject)(key, resizedImage, 'jpeg', { width: widthStr, height: heightStr }, user_id, ip_id);
...
`;
        const url = (0, aws_implementation_1.getDownloadFileUrl)('image', key);
        const str = ejs_1.default.render(template, { url, extension: 'jpeg', imageURL: `https://image.storething.org/${key}` });
        return res.status(200).send(str);
    }
    catch (e) {
        console.error(e);
...
exports.postImageEditorResize = postImageEditorResize;
function getNeuralStyleTransfer(req, res) {
    try {
        ...
        const keywords = ["Neural Style Transfer", "Wikipedia", "Flask"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/neural-style-transfer', image: "https://image.storething.org/frankmbrown/22e330a2-7344-4299-a7ad-76bf520a1657.jpg" };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables
        ...
        console.error(error);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the neural style transfer page." });
    }
}
exports.getNeuralStyleTransfer = getNeuralStyleTransfer;
function getConvertFileType(req, res) {
    try {
        ...
        const keywords = [];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/convert-file-type', image: "https://image.storething.org/frankmbrown/909a3a8a-b998-439a-bda3-89bae28f7263.png" };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables
        ...
        console.error(error);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the convert file type page." });
    }
}
exports.getConvertFileType = getConvertFileType;
...
`;
async function postConvertImageType(req, res) {
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find image file to convert."));
        }
        const buffer = file.buffer;
        const outputImageType = String(req.body['output-image-type']);
        if (!!!ACCEPTED_IMAGE_TYPES.has(outputImageType)) {
            return res.status(200).send((0, html_1.getErrorAlert)("The requested output image type is not accepted."));
        }
        const output_type = outputImageType.slice(1);
        const convertedBuffer = await (0, cmd_1.executeWithArgument)('magick', ['convert', '-', `${output_type}:-`], buffer);
        const key = 'frankmbrown/' + node_crypto_1.default.randomUUID() + outputImageType;
        const keyNew = await (0, aws_implementation_1.uploadFileGeneral)(key, convertedBuffer, 'image', 'image/'.concat(output_type));
        const url = (0, aws_implementation_1.getDownloadFileUrl)('image', keyNew);
        const resp = ejs_1.default.render(returnEJSFileConversion, { url, filename: keyNew.replace('frankmbrown/', '') });
        return res.status(200).send(resp);
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong converting image file type!"));
    }
}
exports.postConvertImageType = postConvertImageType;
function checkIfFolderExistsElseMakeIt() {
    if (!node_fs_1.default.existsSync(node_path_1.default.resolve(__dirname, 'temp'))) {
        node_fs_1.default.mkdirSync(node_path_1.default.resolve(__dirname, 'temp'));
        return;
    }
    return;
}
...
async function postConvertAudioType(req, res) {
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find audio file to convert."));
        }
        const fileBuffer = file.buffer;
        const outputAudioType = String(req.body['output-audio-type']);
        if (!!!ACCEPTED_AUDIO_TYPES.has(outputAudioType)) {
            return res.status(200).send((0, html_1.getErrorAlert)("The requested output audio type is not accepted."));
        }
        checkIfFolderExistsElseMakeIt();
        const path_to_temp_folder = node_path_1.default.resolve(__dirname, 'temp');
        const inputExtension = mime_types_1.default.extension(file.mimetype);
        const input_name = node_crypto_1.default.randomUUID() + "." + inputExtension || '';
        const path_to_input = node_path_1.default.resolve(path_to_temp_folder, input_name);
        const output_name = node_crypto_1.default.randomUUID() + outputAudioType;
        const path_to_output = node_path_1.default.resolve(path_to_temp_folder, output_name);
        // @ts-ignore
        await node_fs_1.default.promises.writeFile(path_to_input, fileBuffer);
        const command = `ffmpeg -i ${path_to_input} ${path_to_output}`;
        await (0, cmd_1.execute)(command, { cwd: __dirname });
        const convertedFileBuffer = await node_fs_1.default.promises.readFile(path_to_output);
        const key = 'frankmbrown/' + node_crypto_1.default.randomUUID() + outputAudioType;
        const keyNew = await (0, aws_implementation_1.uploadFileGeneral)(key, convertedFileBuffer, 'audio', 'audio/'.concat(inputExtension || ''));
        const url = (0, aws_implementation_1.getDownloadFileUrl)('audio', keyNew);
        const resp = ejs_1.default.render(returnEJSFileConversion, { url, filename: keyNew.replace('frankmbrown/', '') });
        return res.status(200).send(resp);
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong converting audio file type!"));
    }
}
exports.postConvertAudioType = postConvertAudioType;
...
async function postConvertVideoType(req, res) {
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find video file to convert."));
        }
        const fileBuffer = file.buffer;
        const outputVideoType = String(req.body['output-video-type']);
        if (!!!ACCEPTED_VIDEO_TYPES.has(outputVideoType)) {
            return res.status(200).send((0, html_1.getErrorAlert)("The requested output video type is not accepted."));
        }
        checkIfFolderExistsElseMakeIt();
        const path_to_temp_folder = node_path_1.default.resolve(__dirname, 'temp');
        const inputExtension = mime_types_1.default.extension(file.mimetype);
        const input_name = node_crypto_1.default.randomUUID() + "." + inputExtension || '';
        const path_to_input = node_path_1.default.resolve(path_to_temp_folder, input_name);
        const output_name = node_crypto_1.default.randomUUID() + outputVideoType;
        const path_to_output = node_path_1.default.resolve(path_to_temp_folder, output_name);
        // @ts-ignore
        await node_fs_1.default.promises.writeFile(path_to_input, fileBuffer);
        const command = `ffmpeg -i ${path_to_input} ${path_to_output}`;
        await (0, cmd_1.execute)(command, { cwd: __dirname });
        const convertedFileBuffer = await node_fs_1.default.promises.readFile(path_to_output);
        const key = 'frankmbrown/' + node_crypto_1.default.randomUUID() + outputVideoType;
        const keyNew = await (0, aws_implementation_1.uploadFileGeneral)(key, convertedFileBuffer, 'video', 'video/'.concat(inputExtension || ''));
        const url = (0, aws_implementation_1.getDownloadFileUrl)('video', keyNew);
        const resp = ejs_1.default.render(returnEJSFileConversion, { url, filename: keyNew.replace('frankmbrown/', '') });
        return res.status(200).send(resp);
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong converting video file type!"));
    }
}
exports.postConvertVideoType = postConvertVideoType;
/**
 * Removed '.pdf' for now
 */
 ...
 */
async function convertTextFileType(fileBuffer, output_text_type, input_text_type, myDesignSystem = false) {
    var output_file = '';
    try {
        const name = node_crypto_1.default.randomUUID() + "." + output_text_type;
        const path_to_output = node_path_1.default.resolve(__dirname, 'temp', name);
        output_file = path_to_output;
        const commandOutput = await (0, cmd_1.executeWithArgument)('pandoc', ['-f', input_text_type, '-o', path_to_output], fileBuffer);
        ...
        const convertedBuffer = await node_fs_1.default.promises.readFile(path_to_output, options);
        await (0, cmd_1.tryRemoveFile)(path_to_output);
        return convertedBuffer;
    }
    catch (e) {
        await (0, cmd_1.tryRemoveFile)(output_file);
        console.error(e);
        throw new Error("Unable to convert text file type.");
    }
}
exports.convertTextFileType = convertTextFileType;
async function postConvertTextFileType(req, res) {
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find file to convert!"));
        }
        const input_text_type = mime_types_1.default.extension(file.mimetype);
        if (!!!input_text_type) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to detect input file type!"));
        }
        const fileBuffer = file.buffer;
        const outputTextType = String(req.body['output-text-type']);
        if (!!!ACCEPTED_TEXT_TYPES.has(outputTextType)) {
            return res.status(200).send((0, html_1.getErrorAlert)("The requested output text type is not accepted!"));
        }
        const key = "frankmbrown/" + node_crypto_1.default.randomUUID() + outputTextType;
        ...
        const keyNew = await (0, aws_implementation_1.uploadFileGeneral)(key, convertedBuffer, 'text', output_text_type);
        const url = (0, aws_implementation_1.getDownloadFileUrl)('text', keyNew);
        const resp = ejs_1.default.render(returnEJSFileConversion, { url, filename: keyNew.replace('frankmbrown/', '') });
        return res.status(200).send(resp);
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong converting text file type!"));
    }
}
exports.postConvertTextFileType = postConvertTextFileType;
function getFileInformation(req, res) {
    try {
        ...
        const keywords = [];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/get-file-information', image: "https://image.storething.org/frankmbrown/dba365f9-127c-40c5-a142-ced336cad571.png" };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Get File Information page." });
    }
}
exports.getFileInformation = getFileInformation;
async function postGetFileInformationImage(req, res) {
    try {
        const view = 'partials/routes/get-file-information/image';
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate input image file."));
        }
        const fileBuffer = file.buffer;
        const extension = mime_types_1.default.extension(file.mimetype);
        const key = 'frankmbrown/' + node_crypto_1.default.randomUUID() + '.' + (extension || file.filename.split('.').at(-1));
        const { user_id, ip_id } = (0, aws_implementation_1.getUserIdAndIpIdForImageUpload)(req);
        const [imageInformation, pil_image_buffer, image_url] = await Promise.all([
            (0, mediaHelpers_1.getImageMetadata)(fileBuffer),
            convertImageToPillowCompatable(fileBuffer, extension),
            (0, aws_implementation_1.uploadImageObject)(key, fileBuffer, (extension || file.filename.split('.').at(-1)), {}, user_id, ip_id)
        ]);
        ...
        const [str, embedding, safeSearch] = await Promise.all([
            (0, static_pages_1.postGetImageDataHelper)(fileBuffer, req, false),
            postToPythonBackend('/python/image-embed', body, 5000),
            postToPythonBackend('/python/safe-search-image', body, 5000)
        ]);
        const embeddingCodeObj = personal_website_shared_1.highlight.highlight(JSON.stringify(embedding), { language: 'json' });
        const embeddingCodeHtmlString = embeddingCodeObj.value;
        const embeddingCode = (0, static_pages_1.renderCodeWrapper)({ block: true, htmlString: embeddingCodeHtmlString, language: 'json', relevance: 1, snackbarID: `copy_html_code_snackbar_`.concat(node_crypto_1.default.randomUUID()) });
        const safeSearchCodeObj = personal_website_shared_1.highlight.highlight(JSON.stringify(safeSearch), { language: 'json' });
        const safeSearchCodeHtmlString = safeSearchCodeObj.value;
        const safeSearchCode = (0, static_pages_1.renderCodeWrapper)({ block: true, htmlString: safeSearchCodeHtmlString, language: 'json', relevance: 1, snackbarID: `copy_html_code_snackbar_`.concat(node_crypto_1.default.randomUUID()) });
        return res.status(200).render(view, { layout: false, str, ...imageInformation[0], embeddingCode, safeSearchCode });
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong getting the file information for the image!."));
    }
}
exports.postGetFileInformationImage = postGetFileInformationImage;
async function postGetFileInformationAudio(req, res) {
    var path_to_file_global = undefined;
    try {
        const view = 'partials/routes/get-file-information/audio';
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate input audio file."));
        }
        const fileBuffer = file.buffer;
        const extension = mime_types_1.default.extension(file.mimetype) || '';
        if (!!!node_fs_1.default.existsSync(node_path_1.default.resolve(__dirname, 'temp')))
            node_fs_1.default.mkdirSync(node_path_1.default.resolve(__dirname, 'temp'));
        const path_to_file = node_path_1.default.resolve(__dirname, 'temp', node_crypto_1.default.randomUUID() + "." + extension);
        path_to_file_global = path_to_file;
        const key = "frankmbrown/" + node_crypto_1.default.randomUUID() + "." + extension;
        // @ts-ignore
        await node_fs_1.default.promises.writeFile(path_to_file, fileBuffer);
        const [audioInformation, _] = await Promise.all([
            (0, mediaHelpers_1.getAudioMetadata)(path_to_file),
            (0, aws_implementation_1.uploadFileGeneral)(key, fileBuffer, 'audio', extension)
        ]);
        await node_fs_1.default.promises.unlink(path_to_file);
        return res.status(200).render(view, { layout: false, ...audioInformation, url: `https://audio.storething.org/${key}` });
    }
    catch (e) {
        if (path_to_file_global)
            await (0, cmd_1.tryRemoveFile)(path_to_file_global);
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong getting the file information for the audio!."));
    }
}
exports.postGetFileInformationAudio = postGetFileInformationAudio;
async function postGetFileInformationVideo(req, res) {
    var path_to_file_global = undefined;
    try {
        const view = 'partials/routes/get-file-information/video';
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate input video file."));
        }
        const fileBuffer = file.buffer;
        const extension = mime_types_1.default.extension(file.mimetype) || '';
        if (!!!node_fs_1.default.existsSync(node_path_1.default.resolve(__dirname, 'temp')))
        ...
        const [videoInformation, _] = await Promise.all([
            (0, mediaHelpers_1.getVideoMetadata)(path_to_file),
            (0, aws_implementation_1.uploadFileGeneral)(key, fileBuffer, 'video', extension)
        ]);
        await node_fs_1.default.promises.unlink(path_to_file);
        ...
        if (path_to_file_global)
            await (0, cmd_1.tryRemoveFile)(path_to_file_global);
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong getting the file information for the video!."));
    }
}
exports.postGetFileInformationVideo = postGetFileInformationVideo;
async function postGetFileInformationText(req, res) {
    try {
        const view = 'partials/routes/get-file-information/text';
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate input document file."));
        }
        const fileBuffer = file.buffer;
        const extension = mime_types_1.default.extension(file.mimetype) || '';
        const contentType = mime_types_1.default.contentType(file.originalname);
        const charset = mime_types_1.default.charset(file.mimetype);
        const size = file.size;
        const key = "frankmbrown/" + node_crypto_1.default.randomUUID() + "." + extension;
        const mimetype = mime_types_1.default.extension(file.mimetype);
        if (!!!mimetype) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate input file type for uploaded file.", NLP_SVG));
        }
        await (0, aws_implementation_1.uploadFileGeneral)(key, fileBuffer, 'text', extension);
        return res.status(200).render(view, { layout: false, size, extension, contentType, charset, url: `https://text.storething.org/${key}` });
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong getting the file information for the document!."));
    }
}
exports.postGetFileInformationText = postGetFileInformationText;
function getVariousNlpTasks(req, res) {
    try {
        ...
        const keywords = ["Fill-Mask", " Question Answering", " Sentiment Analysis", " Named Entity Recognition", " Classification", " Translation", "Table Question Answering", "Feature Extraction", "Text Generation", "Summarization", "Keyword Extraction"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/various-nlp-tasks', image: "https://image.storething.org/frankmbrown/e396894d-0156-4e4b-951b-225daa01a114.webp" };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Various NLP Tasks page." });
    }
}
exports.getVariousNlpTasks = getVariousNlpTasks;
 ...
 * @returns
 */
async function postToPythonBackend(path, body, timeout) {
    const options = { headers: { "Content-Type": "application/json" } };
    if (timeout) {
        options.timeout = timeout;
    }
    return axios_1.default.post("http://127.0.0.1:5000".concat(path), body, { headers: { "Content-Type": "application/json" } })
        .then((res) => {
        return res.data;
    })
        .catch((err) => {
        console.error("Failed to post to Python backend.");
        const newErr = err === null || err === void 0 ? void 0 : err.message;
        throw new Error(newErr);
    });
}
exports.postToPythonBackend = postToPythonBackend;
async function postFillMask(req, res) {
    ...
    try {
        ...
        if (typeof maskedInput !== 'string')
            throw new Error("Unable to find input for maked input route.");
        if (!!!/\[MASK\]/.test(maskedInput))
            maskedInput += ' [MASK]';
        const body = { text: maskedInput };
        const response = await postToPythonBackend('/python/fill-mask', body, 5000);
        viewOptions.response = response;
        return res.status(200).render(view, viewOptions);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing fill-mask.', NLP_SVG));
    }
}
exports.postFillMask = postFillMask;
async function postAnswerQuestion(req, res) {
    ...
    try {
        ...
        if (!!!textFile && (typeof textInput !== 'string' && textInput.length === 0)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate text input for classification. Upload a document or insert text.", NLP_SVG));
        }
        if (typeof question !== 'string' || question.length === 0) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate question for question-anwering.", NLP_SVG));
        }
        var text_to_use = '';
        if (textFile) {
            const mimetype = mime_types_1.default.extension(textFile.mimetype);
            if (!!!mimetype) {
                return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate input file type for uploaded file.", NLP_SVG));
            }
            const text_file = await convertTextFileType(textFile.buffer, 'txt', mimetype, false);
            text_to_use = text_file;
        }
        else {
            text_to_use = textInput;
        }
        const body = { context: text_to_use, question };
        const response = await postToPythonBackend('/python/question-answering', body, 10000);
        viewOptions.response = response;
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing question answering.', NLP_SVG));
    }
}
exports.postAnswerQuestion = postAnswerQuestion;
async function postSentimentAnalysis(req, res) {
    ...
    try {
        ...
        const textInput = req.body['text-input'];
        if (!!!textFile && (typeof textInput !== 'string' && textInput.length === 0)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate text input for sentiment analysis. Upload a document or insert text.", NLP_SVG));
        }
        var text_to_use = '';
        if (textFile) {
            const mimetype = mime_types_1.default.extension(textFile.mimetype);
        ...
        const response = await postToPythonBackend('/python/sentiment-analysis', body, 7000);
        viewOptions.response = response;
        return res.status(200).render(view, viewOptions);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing sentiment analysis.', NLP_SVG));
    }
}
exports.postSentimentAnalysis = postSentimentAnalysis;
async function postNamedEntityRecognition(req, res) {
    ...
    try {
        ...
        const textInput = req.body['text-input'];
        if (!!!textFile && (typeof textInput !== 'string' && textInput.length === 0)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate text input for named entity recognition. Upload a document or insert text into the textarea.", NLP_SVG));
        }
        var text_to_use = '';
        if (textFile) {
            const mimetype = mime_types_1.default.extension(textFile.mimetype);
        ...
        const response = await postToPythonBackend('/python/ner', body, 8000);
        ...
        while (curr_ind < text_to_use.length) {
            if (sortedNer[current_sorted_ner_ind].start < curr_ind) {
                beginStr += (0, escape_html_1.default)(text_to_use.slice(curr_ind, sortedNer[current_sorted_ner_ind].start));
                ...
                beginStr += `<span class="${className}">` + (0, escape_html_1.default)(text_to_use.slice(sortedNer[current_sorted_ner_ind].start, sortedNer[current_sorted_ner_ind].end + 1)) + '</span>';
                curr_ind = sortedNer[current_sorted_ner_ind].end + 1;
                current_sorted_ner_ind += 1;
            }
            if (current_sorted_ner_ind === sortedNer.length)
                break;
        }
        if (curr_ind < text_to_use.length) {
            beginStr += (0, escape_html_1.default)(text_to_use.slice(curr_ind, text_to_use.length));
        }
        beginStr += '</p>';
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing named entity recognition.', NLP_SVG));
    }
}
exports.postNamedEntityRecognition = postNamedEntityRecognition;
async function postNlpClassification(req, res) {
    ...
    try {
        ...
        if (typeof classLabels !== "string" || classLabels.split(',').length === 0) {
            return res.status(200).send((0, html_1.getErrorAlert)('There should be at least one class label to use to classify text - make sure they are comma-separated.', NLP_SVG));
        }
        ...
        const response = await postToPythonBackend('/python/zero-shot-classification', body, 7000);
        viewOptions.response = Object.entries(response);
        return res.status(200).render(view, viewOptions);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing text classification.', NLP_SVG));
    }
}
exports.postNlpClassification = postNlpClassification;
async function postFeatureExtraction(req, res) {
    try {
        const textInput = req.body['text-input'];
        console.log(req.body, textInput);
        if ((typeof textInput !== 'string' || textInput.length === 0)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate text input for feature extraction.", NLP_SVG));
        }
        const input = textInput.slice(0, 8000);
        const embedding = await (0, ai_1.createEmbedding)(input, "text-embedding-ada-002");
        const highlightResult = personal_website_shared_1.highlight.highlight(JSON.stringify(embedding), { language: 'json' });
        const htmlString = highlightResult.value;
        var ret = (0, static_pages_1.renderCodeWrapper)({ block: true, htmlString: htmlString, language: 'json', relevance: 1, snackbarID: `copy_html_code_snackbar_`.concat(node_crypto_1.default.randomUUID()) });
        return res.status(200).send(ret);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing feature extraction.', NLP_SVG));
    }
}
exports.postFeatureExtraction = postFeatureExtraction;
async function postSummarization(req, res) {
    ...
    try {
        ...
        if (!!!textFile && (typeof textInput !== 'string' && textInput.length === 0)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate text input for summarization. Upload a document or insert text.", NLP_SVG));
        }
        if (typeof maxLengthStr !== 'string' || typeof minLengthStr !== 'string') {
            return res.status(200).send((0, html_1.getErrorAlert)("Could not recognie max length or min length.", NLP_SVG));
        }
        ...
        if (!!!Number.isInteger(max_length) || !!!Number.isInteger(min_length) || max_length < min_length) {
            return res.status(200).send((0, html_1.getErrorAlert)("Max length, min length, or both inputs are invalid.", NLP_SVG));
        }
        var text_to_use = '';
        if (textFile) {
            const mimetype = mime_types_1.default.extension(textFile.mimetype);
        ...
        const response = await postToPythonBackend('/python/summarization', body, 15000);
        viewOptions.response = response;
        return res.status(200).render(view, viewOptions);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing summarization.', NLP_SVG));
    }
}
exports.postSummarization = postSummarization;
async function postKeywordExtraction(req, res) {
    ...
    try {
        ...
        const textInput = req.body['text-input'];
        if (!!!textFile && (typeof textInput !== 'string' && textInput.length === 0)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate text input for keyword extraction. Upload a document or insert text.", NLP_SVG));
        }
        var text_to_use = '';
        if (textFile) {
            const mimetype = mime_types_1.default.extension(textFile.mimetype);
        ...
        const body = { inputs };
        const response = await postToPythonBackend('/python/keyword-extraction', body, 10000);
        viewOptions.response = response;
        return res.status(200).render(view, viewOptions);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing keyword extraction.', NLP_SVG));
    }
}
exports.postKeywordExtraction = postKeywordExtraction;
async function postOpenAITextModeration(req, res) {
    try {
        const textFile = req.file;
        const textInput = req.body['text-input'];
        if (!!!textFile && (typeof textInput !== 'string' && textInput.length === 0)) {
        ...
        var curr = 0;
        const arr = [];
        while (curr < text_to_use.length && curr < 16000) {
            arr.push(text_to_use.slice(curr, curr + 4000));
            curr += 4000;
        }
        const jsonResp = await (0, ai_1.moderateOpenAI)(arr);
        const highlightResult = personal_website_shared_1.highlight.highlight(JSON.stringify(jsonResp, null, ' '), { language: 'json' });
        const htmlString = highlightResult.value;
        var ret = (0, static_pages_1.renderCodeWrapper)({ block: true, htmlString: htmlString, language: 'json', relevance: 1, snackbarID: `copy_html_code_snackbar_`.concat(node_crypto_1.default.randomUUID()) });
        ...
        console.error(err);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong getting the OpenAI moderation response for the posted text."));
    }
}
exports.postOpenAITextModeration = postOpenAITextModeration;
function getVariousImageTasks(req, res) {
    try {
        ...
        const keywords = ["Image Feature Extraction", "Image Captioning", "Image Safe Search", "Text to Image Generation", "Depth Estimation", "Object Detection", "Image Segmentation", "Keypoint Detection"];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/various-image-tasks', image: "https://image.storething.org/frankmbrown/7537ebac-c6eb-4b26-9d5a-4d1f347b0eda.jpg" };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Various Image Tasks page." });
    }
}
exports.getVariousImageTasks = getVariousImageTasks;
const ALLOWED_PIL_TYPES = new Set([
    "blp",
    "bmp",
    "dds",
    "dib",
 ...
 * @returns
 */
async function convertImageToPillowCompatable(buffer, extension) {
    if (!!!extension || !!!ALLOWED_PIL_TYPES.has(extension.toLowerCase())) {
        const newBuffer = await (0, cmd_1.executeWithArgument)('magick', ['convert', '-', 'jpeg:-'], buffer);
        return newBuffer;
    }
    return buffer;
}
exports.convertImageToPillowCompatable = convertImageToPillowCompatable;
...
async function postImageFeatureExtraction(req, res) {
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find image for object detection.", IMAGE_ERROR_SVG));
        }
        const fileBuffer = file.buffer;
        const extension = mime_types_1.default.extension(file.mimetype);
        ...
        const body = { image: base64String };
        const response = await postToPythonBackend('/python/image-embed', body, 5000);
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing feature extraction for image.', IMAGE_ERROR_SVG));
    }
}
exports.postImageFeatureExtraction = postImageFeatureExtraction;
async function postImageSafeSearch(req, res) {
    ...
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find image for safe search.", IMAGE_ERROR_SVG));
        }
        const fileBuffer = file.buffer;
        const extension = mime_types_1.default.extension(file.mimetype);
        const newBuffer = await convertImageToPillowCompatable(fileBuffer, extension);
        const base64String = newBuffer.toString('base64');
        const body = { image: base64String };
        const response = await postToPythonBackend('/python/safe-search-image', body, 7000);
        viewOptions.response = response;
        return res.status(200).render(view, viewOptions);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing safe search.', IMAGE_ERROR_SVG));
    }
}
exports.postImageSafeSearch = postImageSafeSearch;
async function postImageCaptioning(req, res) {
    ...
    try {
        ...
        const base64String = newBuffer.toString('base64');
        const body = { image: base64String };
        const response = await postToPythonBackend('/python/image-captioning', body, 7000);
        viewOptions.response = response;
        return res.status(200).render(view, viewOptions);
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing image captioning.', IMAGE_ERROR_SVG));
    }
}
exports.postImageCaptioning = postImageCaptioning;
async function postDepthEstimation(req, res) {
    var _a, _b;
    ...
    try {
        ...
        const base64String = newBuffer.toString('base64');
        const body = { image: base64String };
        const response = await postToPythonBackend('/python/depth-estimation', body, 10000);
        const highlightResp = personal_website_shared_1.highlight.highlight(JSON.stringify(response.depth), { language: 'json' });
        viewOptions.response = highlightResp;
        const imageResponseBuffer = Buffer.from(response.image, 'base64');
        const key = "frankmbrown/" + node_crypto_1.default.randomUUID() + ".png";
        const { user_id, ip_id } = (0, aws_implementation_1.getUserIdAndIpIdForImageUpload)(req);
        const [imageMetadata, imageURL] = await Promise.all([
            (0, mediaHelpers_1.getImageMetadata)(imageResponseBuffer),
            (0, aws_implementation_1.uploadImageObject)(key, imageResponseBuffer, 'png', {}, user_id, ip_id)
        ]);
        const { width, height } = imageMetadata[0];
        const obj = (0, markdown_1.getSizesFromWidthAndHeight)(width, height);
        var widthToUse = 0;
        var heightToUse = 0;
        if ((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop) {
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing depth estimation.', IMAGE_ERROR_SVG));
    }
}
exports.postDepthEstimation = postDepthEstimation;
async function postObjectDetection(req, res) {
    var _a, _b;
    ...
    try {
        ...
        if (typeof threshold !== 'string') {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find threshold.", IMAGE_ERROR_SVG));
        }
        else if (parseFloat(threshold) < 0.1 || parseFloat(threshold) > 0.99) {
            return res.status(200).send((0, html_1.getErrorAlert)("Inavlid Threshold!", IMAGE_ERROR_SVG));
        }
        const fileBuffer = file.buffer;
        const extension = mime_types_1.default.extension(file.mimetype);
        const newBuffer = await convertImageToPillowCompatable(fileBuffer, extension);
        ...
        const response = await postToPythonBackend('/python/object-detection', body, 10000);
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing object detection.', IMAGE_ERROR_SVG));
    }
}
exports.postObjectDetection = postObjectDetection;
async function postImageSegmentation(req, res) {
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find image for object detection.", IMAGE_ERROR_SVG));
        ...
        const extension = mime_types_1.default.extension(file.mimetype);
        const newBuffer = await convertImageToPillowCompatable(fileBuffer, extension);
        return res.status(200).send((0, html_1.getWarningAlert)('I was not able to get this working yet. I am moving on.', IMAGE_ERROR_SVG));
    }
    catch (error) {
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing image segmentation.', IMAGE_ERROR_SVG));
    }
}
exports.postImageSegmentation = postImageSegmentation;
async function postKeypointDetection(req, res) {
    var _a, _b;
    ...
    try {
        ...
        const base64String = newBuffer.toString('base64');
        const body = { image: base64String };
        const response = await postToPythonBackend('/python/keypoint-detection', body, 10000);
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)('Something went wrong performing keypoint detection.', IMAGE_ERROR_SVG));
    }
}
exports.postKeypointDetection = postKeypointDetection;
async function postOpenAIImageModeration(req, res) {
    try {
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find image for object detection.", IMAGE_ERROR_SVG));
        ...
        const extension = mime_types_1.default.extension(file.mimetype);
        const newBuffer = await convertImageToPillowCompatable(fileBuffer, extension);
        const key = 'frankmbrown/'.concat(node_crypto_1.default.randomUUID()).concat(`.${extension}`);
        const { user_id, ip_id } = (0, aws_implementation_1.getUserIdAndIpIdForImageUpload)(req);
        const url = await (0, aws_implementation_1.uploadImageObject)(key, newBuffer, extension || '', {}, user_id, ip_id);
        const jsonResp = await (0, ai_1.moderateOpenAI)([{ type: "image_url", "image_url": { "url": url } }]);
        const highlightResult = personal_website_shared_1.highlight.highlight(JSON.stringify(jsonResp, null, ' '), { language: 'json' });
        const htmlString = highlightResult.value;
        var ret = (0, static_pages_1.renderCodeWrapper)({ block: true, htmlString: htmlString, language: 'json', relevance: 1, snackbarID: `copy_html_code_snackbar_`.concat(node_crypto_1.default.randomUUID()) });
        return res.status(200).send('<div>'.concat(ret).concat('</div>'));
        ...
        console.error(error);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong with getting the OpenAI moderation response for the image!"));
    }
}
exports.postOpenAIImageModeration = postOpenAIImageModeration;
async function getAiChatInformationOnModels(req, res) {
    ...
    const keywords = [];
    const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/chat/information-on-models', image };
    const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
    return res.status(200).render(view, {
        layout: requiredVariables.fullPageRequest ? 'layout' : false,
        ...requiredVariables
...
exports.getAiChatInformationOnModels = getAiChatInformationOnModels;
function getAiChat(req, res) {
    try {
        ...
        const keywords = [];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/chat', image: "https://image.storething.org/frankmbrown/7537ebac-c6eb-4b26-9d5a-4d1f347b0eda.jpg" };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        const chat_id = 'chat_'.concat(node_crypto_1.default.randomUUID());
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables
        });
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the AI Chat page." });
    }
}
exports.getAiChat = getAiChat;
/**
 *
 * );
 * @param req
 ...
 * @returns
 */
async function getSenseOfStyle(req, res) {
    try {
        ...
        const keywords = [];
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: '/projects/sense-of-style', image: "https://image.storething.org/frankmbrown%2F78a3fe81-e9c3-4135-91e5-8376473909ae.jpg" };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        const senseOfStyleRespnse = await (0, database_1.default)().query(`SELECT html, css, js FROM sense_of_style ORDER BY date_created DESC;`);
        ...
        }).join('') : (0, html_1.getInfoAlert)("There are currently no sense of style posts.", undefined, false);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
            posts_html: html
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Sense of Style page." });
    }
}
exports.getSenseOfStyle = getSenseOfStyle;
async function postSenseOfStyle(req, res) {
    try {
        const html = req.body['html-editor-wrapper'];
        const css = req.body['css-editor-wrapper-2'];
        const js = req.body['js-editor-wrapper'];
        if (typeof html !== 'string' || !!!html.length) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate HTML string in POST request."));
        }
        const dom = new jsdom_1.default.JSDOM(html);
        var innerText = dom.window.document.body.textContent;
        if (!!!innerText) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate innerText in POST request."));
        }
        innerText = innerText.replace(/\s+|\n/, ' ');
        const embedding = await (0, ai_1.createEmbedding)(innerText);
        await (0, database_1.default)().query(`INSERT INTO sense_of_style (html,css,js,embedding,document,date_created) VALUES ($1,$2,$3,$4,$5,$6);`, [html, css || null, js || null, pgvector_1.default.toSql(embedding), innerText, TIME.getUnixTime()]);
        const reloadPage = `<script nonce="${req.session.jsNonce}">(()=>{setTimeout(() => {window.location.reload()},500)})()</script>`;
        return res.status(200).send((0, html_1.getSuccessSnackbar)('Successfully added sense_of_style note!').concat(reloadPage));
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Unable to add sense of style."));
    }
}
exports.postSenseOfStyle = postSenseOfStyle;
...
async function getWebAPIs(req, res) {
    ...
    try {
        ...
        const keywords = ["Web APIs"].concat(toc.map((o) => o.text));
        const SEO = { breadcrumbs, keywords, title, description, tableOfContents, path: `/projects/web-apis/${page}`, image };
        const requiredVariables = (0, frontendHelper_1.getRequiredVariables)(req, SEO);
        const audio_1 = (0, mediaHelpers_1.getTestAudioHTML)(req);
        const video_1 = (0, mediaHelpers_1.getTestVideoHTML)(req);
        return res.status(200).render(view, {
            layout: requiredVariables.fullPageRequest ? 'layout' : false,
            ...requiredVariables,
            api_page: page,
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Web APIs project page." });
    }
}
exports.getWebAPIs = getWebAPIs;
const VALID_TABLE_CONVERSION_OUTPUT = new Set(['csv', 'json', 'markdown', 'html', 'rte']);
...
async function convertStringArr(req, stringArr, input_type, output_type, header_row = true) {
    switch (output_type) {
        case 'csv': {
            var str = '';
...
`;
        ...
        case 'html': {
            ...
            if (header_row) {
                ...
                for (let i = 0; i < stringArr[0].length; i++) {
                    str += '<th scope="col">' + (0, escape_html_1.default)(stringArr[0][i]).trim() + "</th>";
                }
                str += '</tr></thead>';
                start += 1;
            }
        ...
        case 'markdown': {
            ...
            for (let i = 0; i < stringArr.length; i++) {
                for (let j = 0; j < stringArr[i].length; j++) {
                    if (input_type === "html") {
                        const md = (await (0, cmd_1.executeWithArgument)('pandoc', ['-t', 'markdown'], Buffer.from(stringArr[i][j]))).toString('utf-8');
                        if (j === 0)
                            str += '| ' + md.trim() + " |";
                        else
                            str += ' ' + md.trim() + ' |';
...
async function uploadtableConversion(str, format) {
    ...
    const key = "frankmbrown/" + node_crypto_1.default.randomUUID() + "." + extension;
    await (0, aws_implementation_1.uploadFileGeneral)(key, Buffer.from(str), "text", contentType);
    const downnload_file = (0, aws_implementation_1.getDownloadFileUrl)('text', key);
    return downnload_file;
}
async function returnTableConversion(req, res, retStr, outputFormat) {
    var strToUse;
...
async function postTableConversionFile(req, res) {
    try {
        const outputFormat = String(req.body['output-format']);
        if (!!!VALID_TABLE_CONVERSION_OUTPUT.has(outputFormat)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Invalid output format selected for the table conversion.", COMMON_SVG_1.default.TABLE, false));
        }
        const file = req.file;
        if (!!!file) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to locate input file for the table conversion.", COMMON_SVG_1.default.TABLE, false));
        }
        const includeHeadingRow = Boolean(req.body['include-heading-row'] === "on");
        const { json, fileType } = await (0, table_1.generateJsonFromCsvExcel)(file);
        const stringMatrix = (0, table_1.parseTableJSON)(json, fileType === "excel", true);
        const retStr = await convertStringArr(req, stringMatrix, 'other', outputFormat, includeHeadingRow);
        return returnTableConversion(req, res, retStr, outputFormat);
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong converting the table provided in the file.", COMMON_SVG_1.default.TABLE, false));
    }
}
exports.postTableConversionFile = postTableConversionFile;
const input_format_types = new Set(['html', 'markdown', 'csv']);
async function postTableConversionText(req, res) {
    try {
        const outputFormat = String(req.body['output-format']);
        if (!!!VALID_TABLE_CONVERSION_OUTPUT.has(outputFormat)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Invalid output format selected for the table conversion.", COMMON_SVG_1.default.TABLE, false));
        ...
        if (!!!input_format_types.has(input_format)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to recognize input format type.", COMMON_SVG_1.default.TABLE, false));
        }
        if (!!!text.length) {
            return res.status(200).send((0, html_1.getErrorAlert)("Input text must be at least one character long.", COMMON_SVG_1.default.TABLE, false));
        }
        if (input_format === "csv") {
            const json = await new Promise((resolve, reject) => {
                (0, csvtojson_1.default)()
                    .on('error', (err) => {
                    console.error('error');
                    return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong parsing the csv data.", COMMON_SVG_1.default.TABLE, false));
                })
                    .fromString(text)
                    .then((csvJSON) => {
                    resolve(csvJSON);
            ...
            const arr = (0, table_1.parseTableJSON)(json, false, true);
            const retStr = await convertStringArr(req, arr, 'other', outputFormat, true);
            return returnTableConversion(req, res, retStr, outputFormat);
        }
        else if (input_format === "html") {
            const dom = new jsdom_1.default.JSDOM(text);
            const tables = Array.from(dom.window.document.querySelectorAll('table'));
            if (!!!tables.length) {
                return res.status(200).send((0, html_1.getErrorAlert)("Unable to find any tables in the provided HTML.", COMMON_SVG_1.default.TABLE, false));
            }
            const table = tables[0];
            const arr = (0, table_1.parseHTMLTable)(table);
            const retStr = await convertStringArr(req, arr, 'html', outputFormat, true);
            return returnTableConversion(req, res, retStr, outputFormat);
        }
        else if (input_format === "markdown") {
            const html = await (0, cmd_1.executeWithArgument)('pandoc', ['-t', 'html'], Buffer.from(text));
            const dom = new jsdom_1.default.JSDOM(html);
            const tables = Array.from(dom.window.document.querySelectorAll('table'));
            if (!!!tables.length) {
                return res.status(200).send((0, html_1.getErrorAlert)("Unable to find any tables in the provided markdown.", COMMON_SVG_1.default.TABLE, false));
            }
            const table = tables[0];
            const arr = (0, table_1.parseHTMLTable)(table);
            const retStr = await convertStringArr(req, arr, 'markdown', outputFormat, true);
            return returnTableConversion(req, res, retStr, outputFormat);
        }
        else {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to recognize input format type.", COMMON_SVG_1.default.TABLE, false));
        ...
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong converting the table provided in the text input.", COMMON_SVG_1.default.TABLE, false));
    }
}
exports.postTableConversionText = postTableConversionText;
async function postTableConversionUrl(req, res) {
    try {
        const outputFormat = String(req.body['output-format']);
        if (!!!VALID_TABLE_CONVERSION_OUTPUT.has(outputFormat)) {
            return res.status(200).send((0, html_1.getErrorAlert)("Invalid output format selected for the table conversion.", COMMON_SVG_1.default.TABLE, false));
        ...
        try {
            ...
            return res.status(200).send((0, html_1.getErrorAlert)("Invalid URL - unable to get tables from provided URL.", COMMON_SVG_1.default.TABLE, false));
        }
        const html = await axios_1.default.get(url, { headers: { 'Accept': 'text/html' }, timeout: 5000 });
        const dom = new jsdom_1.default.JSDOM(html.data);
        const tables = Array.from(dom.window.document.querySelectorAll('table'));
        if (!!!tables.length) {
            return res.status(200).send((0, html_1.getErrorAlert)("Unable to find any tables in the provided URL", COMMON_SVG_1.default.TABLE, false));
        }
        const tables_arrays = [];
        ...
        for (let table of tables_arrays) {
            const retStr = await convertStringArr(req, table, 'html', outputFormat, true);
            retStrArr.push(retStr);
        }
        return returnTableConversion(req, res, retStrArr, outputFormat);
    }
    catch (e) {
        console.error(e);
        return res.status(200).send((0, html_1.getErrorAlert)("Something went wrong converting the HTML tables for the given URL.", COMMON_SVG_1.default.TABLE, false));
    }
}
exports.postTableConversionUrl = postTableConversionUrl;
async function getTableConversionPage(req, res) {
    try {
        ...
        const keywords = ["Chart", "Bokeh", "Python", "mpld3", "file"];
        const tableOfContents = [
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the table conversion project page." });
    }
}
exports.getTableConversionPage = getTableConversionPage;
async function getCreateChartPage(req, res) {
    try {
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Create a Chart project page." });
    }
}
exports.getCreateChartPage = getCreateChartPage;
function getTestingSelectImplementations(req, res) {
    try {
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Testing Select Implementations project page." });
    }
}
exports.getTestingSelectImplementations = getTestingSelectImplementations;
function getSortingMechanisms(req, res) {
    try {
...
exports.getSortingMechanisms = getSortingMechanisms;
function getGoogleColabClone(req, res) {
    try {
...
exports.getGoogleColabClone = getGoogleColabClone;
function getTestingRecommendationSystems(req, res) {
    try {
...
exports.getTestingRecommendationSystems = getTestingRecommendationSystems;
function getBokehFunctionalityPage(req, res) {
    try {
        ...
        console.error(e);
        return (0, redirect_override_1.redirect)(req, res, '/projects', 500, { severity: "error", message: "Something went wrong getting the Bokeh Survey Implementation project page." });
    }
}
exports.getBokehFunctionalityPage = getBokehFunctionalityPage;
function getWebGPUPage(req, res) {
...
exports.getWebGPUPage = getWebGPUPage;
function getWebGLPage(req, res) {
...
exports.getWebGLPage = getWebGLPage;
function getThreeJsPage(req, res) {
...
exports.getThreeJsPage = getThreeJsPage;
