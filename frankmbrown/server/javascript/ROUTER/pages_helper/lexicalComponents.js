...
exports.getTextEditor = exports.getParagraph = exports.getHorizontalRule = exports.getTable = exports.getMath = exports.getCode = exports.getDetails = exports.getAside = exports.getList = exports.getBlockquote = exports.getEmbedMedia = exports.getUpload = exports.getDownload = exports.getSpeechToText = exports.getGif = exports.getHTML = exports.getVideo = exports.getAudio = exports.getImage = exports.getBlockStyle = exports.getJustifyAlign = exports.getRightAlign = exports.getCenterAlign = exports.getLeftAlign = exports.getOutdent = exports.getIndent = exports.getNewline = exports.getClearEditor = exports.getRedo = exports.getUndo = exports.getFontSize = exports.getClearTextFormatting = exports.getSuperscript = exports.getSubscript = exports.getQuote = exports.getKeyboard = exports.getUnderline = exports.getStrikethrough = exports.getItalic = exports.getBold = exports.getTextColor = exports.getBackgroundColor = exports.getLink = exports.getSectionHeading = exports.getHeading = exports.getFontFamily = void 0;
function getFontFamily(req, rand) {
    var _a, _b;
    ...
    const fontFamily = ((_b = req.session.settings) === null || _b === void 0 ? void 0 : _b.fontFamily) || 'Anuphan, sans-serif;';
...
function getSectionHeading(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getBackgroundColor(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getTextColor(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getBold(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getBold = getBold;
function getItalic(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getItalic = getItalic;
function getStrikethrough(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getStrikethrough = getStrikethrough;
function getUnderline(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getUnderline = getUnderline;
function getKeyboard(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getKeyboard = getKeyboard;
function getQuote(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getQuote = getQuote;
function getSubscript(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getSuperscript(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
exports.getSuperscript = getSuperscript;
function getClearTextFormatting(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getClearTextFormatting = getClearTextFormatting;
function getFontSize(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getFontSize = getFontSize;
function getUndo(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getUndo = getUndo;
function getRedo(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getRedo = getRedo;
function getClearEditor(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getClearEditor = getClearEditor;
function getNewline(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getNewline = getNewline;
function getIndent(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getIndent = getIndent;
function getOutdent(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getOutdent = getOutdent;
function getLeftAlign(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getLeftAlign = getLeftAlign;
function getCenterAlign(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getCenterAlign = getCenterAlign;
function getRightAlign(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getRightAlign = getRightAlign;
function getJustifyAlign(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getJustifyAlign = getJustifyAlign;
function getBlockStyle(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getHTML(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
    return /*html*/ ``;
}
exports.getHTML = getHTML;
function getGif(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getSpeechToText(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getEmbedMedia(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
exports.getEmbedMedia = getEmbedMedia;
function getBlockquote(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
exports.getBlockquote = getBlockquote;
function getList(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
exports.getAside = getAside;
function getDetails(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getHorizontalRule(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
exports.getHorizontalRule = getHorizontalRule;
function getParagraph(req, rand) {
    var _a;
    const desktop = Boolean((_a = req.session.device) === null || _a === void 0 ? void 0 : _a.desktop);
...
function getTextEditor(req, options) {
