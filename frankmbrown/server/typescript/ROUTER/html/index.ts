...
export const ALLOW_EDIT_SETTINGS_STRING = /*html*/`<button hx-swap-oob="true" hx-get="/api/light-mode-dark-mode" type="button" class="icon medium" aria-label="Light Mode / Dark Mode Toggle" id="light-mode-dark-mode" hx-target="#application-styles">
...
export const getAllowSettingsString = (req:Request) => {
  ...
  // </head> 
  // `;
  return ALLOW_EDIT_SETTINGS_STRING;
}
export const getSuccessSnackbar = (str:string) => {
...
export const getErrorSnackbar = (str: string) => {
...
export const getWarningSnackbar = (str:string) => {
...
export const getSuccessAlert = (str: string, svg?:string,includeButton=true)=>{
  return /*html*/`
...
export const getErrorAlert = (str: string,svg?:string,includeButton=true) => {
  return /*html*/`
...
export const getInfoAlert = (str: string,svg?:string,includeButton=true) => {
  return /*html*/`
...
export const getWarningAlert = (str: string,svg?:string,includeButton=true) => {
  return /*html*/`
