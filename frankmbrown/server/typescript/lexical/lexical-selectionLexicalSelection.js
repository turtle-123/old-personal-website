 ...
 */
import { $isTextNode, $isElementNode, $isRangeSelection, DEPRECATED_$isGridSelection, $isRootNode, $getNodeByKey, $getPreviousSelection, $createTextNode, $createRangeSelection, DEPRECATED_$isGridCellNode, $normalizeSelection__EXPERIMENTAL, $setSelection, $getRoot, $isRootOrShadowRoot, $hasAncestor, $isLeafNode, $getAdjacentNode, $isDecoratorNode, $isLineBreakNode } from './lexicalLexical.js';
...
function $sliceSelectedTextNodeContent(selection, textNode) {
  if (textNode.isSelected() && !textNode.isSegmented() && !textNode.isToken() && ($isRangeSelection(selection) || DEPRECATED_$isGridSelection(selection))) {
...
function $patchStyleText(selection, patch) {
  ...
  if (selectedNodes.length === 1) {
    ...
    for (let i = 1; i < lastIndex; i++) {
      ...
      if ($isTextNode(selectedNode) && selectedNodeKey !== firstNode.getKey() && selectedNodeKey !== lastNode.getKey() && !selectedNode.isToken()) {
