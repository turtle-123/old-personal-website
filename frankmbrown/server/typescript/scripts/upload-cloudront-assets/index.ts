...
const mobile_css_key = `frankmbrown/css/mobile-bundle-${CSS_FILE_HASH}.min.css`;
const desktop_css_key = `frankmbrown/css/desktop-bundle-${CSS_FILE_HASH}.min.css`;
const desktop_bundle_path_client = path.resolve(__dirname,'..','..','..','..','static','css',`desktop-bundle-${CSS_FILE_HASH}.min.css`);
const mobile_bundle_path_client = path.resolve(__dirname,'..','..','..','..','static','css',`mobile-bundle-${CSS_FILE_HASH}.min.css`);
...
const getUploadJsCommand = (key:string,file:string) => {
...
const invalidateServiceWorker = new CreateInvalidationCommand({
