 ...
 * https://github.com/dmfilipenko/timezones.json/blob/master/README.md
 */
const TIMEZONES = [
  {
...
/**
 * US and US Territories Tiem Zone Offsets 
 * https://www.ferrovial.com/en/resources/us-time-zone-map/
 */
const US_TIMEZONE_OFFSETS = [10,-4,-5,-6,-7,-8,-9,-10,-11];
/**
 * List of US Supported time zones:
...
const SUPPORTED_TIME_ZONES = [
  ...
  'Antarctica/Casey',
  'Antarctica/Davis',
  'Antarctica/DumontDUrville', // Guam // https://bugs.chromium.org/p/chromium/issues/detail?id=928068
  'Antarctica/Mawson',
  'Antarctica/Palmer',
  'Antarctica/Rothera',
  'Antarctica/Syowa',
  ...
  'Europe/Vienna',
  'Australia/Lord_Howe',
  'Antarctica/Macquarie', // Micronesia time zone
  'Australia/Hobart',
  'Australia/Currie',
  'Australia/Melbourne',
  'Australia/Sydney',
  'Australia/Broken_Hill',
  'Australia/Brisbane', // North Mariana Islands
  'Australia/Lindeman', // North Mariana Islands
  'Australia/Adelaide',
  'Australia/Darwin',
  'Australia/Perth',
  'Australia/Eucla',
  ...
  'Europe/Brussels',
  'Europe/Sofia',
  'Atlantic/Bermuda', // puerto rico time zone
  'Asia/Brunei',
  'America/La_Paz',
  'America/Noronha',
  'America/Belem',
  ...
  'Europe/Istanbul',
  'America/Port_of_Spain',
  'Pacific/Funafuti', // Marshall Islands
  'Asia/Taipei',
  'Europe/Kiev',
  'Europe/Uzhgorod',
  'Europe/Zaporozhye',
